...
return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),r[e]=t),t}}),i("iE7OH").register(JSON.parse('{"kKLfj":"shopping_list_olexandr.1ecdfab2.js","kSqT3":"amazon.a0223db0.png","hTMkK":"apple-books.5a9f17e3.png","9Qt2K":"bookshop.801e98bc.png","e46r6":"index.b2399c8a.js","5gdZE":"index.7c15f993.js"}')),i("6JpON");var a={};a=i("aNJCr").getBundleURL("kKLfj")+i("iE7OH").resolve("kSqT3");var s={};s=i("aNJCr").getBundleURL("kKLfj")+i("iE7OH").resolve("hTMkK");var l={};l=i("aNJCr").getBundleURL("kKLfj")+i("iE7OH").resolve("9Qt2K"),i("knWGd"),i("ksGdE"),i("E6hPi");// import Pagination from 'tui-pagination';
...
// // 
// import './js/helper';
let c=document.querySelector(".shop-list-container"),d=document.querySelector(".shop-list-empty"),u="bookArr";function f(e){let t=JSON.parse(localStorage.getItem(u));if(0===t.length){c.innerHTML="",d.classList.remove("shoping-hidden");return}d.classList.add("shoping-hidden"),c.insertAdjacentHTML("beforeend",p(t)),document.querySelector(".shop-button-book-remove"),c.innerHTML=p(t)}function p(e){return e.map(({author:e,title:o,description:n,book_image:r,buy_links:i,list_name:c,id:d})=>{let u=`<li class="shop-list-item" data-id="${d}">
                ...
                <p class="shop-description">${n}</p></div>
                <ul class="modal-book-image-list">
        <li>
        <a href=${g(i,"Amazon")} target= _blank><img src="${/*@__PURE__*/t(a)}" alt="Amazon"></a>
        </li>
        <li>
      ...
      <button class="shop-button-book-remove" type="button">-</button>
        </li>`;return u}).join("")}function g(e,t){for(let{name:o,url:n}of e)if(o===t)return n}window.addEventListener("DOMContentLoaded",f),c.addEventListener("click",function(e){if("shop-button-book-remove"!==e.target.className)return;let t=e.target.parentNode.dataset.id;(function(e){let t=JSON.parse(localStorage.getItem(u)),o=t.find(t=>t.id===e);console.log(o);let n=t.findIndex(t=>t.id===e);t.splice(n,1),localStorage.setItem(u,JSON.stringify(t))}// const addBoock = document.querySelector(".addNotification");
...
//     load,
//   };
}();//# sourceMappingURL=shopping_list_olexandr.1ecdfab2.js.map
