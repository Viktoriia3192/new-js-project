...
}).catch(e=>{let t=e.code,n=e.message;console.log(n),console.log(t)})}else{// ___________________________________________
...
d3(e.eventQueue_,c,[])})(e._repo,e._path,t,/*priority=*/null,n.wrapCallback(()=>{})),n.promise}(fy(g6,"users/"+i.uid),{userName:e,userEmail:t}),console.log("After"),h(),/*@__PURE__*/A(nr).Notify.success("User is signed up!");// shoppingListLink.classList.remove("header-shopping-list-hidden")
...
// Кнопка "SIGN IN"
var g8=document.querySelector(".auth-button-in");let g7=document.querySelector(".auth-button-up");var me=document.querySelector(".auth-input");let mt=document.querySelector(".menu-btn-start-tab"),mn=document.querySelector(".auth-button-signup");g8.addEventListener("click",function(){me&&(me.classList.add("auth-input-hidden"),mt.textContent="Sign in",mn.textContent="Sign in")}),g7.addEventListener("click",function(){me&&(me.classList.remove("auth-input-hidden"),mt.textContent="Sign up",mn.textContent="Sign up")}),P("E6hPi")}();//# sourceMappingURL=index.36d25c3e.js.map

//# sourceMappingURL=index.36d25c3e.js.map
