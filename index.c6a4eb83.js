!function(){let t;var e,n,o,i,r,a,s,l="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{};function f(t){return t&&t.__esModule?t.default:t}var c={},u={},p=l.parcelRequired7c6;null==p&&((p=function(t){if(t in c)return c[t].exports;if(t in u){var e=u[t];delete u[t];var n={id:t,exports:{}};return c[t]=n,e.call(n.exports,n,n.exports),n.exports}var o=Error("Cannot find module '"+t+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(t,e){u[t]=e},l.parcelRequired7c6=p),p.register("aNJCr",function(t,e){Object.defineProperty(t.exports,"getBundleURL",{get:function(){return n},set:function(t){return n=t},enumerable:!0,configurable:!0});var n,o={};n=function(t){var e=o[t];return e||(e=function(){try{throw Error()}catch(e){var t=(""+e.stack).match(/(https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/[^)\n]+/g);if(t)// Use the 3rd one, which will be a runtime in the original bundle.
return(""+t[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),o[t]=e),e}}),p("6JpON"),p("knWGd");let d={el:document.querySelector(".btn-up"),show(){this.el.classList.remove("btn-up_hide")},hide(){this.el.classList.add("btn-up_hide")},addEventListener(){window.addEventListener("scroll",()=>{let t=window.scrollY||document.documentElement.scrollTop;t>400?this.show():this.hide()}),document.querySelector(".btn-up").onclick=()=>{window.scrollTo({top:0,left:0,behavior:"smooth"})}}};d.addEventListener();var h={};function m(t,e){return function(){return t.apply(e,arguments)}}e=void 0!==l?l:"undefined"!=typeof window?window:h,n=function(t){// COMMON: SSR check: begin
...
var h={};"object"==typeof f?h=f:"object"==typeof u&&(h=u),// extend new settings with the new options
e=s(!0,e,h)}// check callbackOrOptions and options: end
// notify type
var m=e[i.toLocaleLowerCase("en")];// notify counter
c++,"string"!=typeof a&&(a="Notiflix "+i),e.plainText&&(a=l(a)),!e.plainText&&a.length>e.messageMaxLength&&(// extend settings for error massege
...
var N,k,A=function(){E.classList.add("nx-remove");var e=t.document.getElementById(o.overlayID);e&&y.childElementCount<=0&&e.classList.add("nx-remove"),clearTimeout(N)},O=function(){if(E&&null!==E.parentNode&&E.parentNode.removeChild(E),y.childElementCount<=0&&null!==y.parentNode){y.parentNode.removeChild(y);var e=t.document.getElementById(o.overlayID);e&&null!==e.parentNode&&e.parentNode.removeChild(e)}clearTimeout(k)};// if callbackOrOptions or click to close: end
...
var S=function(){N=setTimeout(function(){A()},e.timeout),k=setTimeout(function(){O()},e.timeout+e.cssAnimationDuration)};S(),e.pauseOnHover&&(E.addEventListener("mouseenter",function(){E.classList.add("nx-paused"),clearTimeout(N),clearTimeout(k)}),E.addEventListener("mouseleave",function(){E.classList.remove("nx-paused"),S()}));// pause auto remove: end
}// else auto remove: end
}// remove by timeout or click: end
// notify - show only the last one: begin
if(e.showOnlyTheLastOne&&c>0)for(var B=t.document.querySelectorAll("[id^="+e.ID+"-]:not([id="+e.ID+"-"+c+"])"),C=0;C<B.length;C++){var R=B[C];null!==R.parentNode&&R.parentNode.removeChild(R)}// notify - show only the last one: end
// extend new settings with the backup settings
e=s(!0,e,d)},p={Notify:{// Init
init:function(t){// extend options
e=s(!0,o,t),// internal css if exist
...
info:function(t,e,o){u(n.Info,t,e,o)}}};return"object"==typeof t.Notiflix?s(!0,t.Notiflix,{Notify:p.Notify}):{Notify:p.Notify}},"function"==typeof define&&define.amd?define([],function(){return n(e)}):"object"==typeof h?h=n(e):e.Notiflix=n(e);// utils is a library of generic helper functions non-specific to axios
let{toString:y}=Object.prototype,{getPrototypeOf:g}=Object,b=(o=Object.create(null),t=>{let e=y.call(t);return o[e]||(o[e]=e.slice(8,-1).toLowerCase())}),w=t=>(t=t.toLowerCase(),e=>b(e)===t),x=t=>e=>typeof e===t,{isArray:v}=Array,E=x("undefined"),N=w("ArrayBuffer"),k=x("string"),A=x("function"),O=x("number"),S=t=>null!==t&&"object"==typeof t,B=t=>{if("object"!==b(t))return!1;let e=g(t);return(null===e||e===Object.prototype||null===Object.getPrototypeOf(e))&&!(Symbol.toStringTag in t)&&!(Symbol.iterator in t)},C=w("Date"),R=w("File"),T=w("Blob"),I=w("FileList"),L=w("URLSearchParams");/**
 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&N(t.buffer)},isString:k,isNumber:O,isBoolean:t=>!0===t||!1===t,isObject:S,isPlainObject:B,isUndefined:E,isDate:C,isFile:R,isBlob:T,isRegExp:M,isFunction:A,isStream:t=>S(t)&&A(t.pipe),isURLSearchParams:L,isTypedArray:D,isFileList:I,forEach:U,merge:/**
...
G.from=(t,e,n,o,i,r)=>{let a=Object.create(K);return V.toFlatObject(t,a,function(t){return t!==Error.prototype},t=>"isAxiosError"!==t),G.call(a,t.message,e,n,o,i),a.cause=t,a.name=t.name,r&&Object.assign(a,r),a},r=function(t){// go through the array every three bytes, we'll deal with trailing stuff later
for(var e,n=t.length,o=n%3// if we have 1 byte left, pad 2 bytes
,i=[],r=0,a=n-o;r<a;r+=16383// must be multiple of 3
)i.push(function(t,e,n){for(var o,i=[],r=e;r<n;r+=3)i.push(Q[(o=(t[r]<<16&16711680)+(t[r+1]<<8&65280)+(255&t[r+2]))>>18&63]+Q[o>>12&63]+Q[o>>6&63]+Q[63&o]);return i.join("")}(t,r,r+16383>a?a:r+16383));return 1===o?i.push(Q[(e=t[n-1])>>2]+Q[e<<4&63]+"=="):2===o&&i.push(Q[(e=(t[n-2]<<8)+t[n-1])>>10]+Q[e>>4&63]+Q[e<<2&63]+"="),i.join("")};for(var Q=[],X=[],Z="undefined"!=typeof Uint8Array?Uint8Array:Array,tt="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",te=0,tn=tt.length;te<tn;++te)Q[te]=tt[te],X[tt.charCodeAt(te)]=te;// Support decoding URL-safe base64 strings, as Node.js does.
// See: https://en.wikipedia.org/wiki/Base64#URL_applications
X["-".charCodeAt(0)]=62,X["_".charCodeAt(0)]=63,a=function(t,e,n,o,i){var r,a,s=8*i-o-1,l=(1<<s)-1,f=l>>1,c=-7,u=n?i-1:0,p=n?-1:1,d=t[e+u];for(u+=p,r=d&(1<<-c)-1,d>>=-c,c+=s;c>0;r=256*r+t[e+u],u+=p,c-=8);for(a=r&(1<<-c)-1,r>>=-c,c+=o;c>0;a=256*a+t[e+u],u+=p,c-=8);if(0===r)r=1-f;else{if(r===l)return a?NaN:(d?-1:1)*(1/0);a+=Math.pow(2,o),r-=f}return(d?-1:1)*a*Math.pow(2,r-o)},s=function(t,e,n,o,i,r){var a,s,l,f=8*r-i-1,c=(1<<f)-1,u=c>>1,p=23===i?5960464477539062e-23:0,d=o?0:r-1,h=o?1:-1,m=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(s=isNaN(e)?1:0,a=c):(a=Math.floor(Math.log(e)/Math.LN2),e*(l=Math.pow(2,-a))<1&&(a--,l*=2),a+u>=1?e+=p/l:e+=p*Math.pow(2,1-u),e*l>=2&&(a++,l/=2),a+u>=c?(s=0,a=c):a+u>=1?(s=(e*l-1)*Math.pow(2,i),a+=u):(s=e*Math.pow(2,u-1)*Math.pow(2,i),a=0));i>=8;t[n+d]=255&s,d+=h,s/=256,i-=8);for(a=a<<i|s,f+=i;f>0;t[n+d]=255&a,d+=h,a/=256,f-=8);t[n+d-h]|=128*m};let to="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
if("number"==typeof t){if("string"==typeof e)throw TypeError('The "string" argument must be of type string. Received type number');return tl(t)}return ta(t,e,n)}function ta(t,e,n){if("string"==typeof t)return function(t,e){if(("string"!=typeof e||""===e)&&(e="utf8"),!tr.isEncoding(e))throw TypeError("Unknown encoding: "+e);let n=0|tp(t,e),o=ti(n),i=o.write(t,e);return i!==n&&// cause everything after the first invalid character to be ignored. (e.g.
...
?ti(0):tf(t):"Buffer"===t.type&&Array.isArray(t.data)?tf(t.data):void 0}(t);if(i)return i;if("undefined"!=typeof Symbol&&null!=Symbol.toPrimitive&&"function"==typeof t[Symbol.toPrimitive])return tr.from(t[Symbol.toPrimitive]("string"),e,n);throw TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof t)}function ts(t){if("number"!=typeof t)throw TypeError('"size" argument must be of type number');if(t<0)throw RangeError('The value "'+t+'" is invalid for option "size"')}function tl(t){return ts(t),ti(t<0?0:0|tu(t))}function tf(t){let e=t.length<0?0:0|tu(t.length),n=ti(e);for(let o=0;o<e;o+=1)n[o]=255&t[o];return n}function tc(t,e,n){let o;if(e<0||t.byteLength<e)throw RangeError('"offset" is outside of buffer bounds');if(t.byteLength<e+(n||0))throw RangeError('"length" is outside of buffer bounds');return(// Return an augmented `Uint8Array` instance
...
;e=(""+e).toLowerCase(),i=!0}}function td(t,e,n){let o=!1;// Return early if start > this.length. Done here to prevent potential uint32
// coercion fail below.
...
(n>>>=0)<=(e>>>=0)))return"";for(t||(t="utf8");;)switch(t){case"hex":return function(t,e,n){let o=t.length;(!e||e<0)&&(e=0),(!n||n<0||n>o)&&(n=o);let i="";for(let o=e;o<n;++o)i+=tj[t[o]];return i}(this,e,n);case"utf8":case"utf-8":return tg(this,e,n);case"ascii":return function(t,e,n){let o="";n=Math.min(t.length,n);for(let i=e;i<n;++i)o+=String.fromCharCode(127&t[i]);return o}(this,e,n);case"latin1":case"binary":return function(t,e,n){let o="";n=Math.min(t.length,n);for(let i=e;i<n;++i)o+=String.fromCharCode(t[i]);return o}(this,e,n);case"base64":var i,a;return i=e,a=n,0===i&&a===this.length?r(this):r(this.slice(i,a));case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return function(t,e,n){let o=t.slice(e,n),i="";// If bytes.length is odd, the last 8 bits must be ignored (same as node.js)
for(let t=0;t<o.length-1;t+=2)i+=String.fromCharCode(o[t]+256*o[t+1]);return i}(this,e,n);default:if(o)throw TypeError("Unknown encoding: "+t);t=(t+"").toLowerCase(),o=!0}}function th(t,e,n){let o=t[e];t[e]=t[n],t[n]=o}// Finds either the first index of `val` in `buffer` at offset >= `byteOffset`,
...
,"function"==typeof Uint8Array.prototype.indexOf)?i?Uint8Array.prototype.indexOf.call(t,e,n):Uint8Array.prototype.lastIndexOf.call(t,e,n):ty(t,[e],n,o,i);throw TypeError("val must be string, number or Buffer")}function ty(t,e,n,o,i){let r,a=1,s=t.length,l=e.length;if(void 0!==o&&("ucs2"===(o=String(o).toLowerCase())||"ucs-2"===o||"utf16le"===o||"utf-16le"===o)){if(t.length<2||e.length<2)return -1;a=2,s/=2,l/=2,n/=2}function f(t,e){return 1===a?t[e]:t.readUInt16BE(e*a)}if(i){let o=-1;for(r=n;r<s;r++)if(f(t,r)===f(e,-1===o?0:r-o)){if(-1===o&&(o=r),r-o+1===l)return o*a}else -1!==o&&(r-=r-o),o=-1}else for(n+l>s&&(n=s-l),r=n;r>=0;r--){let n=!0;for(let o=0;o<l;o++)if(f(t,r+o)!==f(e,o)){n=!1;break}if(n)return r}return -1}function tg(t,e,n){n=Math.min(t.length,n);let o=[],i=e;for(;i<n;){let e=t[i],r=null,a=e>239?4:e>223?3:e>191?2:1;if(i+a<=n){let n,o,s,l;switch(a){case 1:e<128&&(r=e);break;case 2:(192&(n=t[i+1]))==128&&(l=(31&e)<<6|63&n)>127&&(r=l);break;case 3:n=t[i+1],o=t[i+2],(192&n)==128&&(192&o)==128&&(l=(15&e)<<12|(63&n)<<6|63&o)>2047&&(l<55296||l>57343)&&(r=l);break;case 4:n=t[i+1],o=t[i+2],s=t[i+3],(192&n)==128&&(192&o)==128&&(192&s)==128&&(l=(15&e)<<18|(63&n)<<12|(63&o)<<6|63&s)>65535&&l<1114112&&(r=l)}}null===r?(// we did not generate a valid codePoint so insert a
// replacement char (U+FFFD) and advance only 1 byte
r=65533,a=1):r>65535&&(// encode to utf16 (surrogate pair dance)
r-=65536,o.push(r>>>10&1023|55296),r=56320|1023&r),o.push(r),i+=a}return function(t){let e=t.length;if(e<=4096)return String.fromCharCode.apply(String,t)// avoid extra slice()
;// Decode in chunks to avoid "call stack size exceeded".
let n="",o=0;for(;o<e;)n+=String.fromCharCode.apply(String,t.slice(o,o+=4096));return n}(o)}/*
 * Need to make sure that buffer isn't trying to write out of bounds.
 */function tb(t,e,n){if(t%1!=0||t<0)throw RangeError("offset is not uint");if(t+e>n)throw RangeError("Trying to access beyond buffer length")}function tw(t,e,n,o,i,r){if(!tr.isBuffer(t))throw TypeError('"buffer" argument must be a Buffer instance');if(e>i||e<r)throw RangeError('"value" argument is out of bounds');if(n+o>t.length)throw RangeError("Index out of range")}function tx(t,e,n,o,i){tB(e,o,i,t,n,7);let r=Number(e&BigInt(4294967295));t[n++]=r,r>>=8,t[n++]=r,r>>=8,t[n++]=r,r>>=8,t[n++]=r;let a=Number(e>>BigInt(32)&BigInt(4294967295));return t[n++]=a,a>>=8,t[n++]=a,a>>=8,t[n++]=a,a>>=8,t[n++]=a,n}function tv(t,e,n,o,i){tB(e,o,i,t,n,7);let r=Number(e&BigInt(4294967295));t[n+7]=r,r>>=8,t[n+6]=r,r>>=8,t[n+5]=r,r>>=8,t[n+4]=r;let a=Number(e>>BigInt(32)&BigInt(4294967295));return t[n+3]=a,a>>=8,t[n+2]=a,a>>=8,t[n+1]=a,a>>=8,t[n]=a,n+8}function tE(t,e,n,o,i,r){if(n+o>t.length||n<0)throw RangeError("Index out of range")}function tN(t,e,n,o,i){return e=+e,n>>>=0,i||tE(t,e,n,4,34028234663852886e22,-34028234663852886e22),s(t,e,n,o,23,4),n+4}function tk(t,e,n,o,i){return e=+e,n>>>=0,i||tE(t,e,n,8,17976931348623157e292,-17976931348623157e292),s(t,e,n,o,52,8),n+8}/**
 ...
 **/tr.from=function(t,e,n){return ta(t,e,n)},// Note: Change prototype *after* Buffer.from is defined to workaround Chrome bug:
// https://github.com/feross/buffer/pull/148
Object.setPrototypeOf(tr.prototype,Uint8Array.prototype),Object.setPrototypeOf(tr,Uint8Array),/**
 * Creates a new filled Buffer instance.
 * alloc(size[, fill[, encoding]])
 **/tr.alloc=function(t,e,n){return(ts(t),t<=0)?ti(t):void 0!==e?"string"==typeof n?ti(t).fill(e,n):ti(t).fill(e):ti(t)},/**
...
if(e<0||this.length<e||this.length<n)throw RangeError("Out of range index");if(n<=e)return this;if(e>>>=0,n=void 0===n?this.length:n>>>0,t||(t=0),"number"==typeof t)for(i=e;i<n;++i)this[i]=t;else{let r=tr.isBuffer(t)?t:tr.from(t,o),a=r.length;if(0===a)throw TypeError('The value "'+t+'" is invalid for argument "value"');for(i=0;i<n-e;++i)this[i+e]=r[i%a]}return this};// CUSTOM ERRORS
// =============
// Simplified versions from Node, changed for Buffer-only usage
let tA={};function tO(t,e,n){tA[t]=class extends n{constructor(){super(),Object.defineProperty(this,"message",{value:e.apply(this,arguments),writable:!0,configurable:!0}),// Add the error code to the name to include it in the stack trace.
this.name=`${this.name} [${t}]`,// Access the stack to generate the error message including the error code
// from the name.
this.stack// eslint-disable-line no-unused-expressions
,// Reset the name to the actual name.
delete this.name}get code(){return t}set code(t){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:t,writable:!0})}toString(){return`${this.name} [${t}]: ${this.message}`}}}function tS(t){let e="",n=t.length,o="-"===t[0]?1:0;for(;n>=o+4;n-=3)e=`_${t.slice(n-3,n)}${e}`;return`${t.slice(0,n)}${e}`}function tB(t,e,n,o,i,r){if(t>n||t<e){let o;let i="bigint"==typeof e?"n":"";throw o=r>3?0===e||e===BigInt(0)?`>= 0${i} and < 2${i} ** ${(r+1)*8}${i}`:`>= -(2${i} ** ${(r+1)*8-1}${i}) and < 2 ** ${(r+1)*8-1}${i}`:`>= ${e}${i} and <= ${n}${i}`,new tA.ERR_OUT_OF_RANGE("value",o,t)}tC(i,"offset"),(void 0===o[i]||void 0===o[i+r])&&tR(i,o.length-(r+1))}function tC(t,e){if("number"!=typeof t)throw new tA.ERR_INVALID_ARG_TYPE(e,"number",t)}function tR(t,e,n){if(Math.floor(t)!==t)throw tC(t,n),new tA.ERR_OUT_OF_RANGE(n||"offset","an integer",t);if(e<0)throw new tA.ERR_BUFFER_OUT_OF_BOUNDS;throw new tA.ERR_OUT_OF_RANGE(n||"offset",`>= ${n?1:0} and <= ${e}`,t)}tO("ERR_BUFFER_OUT_OF_BOUNDS",function(t){return t?`${t} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),tO("ERR_INVALID_ARG_TYPE",function(t,e){return`The "${t}" argument must be of type number. Received type ${typeof e}`},TypeError),tO("ERR_OUT_OF_RANGE",function(t,e,n){let o=`The value of "${t}" is out of range.`,i=n;return Number.isInteger(n)&&Math.abs(n)>4294967296?i=tS(String(n)):"bigint"==typeof n&&(i=String(n),(n>BigInt(2)**BigInt(32)||n<-(BigInt(2)**BigInt(32)))&&(i=tS(i)),i+="n"),o+=` It must be ${e}. Received ${i}`},RangeError);// HELPER FUNCTIONS
// ================
let tT=/[^+/0-9A-Za-z-_]/g;function tI(t,e){let n;e=e||1/0;let o=t.length,i=null,r=[];for(let a=0;a<o;++a){// is surrogate component
if((n=t.charCodeAt(a))>55295&&n<57344){// last char was a lead
if(!i){// no lead yet
if(n>56319||a+1===o){(e-=3)>-1&&r.push(239,191,189);continue}// valid lead
...
let tj=function(){let t="0123456789abcdef",e=Array(256);for(let n=0;n<16;++n){let o=16*n;for(let i=0;i<16;++i)e[o+i]=t[n]+t[i]}return e}();// Return not function with Error if BigInt not supported
...
t=tz(t),!n&&e?"["+t+"]":t)}).join(n?".":""):e}let t$=V.toFlatObject(V,{},null,function(t){return/^is[A-Z]/.test(t)});var tW=/**
...
return!V.isUndefined(e[t])});let o=n.metaTokens,i=n.visitor||c,r=n.dots,a=n.indexes,s=n.Blob||"undefined"!=typeof Blob&&Blob,l=s&&V.isSpecCompliantForm(e);if(!V.isFunction(i))throw TypeError("visitor must be a function");function f(t){if(null===t)return"";if(V.isDate(t))return t.toISOString();if(!l&&V.isBlob(t))throw new G("Blob is not supported. Use a Buffer instead.");return V.isArrayBuffer(t)||V.isTypedArray(t)?l&&"function"==typeof Blob?new Blob([t]):tr.from(t):t}/**
   ...
   */function c(t,n,i){let s=t;if(t&&!i&&"object"==typeof t){if(V.endsWith(n,"{}"))// eslint-disable-next-line no-param-reassign
n=o?n:n.slice(0,-2),// eslint-disable-next-line no-param-reassign
t=JSON.stringify(t);else{var l;if(V.isArray(t)&&(l=t,V.isArray(l)&&!l.some(tF))||(V.isFileList(t)||V.endsWith(n,"[]"))&&(s=V.toArray(t)))return(// eslint-disable-next-line no-param-reassign
n=tz(n),s.forEach(function(t,o){V.isUndefined(t)||null===t||e.append(!0===a?tM([n],o,r):null===a?n:n+"[]",f(t))}),!1)}}return!!tF(t)||(e.append(tM(i,n,r),f(t)),!1)}let u=[],p=Object.assign(t$,{defaultVisitor:c,convertValue:f,isVisitable:tF});if(!V.isObject(t))throw TypeError("data must be an object");return!function t(n,o){if(!V.isUndefined(n)){if(-1!==u.indexOf(n))throw Error("Circular reference detected in "+o.join("."));u.push(n),V.forEach(n,function(n,r){let a=!(V.isUndefined(n)||null===n)&&i.call(e,n,V.isString(r)?r.trim():r,o,p);!0===a&&t(n,o?o.concat(r):[r])}),u.pop()}}(t),e};/**
 ...
 *
 * @returns {void}
 */function tH(t,e){this._pairs=[],t&&tW(t,this,e)}let tJ=tH.prototype;/**
 ...
 */function tV(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function tG(t,e,n){let o;/*eslint no-param-reassign:0*/if(!e)return t;let i=n&&n.encode||tV,r=n&&n.serialize;if(o=r?r(e,n):V.isURLSearchParams(e)?e.toString():new tH(e,n).toString(i)){let e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+o}return t}tJ.append=function(t,e){this._pairs.push([t,e])},tJ.toString=function(t){let e=t?function(e){return t.call(this,e,tq)}:tq;return this._pairs.map(function(t){return e(t[0])+"="+e(t[1])},"").join("&")};var tK=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(t){V.forEach(this.handlers,function(e){null!==e&&t(e)})}},tY={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},tQ="undefined"!=typeof URLSearchParams?URLSearchParams:tH,tX="undefined"!=typeof FormData?FormData:null,tZ="undefined"!=typeof Blob?Blob:null;/**
...
self instanceof WorkerGlobalScope&&"function"==typeof self.importScripts;var t2={classes:{URLSearchParams:tQ,FormData:tX,Blob:tZ},isStandardBrowserEnv:t0,isStandardBrowserWebWorkerEnv:t1,protocols:["http","https","file","blob","url","data"]},t5=/**
 * It takes a FormData object and returns a JavaScript object
 *
 * @param {string} formData The FormData object to convert to JSON.
 *
 * @returns {Object<string, any> | null} The converted object.
 */function(t){if(V.isFormData(t)&&V.isFunction(t.entries)){let e={};return V.forEachEntry(t,(t,n)=>{!function t(e,n,o,i){let r=e[i++],a=Number.isFinite(+r),s=i>=e.length;if(r=!r&&V.isArray(o)?o.length:r,s)return V.hasOwnProp(o,r)?o[r]=[o[r],n]:o[r]=n,!a;o[r]&&V.isObject(o[r])||(o[r]=[]);let l=t(e,n,o[r],i);return l&&V.isArray(o[r])&&(o[r]=/**
 * Convert an array to an object.
 *
 * @param {Array<any>} arr - The array to convert to an object.
 *
 * @returns An object with the same keys and values as the array.
 */function(t){let e,n;let o={},i=Object.keys(t),r=i.length;for(e=0;e<r;e++)o[n=i[e]]=t[n];return o}(o[r])),!a}(V.matchAll(/\w+|\[(\w*)]/g,t).map(t=>"[]"===t[0]?"":t[1]||t[0]),n,e,0)}),e}return null};let t3={transitional:tY,adapter:t2.isNode?"http":"xhr",transformRequest:[function(t,e){let n;let o=e.getContentType()||"",i=o.indexOf("application/json")>-1,r=V.isObject(t);r&&V.isHTMLForm(t)&&(t=new FormData(t));let a=V.isFormData(t);if(a)return i&&i?JSON.stringify(t5(t)):t;if(V.isArrayBuffer(t)||V.isBuffer(t)||V.isStream(t)||V.isFile(t)||V.isBlob(t))return t;if(V.isArrayBufferView(t))return t.buffer;if(V.isURLSearchParams(t))return e.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),t.toString();if(r){if(o.indexOf("application/x-www-form-urlencoded")>-1){var s,l;return(s=t,l=this.formSerializer,tW(s,new t2.classes.URLSearchParams,Object.assign({visitor:function(t,e,n,o){return t2.isNode&&V.isBuffer(t)?(this.append(e,t.toString("base64")),!1):o.defaultVisitor.apply(this,arguments)}},l))).toString()}if((n=V.isFileList(t))||o.indexOf("multipart/form-data")>-1){let e=this.env&&this.env.FormData;return tW(n?{"files[]":t}:t,e&&new e,this.formSerializer)}}return r||i?(e.setContentType("application/json",!1),/**
...
let t8=V.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]);var /**
...
return{get:()=>t,set(t){this[n]=t}}}),V.freezeMethods(en),V.inherits(er,G,{__CANCEL__:!0});var ea=t2.isStandardBrowserEnv?{write:function(t,e,n,o,i,r){let a=[];a.push(t+"="+encodeURIComponent(e)),V.isNumber(n)&&a.push("expires="+new Date(n).toGMTString()),V.isString(o)&&a.push("path="+o),V.isString(i)&&a.push("domain="+i),!0===r&&a.push("secure"),document.cookie=a.join("; ")},read:function(t){let e=document.cookie.match(RegExp("(^|;\\s*)("+t+")=([^;]*)"));return e?decodeURIComponent(e[3]):null},remove:function(t){this.write(t,"",Date.now()-864e5)}}:{write:function(){},read:function(){return null},remove:function(){}};function es(t,e){return t&&!/^([a-z][a-z\d+\-.]*:)?\/\//i.test(e)?e?t.replace(/\/+$/,"")+"/"+e.replace(/^\/+/,""):t:e}var el=t2.isStandardBrowserEnv?// whether the request URL is of the same origin as current location.
 ...
 * @returns {Function}
 */function(t,e){let n;t=t||10;let o=Array(t),i=Array(t),r=0,a=0;return e=void 0!==e?e:1e3,function(s){let l=Date.now(),f=i[a];n||(n=l),o[r]=s,i[r]=l;let c=a,u=0;for(;c!==r;)u+=o[c++],c%=t;if((r=(r+1)%t)===a&&(a=(a+1)%t),l-n<e)return;let p=f&&l-f;return p?Math.round(1e3*u/p):void 0}};function ec(t,e){let n=0,o=ef(50,250);return i=>{let r=i.loaded,a=i.lengthComputable?i.total:void 0,s=r-n,l=o(s),f=r<=a;n=r;let c={loaded:r,total:a,progress:a?r/a:void 0,bytes:s,rate:l||void 0,estimated:l&&a&&f?(a-r)/l:void 0,event:i};c[e?"download":"upload"]=!0,t(c)}}let eu="undefined"!=typeof XMLHttpRequest;var ep=eu&&function(t){return new Promise(function(e,n){let o,i=t.data,r=en.from(t.headers).normalize(),a=t.responseType;function s(){t.cancelToken&&t.cancelToken.unsubscribe(o),t.signal&&t.signal.removeEventListener("abort",o)}V.isFormData(i)&&(t2.isStandardBrowserEnv||t2.isStandardBrowserWebWorkerEnv?r.setContentType(!1):r.setContentType("multipart/form-data;",!1));let l=new XMLHttpRequest;// HTTP basic authentication
if(t.auth){let e=t.auth.username||"",n=t.auth.password?unescape(encodeURIComponent(t.auth.password)):"";r.set("Authorization","Basic "+btoa(e+":"+n))}let f=es(t.baseURL,t.url);function c(){if(!l)return;// Prepare the response
let o=en.from("getAllResponseHeaders"in l&&l.getAllResponseHeaders()),i=a&&"text"!==a&&"json"!==a?l.response:l.responseText,r={data:i,status:l.status,statusText:l.statusText,headers:o,config:t,request:l};!function(t,e,n){let o=n.config.validateStatus;!n.status||!o||o(n.status)?t(n):e(new G("Request failed with status code "+n.status,[G.ERR_BAD_REQUEST,G.ERR_BAD_RESPONSE][Math.floor(n.status/100)-4],n.config,n.request,n))}(function(t){e(t),s()},function(t){n(t),s()},r),// Clean up request
...
let e=(t.withCredentials||el(f))&&t.xsrfCookieName&&ea.read(t.xsrfCookieName);e&&r.set(t.xsrfHeaderName,e)}// Remove Content-Type if data is undefined
void 0===i&&r.setContentType(null),"setRequestHeader"in l&&V.forEach(r.toJSON(),function(t,e){l.setRequestHeader(e,t)}),V.isUndefined(t.withCredentials)||(l.withCredentials=!!t.withCredentials),a&&"json"!==a&&(l.responseType=t.responseType),"function"==typeof t.onDownloadProgress&&l.addEventListener("progress",ec(t.onDownloadProgress,!0)),"function"==typeof t.onUploadProgress&&l.upload&&l.upload.addEventListener("progress",ec(t.onUploadProgress)),(t.cancelToken||t.signal)&&(// Handle cancellation
...
l.send(i||null)})};let ed={http:null,xhr:ep};V.forEach(ed,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
}Object.defineProperty(t,"adapterName",{value:e})}});var eh={getAdapter:t=>{let e,n;t=V.isArray(t)?t:[t];let{length:o}=t;for(let i=0;i<o&&(e=t[i],!(n=V.isString(e)?ed[e.toLowerCase()]:e));i++);if(!n){if(!1===n)throw new G(`Adapter ${e} is not supported by the environment`,"ERR_NOT_SUPPORT");throw Error(V.hasOwnProp(ed,e)?`Adapter '${e}' is not available in the build`:`Unknown adapter '${e}'`)}if(!V.isFunction(n))throw TypeError("adapter is not a function");return n},adapters:ed};/**
...
t.data=eo.call(t,t.transformRequest),-1!==["post","put","patch"].indexOf(t.method)&&t.headers.setContentType("application/x-www-form-urlencoded",!1);let e=eh.getAdapter(t.adapter||t3.adapter);return e(t).then(function(e){return em(t),// Transform response data
e.data=eo.call(t,t.transformResponse,e),e.headers=en.from(e.headers),e},function(e){return!ei(e)&&(em(t),e&&e.response&&(e.response.data=eo.call(t,t.transformResponse,e.response),e.response.headers=en.from(e.response.headers))),Promise.reject(e)})}let eg=t=>t instanceof en?t.toJSON():t;function eb(t,e){// eslint-disable-next-line no-param-reassign
...
function a(t,e){return V.isUndefined(e)?V.isUndefined(t)?void 0:o(void 0,t):o(void 0,e)}// eslint-disable-next-line consistent-return
function s(n,i,r){return r in e?o(n,i):r in t?o(void 0,n):void 0}let l={url:r,method:r,data:r,baseURL:a,transformRequest:a,transformResponse:a,paramsSerializer:a,timeout:a,timeoutMessage:a,withCredentials:a,adapter:a,responseType:a,xsrfCookieName:a,xsrfHeaderName:a,onUploadProgress:a,onDownloadProgress:a,decompress:a,maxContentLength:a,maxBodyLength:a,beforeRedirect:a,transport:a,httpAgent:a,httpsAgent:a,cancelToken:a,socketPath:a,responseEncoding:a,validateStatus:s,headers:(t,e)=>i(eg(t),eg(e),!0)};return V.forEach(Object.keys(Object.assign({},t,e)),function(o){let r=l[o]||i,a=r(t[o],e[o],o);V.isUndefined(a)&&r!==s||(n[o]=a)}),n}let ew="1.5.0",ex={};// eslint-disable-next-line func-names
["object","boolean","number","function","string","symbol"].forEach((t,e)=>{ex[t]=function(n){return typeof n===t||"a"+(e<1?"n ":" ")+t}});let ev={};/**
 ...
 *
 * @returns {object}
 */function(t,e,n){if("object"!=typeof t)throw new G("options must be an object",G.ERR_BAD_OPTION_VALUE);let o=Object.keys(t),i=o.length;for(;i-- >0;){let r=o[i],a=e[r];if(a){let e=t[r],n=void 0===e||a(e,r,t);if(!0!==n)throw new G("option "+r+" must be "+n,G.ERR_BAD_OPTION_VALUE);continue}if(!0!==n)throw new G("Unknown option "+r,G.ERR_BAD_OPTION)}},validators:ex};let eN=eE.validators;/**
 * Create a new instance of Axios
 *
 * @param {Object} instanceConfig The default config for the instance
 *
 * @return {Axios} A new instance of Axios
 */class ek{constructor(t){this.defaults=t,this.interceptors={request:new tK,response:new tK}}/**
   * Dispatch a request
   *
   ...
   */request(t,e){let n,o;"string"==typeof t?(e=e||{}).url=t:e=t||{},e=eb(this.defaults,e);let{transitional:i,paramsSerializer:r,headers:a}=e;void 0!==i&&eE.assertOptions(i,{silentJSONParsing:eN.transitional(eN.boolean),forcedJSONParsing:eN.transitional(eN.boolean),clarifyTimeoutError:eN.transitional(eN.boolean)},!1),null!=r&&(V.isFunction(r)?e.paramsSerializer={serialize:r}:eE.assertOptions(r,{encode:eN.function,serialize:eN.function},!0)),// Set config.method
e.method=(e.method||this.defaults.method||"get").toLowerCase();// Flatten headers
let s=a&&V.merge(a.common,a[e.method]);a&&V.forEach(["delete","get","head","post","put","patch","common"],t=>{delete a[t]}),e.headers=en.concat(s,a);// filter out skipped interceptors
let l=[],f=!0;this.interceptors.request.forEach(function(t){("function"!=typeof t.runWhen||!1!==t.runWhen(e))&&(f=f&&t.synchronous,l.unshift(t.fulfilled,t.rejected))});let c=[];this.interceptors.response.forEach(function(t){c.push(t.fulfilled,t.rejected)});let u=0;if(!f){let t=[ey.bind(this),void 0];for(t.unshift.apply(t,l),t.push.apply(t,c),o=t.length,n=Promise.resolve(e);u<o;)n=n.then(t[u++],t[u++]);return n}o=l.length;let p=e;for(u=0;u<o;){let t=l[u++],e=l[u++];try{p=t(p)}catch(t){e.call(this,t);break}}try{n=ey.call(this,p)}catch(t){return Promise.reject(t)}for(u=0,o=c.length;u<o;)n=n.then(c[u++],c[u++]);return n}getUri(t){t=eb(this.defaults,t);let e=es(t.baseURL,t.url);return tG(e,t.params,t.paramsSerializer)}}V.forEach(["delete","get","head","options"],function(t){/*eslint func-names:0*/ek.prototype[t]=function(e,n){return this.request(eb(n||{},{method:t,url:e,data:(n||{}).data}))}}),V.forEach(["post","put","patch"],function(t){/*eslint func-names:0*/function e(e){return function(n,o,i){return this.request(eb(i||{},{method:t,headers:e?{"Content-Type":"multipart/form-data"}:{},url:n,data:o}))}}ek.prototype[t]=e(),ek.prototype[t+"Form"]=e(!0)});/**
 ...
 */function t(e){let n=new ek(e),o=m(ek.prototype.request,n);return V.extend(o,ek.prototype,n,{allOwnKeys:!0}),V.extend(o,n,null,{allOwnKeys:!0}),// Factory for creating new instances
o.create=function(n){return t(eb(e,n))},o}(t3);// Expose Axios class to allow class inheritance
eS.Axios=ek,// Expose Cancel & CancelToken
...
eS.mergeConfig=eb,eS.AxiosHeaders=en,eS.formToJSON=t=>t5(V.isHTMLForm(t)?new FormData(t):t),eS.getAdapter=eh.getAdapter,eS.HttpStatusCode=eO,eS.default=eS;// This module is intended to unwrap Axios default export as named.
// Keep top-level export same with static properties
// so that it can keep same with es module or cjs
let{Axios:eB,AxiosError:eC,CanceledError:eR,isCancel:eT,CancelToken:eI,VERSION:eL,all:eU,Cancel:e_,isAxiosError:ej,spread:eP,toFormData:eD,AxiosHeaders:eF,HttpStatusCode:ez,formToJSON:eM,getAdapter:e$,mergeConfig:eW}=eS;async function eq(t){try{let e=await eS.get("https://books-backend.p.goit.global/books/"+t);return e.data}catch(t){console.error("An error occurred while fetching data:",t)}}async function eH(){let{data:t}=await eS.get("https://books-backend.p.goit.global/books/category-list");return t}let eJ=document.querySelector(".categories-list");(async function t(){try{let t=await eH();if(!t.length){(0,h.Notify).failure("Oops something going wrong.");return}eJ.insertAdjacentHTML("beforeend",t.map(({list_name:t})=>`
    <li class="categories-list-item">
      <a href="#" class="categories-link">${t}</a>
    </li>
  `).join(""))}catch(t){console.log("TRY-CATCH:",t),(0,h.Notify).failure("Oops something going wrong.")}})(),eJ.addEventListener("click",t=>{t.preventDefault()}),p("ksGdE");var eV=p("6JpON");let eG=(t,e)=>{try{let n=JSON.stringify(e);localStorage.setItem(t,n)}catch(t){(0,eV.Notify).error("Set state error: ",t.message)}},eK=t=>{try{let e=localStorage.getItem(t);return null===e?void 0:JSON.parse(e)}catch(t){(0,eV.Notify).error("Get state error: ",t.message)}};var eV=p("6JpON");(0,eV.Loading).pulse({svgColor:"#eac645"});let eY=document.querySelector(".common-list"),eQ=document.querySelector(".main-title"),eX=document.querySelector(".categories-list"),eZ=window.innerWidth<767?1:window.innerWidth<1439?3:5;function e0(t){//render categories
let e=function(t){let e=[...t];for(let t=e.length-1;t>0;t--){let n=Math.floor(Math.random()*(t+1));[e[t],e[n]]=[e[n],e[t]]}return e}(t),n="";for(let t of(eQ.textContent="Best Sellers",eQ.insertAdjacentHTML("beforeend",'&nbsp;<span class="main-title main-title-wrapper">Books</span>'),e)){let{books:e,list_name:o}=t;n+=` 
        <li class="common-item">
        <h2 class="common-title">${o}</h2>
        <ul class="book-list">
            ${function(t,e){// render books inside the category
let n="";for(let o=0;o<e;o+=1){let{book_image:e,title:i,author:r,_id:a}=t[o];n+=`
              <li class="book-item" data-id="${a}" tabindex="0">
              <div class="thumb" data-id="${a}">
              <img src="${e||"../images/default_image.png"}" alt="${i}" class="book-img" data-id="${a}">
              <p class="notifications" data-id="${a}">quick view</p>
              </div> 
              <h3 class="book-title" data-id="${a}">${i}</h3>
              <p class="book-author" data-id="${a}">${r}</p>
              </li>
            `}return n}(e,eZ)}
        </ul>
        <button type="button" class="showMore-btn" name="${o}">see more</button>
    </li>`}eY.innerHTML=n}eX.firstElementChild.addEventListener("click",function(){(0,eV.Loading).pulse({svgColor:"#eac645"});let t=eK("data");e0(t),(0,eV.Loading).remove()}),window.addEventListener("resize",function(){// Check wether we should render markup or not.
let t=window.innerWidth<767?1:window.innerWidth<1439?3:5;if(t!=eZ){eZ=t;let e=eK("data");e0(e)}}),eq("top-books").then(t=>{eG("data",t),e0(t)}).catch(t=>(0,eV.Notify).failure(t)).finally(()=>(0,eV.Loading).remove());var eV=p("6JpON");let e1={categories:document.querySelector(".categories-list"),title:document.querySelector(".main-title"),list:document.querySelector(".common-list")},e2="Sorry, there are no books matching the selected category. Please select something else.",e5="Sorry, something went wrong. Try again!";e1.categories.addEventListener("click",function(t){"categories-link"===t.target.className&&(ne(t.target),e3=t.target.textContent.replaceAll(" ","%20"),t.target!==e1.categories.firstElementChild.firstElementChild&&((0,eV.Loading).pulse({svgColor:"#eac645"}),e4(e3).then(t=>{if(0===t.data.length)throw Error((0,eV.Notify).info(e2));let e=t.data[0].list_name;e1.title.textContent=e7(e),e1.title.insertAdjacentHTML("beforeend",`&nbsp;<span class="main-title main-title-wrapper">${nt(e)}</span>`),e1.list.innerHTML=e9(t.data)}).catch(function(t){t.response?(0,eV.Notify).failure(e5):t.request&&(0,eV.Notify).failure(e5)}).finally(()=>(0,eV.Loading).remove())))}),e1.list.addEventListener("click",function(t){if("showMore-btn"!==t.target.className)return;(0,eV.Loading).pulse({svgColor:"#eac645"}),e8=t.target.name.replaceAll(" ","%20");let e=Array.from(e1.categories.children);e.forEach(t=>{let e=t.firstElementChild.textContent.replaceAll(" ","%20");e===e8&&ne(t)}),e4(e8).then(t=>{if(0===t.data.length)throw Error((0,eV.Notify).info(e2));let e=t.data[0].list_name;e1.title.textContent=e7(e),e1.title.insertAdjacentHTML("beforeend",`&nbsp;<span class="main-title main-title-wrapper">${nt(e)}</span>`),e1.list.innerHTML=e9(t.data)}).catch(function(t){t.response?(0,eV.Notify).failure(e5):t.request&&(0,eV.Notify).failure(e5)}).finally(()=>(0,eV.Loading).remove())});let e3="",e8="",e6=e1.categories.firstElementChild.firstElementChild;async function e4(t){let e=`https://books-backend.p.goit.global/books/category?category=${t}`,n=await eS.get(e);return n}function e9(t){return t.map(({book_image:t,author:e,title:n,_id:o})=>{let i=`<li class="book-item" data-id="${o}" tabindex="0">
              <div class="thumb" data-id="${o}">
              <img src="${t||"../images/default_image.png"}" alt="${n}" class="book-img" data-id="${o}">
              <p class="notifications" data-id="${o}">quick view</p>
              </div> 
              <h3 class="book-title" data-id="${o}">${n}</h3>
              <p class="book-author" data-id="${o}">${e}</p>
              </li>`;return i}).join("")}function e7(t){let e=t.split(" ");return e.splice(0,e.length-1).join(" ")}function nt(t){let e=t.split(" ");return e[e.length-1]}function ne(t){e6&&e6.classList.remove("category-active"),t.classList.add("category-active"),e6=t}ne(e6);var nn={};nn=p("aNJCr").getBundleURL("EVgbq")+p("iE7OH").resolve("kSqT3");var no={};no=p("aNJCr").getBundleURL("EVgbq")+p("iE7OH").resolve("hTMkK");var ni={};ni=p("aNJCr").getBundleURL("EVgbq")+p("iE7OH").resolve("9Qt2K");//!------------------------------------------
let nr=document.querySelector(".common-list"),na=document.querySelector(".modal__content"),ns=document.querySelector("#book-modal"),nl=document.getElementById("book-modal"),nf=document.querySelector(".modal__close-btn"),nc=document.querySelector(".add-bookBtn");document.querySelector(".addNotification"),document.querySelector(".removeNotification");let nu=document.querySelector(".notification");document.querySelector(".remove-book");let np=document.querySelector(".modal");nr.addEventListener("click",function(t){t.target.closest(".book-item")&&nh(t.target.dataset.id).then(t=>{let{author:e,title:n,description:o,book_image:i,buy_links:r,list_name:a,_id:s}=t.data;nd={author:e,title:n,description:o,book_image:i,buy_links:r,list_name:a,id:s},//!--------------------
na.innerHTML="",na.insertAdjacentHTML("afterbegin",function({author:t,title:e,description:n,book_image:o,buy_links:i}){let r=`<div class="modal__img-container"> 
      ...
      <div class="modal__desc"> 
        ...
        <li>
        <a class="modal-book-shop-amazon" href=${nm(i,"Amazon")} target= _blank><img src="${/*@__PURE__*/f(nn)}" alt="Amazon"></a>
          
        </li>
        <li>
        <a class="modal-book-shop" href=${nm(i,"Apple Books")} target= _blank><img src="${/*@__PURE__*/f(no)}" alt="Apple-Books"></a>
          

        </li>
        <li>
        <a class="modal-book-shop" href=${nm(i,"Bookshop")} target= _blank> <img src="${/*@__PURE__*/f(ni)}" alt="Book-Shop"></a>
         
       
        </li>
      </ul> 
</div>`;return r}(t.data)),document.body.style.overflow="hidden",ns.classList.remove("is-hidden"),nc.textContent=`${ng(t.data._id)}`,"Remove from the shopping list"===nc.textContent?nu.classList.remove("hidden"):"Add to shopping list"===nc.textContent&&nu.classList.add("hidden")})});let nd={};async function nh(t){let e=`https://books-backend.p.goit.global/books/${t}`,n=await eS.get(e);return n}function nm(t,e){for(let{name:n,url:o}of t)if(n===e)return o}document.addEventListener("DOMContentLoaded",function(){function t(){na.innerHTML="",document.body.style.overflow="auto",nl.classList.add("is-hidden")}nf.addEventListener("click",t),document.addEventListener("keydown",function(e){"Escape"===e.key&&t()}),nl.addEventListener("click",function(e){e.target===nl&&t()}),na.addEventListener("click",function(t){t.stopPropagation()})});//!--------------------------------
let ny="bookArr";//!--------------------------------
//! Check if the book has alredy been in LS
//!-------------------------------------------------------
function ng(t){let e=JSON.parse(localStorage.getItem(ny));if(!e)return"Add to shopping list";let n=e.findIndex(e=>e.id===t);return -1===n?"Add to shopping list":"Remove from the shopping list"}//!--------------------------------------------------------
function nb(t){let e=JSON.parse(localStorage.getItem(ny));if(!e)return;let n=e.findIndex(e=>e.id===t);-1!==n?nu.classList.remove("hidden"):nu.classList.add("hidden")}np.addEventListener("click",function(t){"Add to shopping list"===t.target.textContent?function(t){let e=JSON.parse(localStorage.getItem(ny))??[];if(0===e.length)e.push(t);else if(e.length>0){let n=t.id;JSON.parse(localStorage.getItem(ny));let o=e.findIndex(({id:t})=>t===n);-1===o&&e.push(t)}localStorage.setItem(ny,JSON.stringify(e)),nc.textContent=`${ng(t.id)}`,nb(t.id)}(nd):"Remove from the shopping list"===t.target.textContent&&function({id:t}){let e=JSON.parse(localStorage.getItem(ny));e.find(e=>e.id===t);let n=e.findIndex(e=>e.id===t);e.splice(n,1),localStorage.setItem(ny,JSON.stringify(e)),nc.textContent=`${ng(t)}`,nb(t)}(nd)}),// import { initializeApp } from 'firebase/app';
...
//   }
// });
p("E6hPi")}();//# sourceMappingURL=index.c6a4eb83.js.map

//# sourceMappingURL=index.c6a4eb83.js.map
