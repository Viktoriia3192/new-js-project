function t(t){return t&&t.__esModule?t.default:t}var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},i={},o=e.parcelRequired7c6;null==o&&((o=function(t){if(t in n)return n[t].exports;if(t in i){var e=i[t];delete i[t];var o={id:t,exports:{}};return n[t]=o,e.call(o.exports,o,o.exports),o.exports}var r=Error("Cannot find module '"+t+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(t,e){i[t]=e},e.parcelRequired7c6=o),o("7Y9D8");var r={};r=new URL(o("kyEFX").resolve("8XY7q"),import.meta.url).toString();var s={};s=new URL(o("kyEFX").resolve("3WxNb"),import.meta.url).toString();var a={};a=new URL(o("kyEFX").resolve("lJIFT"),import.meta.url).toString();var u={};window,u=/******/function(t){/******/// The module cache
...
return e.prototype=t,new e};/***/},/* 20 *//***/function(t,e,n){var i=n(3),o=n(7),r=n(21),s=n(22),a=n(24),u=n(25),c=n(0),l=n(4),p=n(28),f=n(9),h={page:'<a href="#" class="tui-page-btn">{{page}}</a>',currentPage:'<strong class="tui-page-btn tui-is-selected">{{page}}</strong>',moveButton:'<a href="#" class="tui-page-btn tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></a>',disabledMoveButton:'<span class="tui-page-btn tui-is-disabled tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></span>',moreButton:'<a href="#" class="tui-page-btn tui-{{type}}-is-ellip"><span class="tui-ico-ellip">...</span></a>'},g=["first","prev","next","last"],d=["prev","next"],m=o(/** @lends View.prototype */{init:function(t,e,n){/**
       * Root element
       * @type {HTMLElement}
       * @private
 ...
 * @author NHN FE Development Lab <dl_javascript@nhn.com>
 */var i=n(8),o=n(3),r=n(2),s=n(4),a=n(0),u=/{{\s?|\s?}}/g,c=/^[a-zA-Z0-9_@]+\[[a-zA-Z0-9_@"']+\]$/,l=/\[\s?|\s?\]/,p=/^[a-zA-Z_]+\.[a-zA-Z_]+$/,f=/\./,h=/^["']\w+["']$/,g=/"|'/g,d=/^-?\d+\.?\d*$/,m={if:/**
 ...
 * @returns {string}
 * @private
 */function(t,e,n){var o=i("as",t),r=t[o+1],s=x(t.slice(0,o),n),u={};return u[r]=s,y(e,a(n,u))||""}},_=3==="a".split(/a/).length?function(t,e){return t.split(e)}:function(t,e){var n,i,o=[],r=0;for(e.global||(e=RegExp(e,"g")),n=e.exec(t);null!==n;)i=n.index,o.push(t.slice(r,i)),r=i+n[0].length,n=e.exec(t);return o.push(t.slice(r)),o};/**
 ...
 * @private
 */function y(t,e){for(var n,i,o,r=1,a=t[1];s(a);)m[i=(n=a.split(" "))[0]]?(o=/**
 ...
 * @private
 */function(t,e,n){for(var i,o,r,a=m[t],u=1,c=2,l=e[2];u&&s(l);)0===l.indexOf(t)?u+=1:0===l.indexOf("/"+t)&&(u-=1,r=c),c+=2,l=e[c];if(u)throw Error(t+" needs {{/"+t+"}} expression.");return e[0]=a(e[0].split(" ").slice(1),(i=r,(o=e.splice(1,i-0)).pop(),o),n),e}(i,t.splice(r,t.length-r),e),t=t.concat(o)):t[r]=x(n,e),r+=2,a=t[r];return t.join("")}t.exports=/**
...
let c=JSON.parse(localStorage.getItem("bookArr")),l=c.length;const p=document.querySelector(".tui-pagination"),f=document.querySelector(".shop-list-container");function h(){c=JSON.parse(localStorage.getItem("bookArr"));let e={totalItems:l,itemsPerPage:3,visiblePages:3,centerAlign:!0,currentPage:1},n=//  Розподіл даних на порції
...
//   }
// //
o("5Szup"),o("fewGv"),o("dGLOO");var g={};g=new URL(o("kyEFX").resolve("lp5u4"),import.meta.url).toString();const d=document.querySelector(".shop-list-container"),m=document.querySelector(".shop-list-empty"),_="bookArr";function v(e){return e.map(({author:e,title:n,description:i,book_image:o,buy_links:u,list_name:c,id:l})=>{let p=`<li class="shop-list-item" data-id="${l}">
      ...
      <svg class="shop-remove-btn" width="20" height="20">
        ...
        </li>`;return p}).join("")}function x(t,e){for(let{name:n,url:i}of t)if(n===e)return i}window.addEventListener("DOMContentLoaded",function(t){let e=JSON.parse(localStorage.getItem(_));if(0===e.length){d.innerHTML="",m.classList.remove("shoping-hidden");return}m.classList.add("shoping-hidden"),h(),document.querySelector(".shop-button-book-remove");// rightWrapper.innerHTML = shopingListBookMarkup(booksArr);
}),d.addEventListener("click",function(t){if("shop-button-book-remove"!==t.target.className)return;let e=t.target.parentNode.dataset.id;(function(t){let e=JSON.parse(localStorage.getItem(_));e.find(e=>e.id===t);let n=e.findIndex(e=>e.id===t);e.splice(n,1),localStorage.setItem(_,JSON.stringify(e))}//# sourceMappingURL=shopping_list_olexandr.0ea9a5a6.js.map
)(e),h()});
//# sourceMappingURL=shopping_list_olexandr.0ea9a5a6.js.map
