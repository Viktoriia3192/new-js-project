...
// Кнопка "SIGN IN"
var g8=document.querySelector(".auth-button-in");const g7=document.querySelector(".auth-button-up");var me=document.querySelector(".auth-input");const mt=document.querySelector(".menu-btn-start-tab"),mn=document.querySelector(".auth-button-signup");g8.addEventListener("click",function(){me&&(me.classList.add("auth-input-hidden"),mt.textContent="Sign in",mn.textContent="Sign in")}),g7.addEventListener("click",function(){me&&(me.classList.remove("auth-input-hidden"),mt.textContent="Sign up",mn.textContent="Sign up")}),P("dGLOO");//# sourceMappingURL=index.9e082d4f.js.map

//# sourceMappingURL=index.9e082d4f.js.map
