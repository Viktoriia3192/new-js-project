...
)i.push(function(t,e,n){for(var o,i=[],r=e;r<n;r+=3)i.push(X[(o=(t[r]<<16&16711680)+(t[r+1]<<8&65280)+(255&t[r+2]))>>18&63]+X[o>>12&63]+X[o>>6&63]+X[63&o]);return i.join("")}(t,r,r+16383>a?a:r+16383));return 1===o?i.push(X[(e=t[n-1])>>2]+X[e<<4&63]+"=="):2===o&&i.push(X[(e=(t[n-2]<<8)+t[n-1])>>10]+X[e>>4&63]+X[e<<2&63]+"="),i.join("")};for(var X=[],Q=[],Z="undefined"!=typeof Uint8Array?Uint8Array:Array,tt="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",te=0,tn=tt.length;te<tn;++te)X[te]=tt[te],Q[tt.charCodeAt(te)]=te;// Support decoding URL-safe base64 strings, as Node.js does.
// See: https://en.wikipedia.org/wiki/Base64#URL_applications
Q["-".charCodeAt(0)]=62,Q["_".charCodeAt(0)]=63,a=function(t,e,n,o,i){var r,a,s=8*i-o-1,l=(1<<s)-1,f=l>>1,c=-7,u=n?i-1:0,p=n?-1:1,d=t[e+u];for(u+=p,r=d&(1<<-c)-1,d>>=-c,c+=s;c>0;r=256*r+t[e+u],u+=p,c-=8);for(a=r&(1<<-c)-1,r>>=-c,c+=o;c>0;a=256*a+t[e+u],u+=p,c-=8);if(0===r)r=1-f;else{if(r===l)return a?NaN:(d?-1:1)*(1/0);a+=Math.pow(2,o),r-=f}return(d?-1:1)*a*Math.pow(2,r-o)},s=function(t,e,n,o,i,r){var a,s,l,f=8*r-i-1,c=(1<<f)-1,u=c>>1,p=23===i?5960464477539062e-23:0,d=o?0:r-1,h=o?1:-1,m=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(s=isNaN(e)?1:0,a=c):(a=Math.floor(Math.log(e)/Math.LN2),e*(l=Math.pow(2,-a))<1&&(a--,l*=2),a+u>=1?e+=p/l:e+=p*Math.pow(2,1-u),e*l>=2&&(a++,l/=2),a+u>=c?(s=0,a=c):a+u>=1?(s=(e*l-1)*Math.pow(2,i),a+=u):(s=e*Math.pow(2,u-1)*Math.pow(2,i),a=0));i>=8;t[n+d]=255&s,d+=h,s/=256,i-=8);for(a=a<<i|s,f+=i;f>0;t[n+d]=255&a,d+=h,a/=256,f-=8);t[n+d-h]|=128*m};const to="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
// ================
const tT=/[^+/0-9A-Za-z-_]/g;function tI(t,e){let n;e=e||1/0;let o=t.length,i=null,r=[];for(let a=0;a<o;++a){// is surrogate component
...
var n=t.indexOf("=");-1===n&&(n=e);var o=n===e?0:4-n%4;return[n,o]}(t),i=o[0],r=o[1],a=new Z((i+r)*3/4-r),s=0,l=r>0?i-4:i;for(n=0;n<l;n+=4)e=Q[t.charCodeAt(n)]<<18|Q[t.charCodeAt(n+1)]<<12|Q[t.charCodeAt(n+2)]<<6|Q[t.charCodeAt(n+3)],a[s++]=e>>16&255,a[s++]=e>>8&255,a[s++]=255&e;return 2===r&&(e=Q[t.charCodeAt(n)]<<2|Q[t.charCodeAt(n+1)]>>4,a[s++]=255&e),1===r&&(e=Q[t.charCodeAt(n)]<<10|Q[t.charCodeAt(n+1)]<<4|Q[t.charCodeAt(n+2)]>>2,a[s++]=e>>8&255,a[s++]=255&e),a}(function(t){// Node converts strings with length < 2 to ''
...
function tD(t){return"undefined"==typeof BigInt?tP:t}function tP(){throw Error("BigInt not supported")}/**
...
l.send(i||null)})};const ed={http:null,xhr:ep};V.forEach(ed,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
 ...
 *
 * @returns {object}
 */function(t,e,n){if("object"!=typeof t)throw new G("options must be an object",G.ERR_BAD_OPTION_VALUE);let o=Object.keys(t),i=o.length;for(;i-- >0;){let r=o[i],a=e[r];if(a){let e=t[r],n=void 0===e||a(e,r,t);if(!0!==n)throw new G("option "+r+" must be "+n,G.ERR_BAD_OPTION_VALUE);continue}if(!0!==n)throw new G("Unknown option "+r,G.ERR_BAD_OPTION)}},validators:ex};const ek=eE.validators;/**
...
let l=[],f=!0;this.interceptors.request.forEach(function(t){("function"!=typeof t.runWhen||!1!==t.runWhen(e))&&(f=f&&t.synchronous,l.unshift(t.fulfilled,t.rejected))});let c=[];this.interceptors.response.forEach(function(t){c.push(t.fulfilled,t.rejected)});let u=0;if(!f){let t=[ey.bind(this),void 0];for(t.unshift.apply(t,l),t.push.apply(t,c),o=t.length,n=Promise.resolve(e);u<o;)n=n.then(t[u++],t[u++]);return n}o=l.length;let p=e;for(u=0;u<o;){let t=l[u++],e=l[u++];try{p=t(p)}catch(t){e.call(this,t);break}}try{n=ey.call(this,p)}catch(t){return Promise.reject(t)}for(u=0,o=c.length;u<o;)n=n.then(c[u++],c[u++]);return n}getUri(t){t=eb(this.defaults,t);let e=es(t.baseURL,t.url);return tG(e,t.params,t.paramsSerializer)}}V.forEach(["delete","get","head","options"],function(t){/*eslint func-names:0*/eN.prototype[t]=function(e,n){return this.request(eb(n||{},{method:t,url:e,data:(n||{}).data}))}}),V.forEach(["post","put","patch"],function(t){/*eslint func-names:0*/function e(e){return function(n,o,i){return this.request(eb(i||{},{method:t,headers:e?{"Content-Type":"multipart/form-data"}:{},url:n,data:o}))}}eN.prototype[t]=e(),eN.prototype[t+"Form"]=e(!0)});/**
...
const{Axios:eB,AxiosError:eC,CanceledError:eR,isCancel:eT,CancelToken:eI,VERSION:eL,all:eU,Cancel:e_,isAxiosError:ej,spread:eD,toFormData:eP,AxiosHeaders:eF,HttpStatusCode:ez,formToJSON:eM,getAdapter:e$,mergeConfig:eW}=eS;async function eq(t){try{let e=await eS.get("https://books-backend.p.goit.global/books/"+t);return e.data}catch(t){console.error("An error occurred while fetching data:",t)}}async function eH(){let{data:t}=await eS.get("https://books-backend.p.goit.global/books/category-list");return t}const eJ=document.querySelector(".categories-list");(async function t(){try{let t=await eH();if(!t.length){(0,h.Notify).failure("Oops something going wrong.");return}eJ.insertAdjacentHTML("beforeend",t.map(({list_name:t})=>`
    <li class="categories-list-item">
      <a href="#" class="categories-link">${t}</a>
    </li>
  `).join(""))}catch(t){console.log("TRY-CATCH:",t),(0,h.Notify).failure("Oops something going wrong.")}})(),eJ.addEventListener("click",t=>{t.preventDefault()}),p("fewGv");var eV=p("7Y9D8");const eG=(t,e)=>{try{let n=JSON.stringify(e);localStorage.setItem(t,n)}catch(t){(0,eV.Notify).error("Set state error: ",t.message)}},eK=t=>{try{let e=localStorage.getItem(t);return null===e?void 0:JSON.parse(e)}catch(t){(0,eV.Notify).error("Get state error: ",t.message)}};var eV=p("7Y9D8");(0,eV.Loading).pulse({svgColor:"#eac645"});const eY=document.querySelector(".common-list"),eX=document.querySelector(".main-title"),eQ=document.querySelector(".categories-list");let eZ=window.innerWidth<767?1:window.innerWidth<1439?3:5;function e0(t){//render categories
let e=function(t){let e=[...t];for(let t=e.length-1;t>0;t--){let n=Math.floor(Math.random()*(t+1));[e[t],e[n]]=[e[n],e[t]]}return e}(t),n="";for(let t of(eX.textContent="Best Sellers",eX.insertAdjacentHTML("beforeend",'&nbsp;<span class="main-title main-title-wrapper">Books</span>'),e)){let{books:e,list_name:o}=t;n+=` 
...
let t=window.innerWidth<767?1:window.innerWidth<1439?3:5;if(t!=eZ){eZ=t;let e=eK("data");e0(e)}}),eq("top-books").then(t=>{eG("data",t),e0(t)}).catch(t=>(0,eV.Notify).failure(t)).finally(()=>(0,eV.Loading).remove());var eV=p("7Y9D8");const e1={categories:document.querySelector(".categories-list"),title:document.querySelector(".main-title"),list:document.querySelector(".common-list")},e2="Sorry, there are no books matching the selected category. Please select something else.",e5="Sorry, something went wrong. Try again!";e1.categories.addEventListener("click",function(t){"categories-link"===t.target.className&&(ne(t.target),e3=t.target.textContent.replaceAll(" ","%20"),t.target!==e1.categories.firstElementChild.firstElementChild&&((0,eV.Loading).pulse({svgColor:"#eac645"}),e4(e3).then(t=>{if(0===t.data.length)throw Error((0,eV.Notify).info(e2));let e=t.data[0].list_name;e1.title.textContent=e7(e),e1.title.insertAdjacentHTML("beforeend",`&nbsp;<span class="main-title main-title-wrapper">${nt(e)}</span>`),e1.list.innerHTML=e9(t.data)}).catch(function(t){t.response?(0,eV.Notify).failure(e5):t.request&&(0,eV.Notify).failure(e5)}).finally(()=>(0,eV.Loading).remove())))}),e1.list.addEventListener("click",function(t){if("showMore-btn"!==t.target.className)return;(0,eV.Loading).pulse({svgColor:"#eac645"}),e8=t.target.name.replaceAll(" ","%20");let e=Array.from(e1.categories.children);e.forEach(t=>{let e=t.firstElementChild.textContent.replaceAll(" ","%20");e===e8&&ne(t)}),e4(e8).then(t=>{if(0===t.data.length)throw Error((0,eV.Notify).info(e2));let e=t.data[0].list_name;e1.title.textContent=e7(e),e1.title.insertAdjacentHTML("beforeend",`&nbsp;<span class="main-title main-title-wrapper">${nt(e)}</span>`),e1.list.innerHTML=e9(t.data)}).catch(function(t){t.response?(0,eV.Notify).failure(e5):t.request&&(0,eV.Notify).failure(e5)}).finally(()=>(0,eV.Loading).remove())});let e3="",e8="",e6=e1.categories.firstElementChild.firstElementChild;async function e4(t){let e=`https://books-backend.p.goit.global/books/category?category=${t}`,n=await eS.get(e);return n}function e9(t){return t.map(({book_image:t,author:e,title:n,_id:o})=>{let i=`<li class="book-item" data-id="${o}" tabindex="0">
              ...
              </li>`;return i}).join("")}function e7(t){let e=t.split(" ");return e.splice(0,e.length-1).join(" ")}function nt(t){let e=t.split(" ");return e[e.length-1]}function ne(t){e6&&e6.classList.remove("category-active"),t.classList.add("category-active"),e6=t}ne(e6);var nn={};nn=new URL(p("kyEFX").resolve("8XY7q"),import.meta.url).toString();var no={};no=new URL(p("kyEFX").resolve("3WxNb"),import.meta.url).toString();var ni={};ni=new URL(p("kyEFX").resolve("lJIFT"),import.meta.url).toString();//!------------------------------------------
const nr=document.querySelector(".common-list"),na=document.querySelector(".modal__content"),ns=document.querySelector("#book-modal"),nl=document.getElementById("book-modal"),nf=document.querySelector(".modal__close-btn"),nc=document.querySelector(".add-bookBtn");document.querySelector(".addNotification"),document.querySelector(".removeNotification");const nu=document.querySelector(".notification");document.querySelector(".remove-book");const np=document.querySelector(".modal");nr.addEventListener("click",function(t){t.target.closest(".book-item")&&nh(t.target.dataset.id).then(t=>{let{author:e,title:n,description:o,book_image:i,buy_links:r,list_name:a,_id:s}=t.data;nd={author:e,title:n,description:o,book_image:i,buy_links:r,list_name:a,id:s},//!--------------------
...
//   }
// });
p("dGLOO");//# sourceMappingURL=index.d2414043.js.map

//# sourceMappingURL=index.d2414043.js.map
