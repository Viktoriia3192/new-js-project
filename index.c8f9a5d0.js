...
function(){n.style.display="block",document.querySelector(".auth").style.visibility="visible",s.value="",o.value="",a.value=""}),t.addEventListener("click",c),// Реєстрація користувача при натисканні кнопки SIGN UP
...
d3(e.eventQueue_,t,[])}})(e._repo,e._path,t,n.wrapCallback(()=>{})),n.promise})(fy(g6,"users/"+t.uid),{last_login:n}),c(),/*@__PURE__*/A(nr).Notify.success("User is signed in!"),h.classList.remove("header-shopping-list-hidden")}).catch(e=>{e.code;let t=e.message;console.log(t)})}else{// ___________________________________________
