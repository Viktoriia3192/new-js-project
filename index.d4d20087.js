...
var h=s(!0,e,{});// check callbackOrOptions and options: begin
...
e=s(!0,e,d)}// check callbackOrOptions and options: end
// notify type
...
var B=function(){k=setTimeout(function(){A()},e.timeout),N=setTimeout(function(){O()},e.timeout+e.cssAnimationDuration)};B(),e.pauseOnHover&&(E.addEventListener("mouseenter",function(){E.classList.add("nx-paused"),clearTimeout(k),clearTimeout(N)}),E.addEventListener("mouseleave",function(){E.classList.remove("nx-paused"),B()}));// pause auto remove: end
}// else auto remove: end
}// remove by timeout or click: end
// notify - show only the last one: begin
if(e.showOnlyTheLastOne&&c>0)for(var S=t.document.querySelectorAll("[id^="+e.ID+"-]:not([id="+e.ID+"-"+c+"])"),R=0;R<S.length;R++){var C=S[R];null!==C.parentNode&&C.parentNode.removeChild(C)}// notify - show only the last one: end
// extend new settings with the backup settings
e=s(!0,e,h)},p={Notify:{// Init
...
info:function(t,e,o){u(n.Info,t,e,o)}}};return"object"==typeof t.Notiflix?s(!0,t.Notiflix,{Notify:p.Notify}):{Notify:p.Notify}},"function"==typeof define&&define.amd?define([],function(){return n(e)}):"object"==typeof d?d=n(e):e.Notiflix=n(e);// utils is a library of generic helper functions non-specific to axios
let{toString:y}=Object.prototype,{getPrototypeOf:g}=Object,b=(o=Object.create(null),t=>{let e=y.call(t);return o[e]||(o[e]=e.slice(8,-1).toLowerCase())}),w=t=>(t=t.toLowerCase(),e=>b(e)===t),x=t=>e=>typeof e===t,{isArray:v}=Array,E=x("undefined"),k=w("ArrayBuffer"),N=x("string"),A=x("function"),O=x("number"),B=t=>null!==t&&"object"==typeof t,S=t=>{if("object"!==b(t))return!1;let e=g(t);return(null===e||e===Object.prototype||null===Object.getPrototypeOf(e))&&!(Symbol.toStringTag in t)&&!(Symbol.iterator in t)},R=w("Date"),C=w("File"),T=w("Blob"),I=w("FileList"),L=w("URLSearchParams");/**
 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&k(t.buffer)},isString:N,isNumber:O,isBoolean:t=>!0===t||!1===t,isObject:B,isPlainObject:S,isUndefined:E,isDate:R,isFile:C,isBlob:T,isRegExp:M,isFunction:A,isStream:t=>B(t)&&A(t.pipe),isURLSearchParams:L,isTypedArray:D,isFileList:I,forEach:U,merge:/**
...
X["-".charCodeAt(0)]=62,X["_".charCodeAt(0)]=63,a=function(t,e,n,o,i){var r,a,s=8*i-o-1,l=(1<<s)-1,f=l>>1,c=-7,u=n?i-1:0,p=n?-1:1,h=t[e+u];for(u+=p,r=h&(1<<-c)-1,h>>=-c,c+=s;c>0;r=256*r+t[e+u],u+=p,c-=8);for(a=r&(1<<-c)-1,r>>=-c,c+=o;c>0;a=256*a+t[e+u],u+=p,c-=8);if(0===r)r=1-f;else{if(r===l)return a?NaN:(h?-1:1)*(1/0);a+=Math.pow(2,o),r-=f}return(h?-1:1)*a*Math.pow(2,r-o)},s=function(t,e,n,o,i,r){var a,s,l,f=8*r-i-1,c=(1<<f)-1,u=c>>1,p=23===i?5960464477539062e-23:0,h=o?0:r-1,d=o?1:-1,m=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(s=isNaN(e)?1:0,a=c):(a=Math.floor(Math.log(e)/Math.LN2),e*(l=Math.pow(2,-a))<1&&(a--,l*=2),a+u>=1?e+=p/l:e+=p*Math.pow(2,1-u),e*l>=2&&(a++,l/=2),a+u>=c?(s=0,a=c):a+u>=1?(s=(e*l-1)*Math.pow(2,i),a+=u):(s=e*Math.pow(2,u-1)*Math.pow(2,i),a=0));i>=8;t[n+h]=255&s,h+=d,s/=256,i-=8);for(a=a<<i|s,f+=i;f>0;t[n+h]=255&a,h+=d,a/=256,f-=8);t[n+h-d]|=128*m};let to="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
 ...
 */function tb(t,e,n){if(t%1!=0||t<0)throw RangeError("offset is not uint");if(t+e>n)throw RangeError("Trying to access beyond buffer length")}function tw(t,e,n,o,i,r){if(!tr.isBuffer(t))throw TypeError('"buffer" argument must be a Buffer instance');if(e>i||e<r)throw RangeError('"value" argument is out of bounds');if(n+o>t.length)throw RangeError("Index out of range")}function tx(t,e,n,o,i){tS(e,o,i,t,n,7);let r=Number(e&BigInt(4294967295));t[n++]=r,r>>=8,t[n++]=r,r>>=8,t[n++]=r,r>>=8,t[n++]=r;let a=Number(e>>BigInt(32)&BigInt(4294967295));return t[n++]=a,a>>=8,t[n++]=a,a>>=8,t[n++]=a,a>>=8,t[n++]=a,n}function tv(t,e,n,o,i){tS(e,o,i,t,n,7);let r=Number(e&BigInt(4294967295));t[n+7]=r,r>>=8,t[n+6]=r,r>>=8,t[n+5]=r,r>>=8,t[n+4]=r;let a=Number(e>>BigInt(32)&BigInt(4294967295));return t[n+3]=a,a>>=8,t[n+2]=a,a>>=8,t[n+1]=a,a>>=8,t[n]=a,n+8}function tE(t,e,n,o,i,r){if(n+o>t.length||n<0)throw RangeError("Index out of range")}function tk(t,e,n,o,i){return e=+e,n>>>=0,i||tE(t,e,n,4,34028234663852886e22,-34028234663852886e22),s(t,e,n,o,23,4),n+4}function tN(t,e,n,o,i){return e=+e,n>>>=0,i||tE(t,e,n,8,17976931348623157e292,-17976931348623157e292),s(t,e,n,o,52,8),n+8}/**
...
delete this.name}get code(){return t}set code(t){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:t,writable:!0})}toString(){return`${this.name} [${t}]: ${this.message}`}}}function tB(t){let e="",n=t.length,o="-"===t[0]?1:0;for(;n>=o+4;n-=3)e=`_${t.slice(n-3,n)}${e}`;return`${t.slice(0,n)}${e}`}function tS(t,e,n,o,i,r){if(t>n||t<e){let o;let i="bigint"==typeof e?"n":"";throw o=r>3?0===e||e===BigInt(0)?`>= 0${i} and < 2${i} ** ${(r+1)*8}${i}`:`>= -(2${i} ** ${(r+1)*8-1}${i}) and < 2 ** ${(r+1)*8-1}${i}`:`>= ${e}${i} and <= ${n}${i}`,new tA.ERR_OUT_OF_RANGE("value",o,t)}tR(i,"offset"),(void 0===o[i]||void 0===o[i+r])&&tC(i,o.length-(r+1))}function tR(t,e){if("number"!=typeof t)throw new tA.ERR_INVALID_ARG_TYPE(e,"number",t)}function tC(t,e,n){if(Math.floor(t)!==t)throw tR(t,n),new tA.ERR_OUT_OF_RANGE(n||"offset","an integer",t);if(e<0)throw new tA.ERR_BUFFER_OUT_OF_BOUNDS;throw new tA.ERR_OUT_OF_RANGE(n||"offset",`>= ${n?1:0} and <= ${e}`,t)}tO("ERR_BUFFER_OUT_OF_BOUNDS",function(t){return t?`${t} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),tO("ERR_INVALID_ARG_TYPE",function(t,e){return`The "${t}" argument must be of type number. Received type ${typeof e}`},TypeError),tO("ERR_OUT_OF_RANGE",function(t,e,n){let o=`The value of "${t}" is out of range.`,i=n;return Number.isInteger(n)&&Math.abs(n)>4294967296?i=tB(String(n)):"bigint"==typeof n&&(i=String(n),(n>BigInt(2)**BigInt(32)||n<-(BigInt(2)**BigInt(32)))&&(i=tB(i)),i+="n"),o+=` It must be ${e}. Received ${i}`},RangeError);// HELPER FUNCTIONS
// ================
...
l.send(i||null)})};let eh={http:null,xhr:ep};V.forEach(eh,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
 ...
 *
 * @returns {object}
 */function(t,e,n){if("object"!=typeof t)throw new G("options must be an object",G.ERR_BAD_OPTION_VALUE);let o=Object.keys(t),i=o.length;for(;i-- >0;){let r=o[i],a=e[r];if(a){let e=t[r],n=void 0===e||a(e,r,t);if(!0!==n)throw new G("option "+r+" must be "+n,G.ERR_BAD_OPTION_VALUE);continue}if(!0!==n)throw new G("Unknown option "+r,G.ERR_BAD_OPTION)}},validators:ex};let ek=eE.validators;/**
...
eB.Axios=eN,// Expose Cancel & CancelToken
eB.CanceledError=er,eB.CancelToken=eA,eB.isCancel=ei,eB.VERSION=ew,eB.toFormData=tW,// Expose AxiosError class
eB.AxiosError=G,// alias for CanceledError for backward compatibility
...
eB.isAxiosError=function(t){return V.isObject(t)&&!0===t.isAxiosError},// Expose mergeConfig
eB.mergeConfig=eb,eB.AxiosHeaders=en,eB.formToJSON=t=>t5(V.isHTMLForm(t)?new FormData(t):t),eB.getAdapter=ed.getAdapter,eB.HttpStatusCode=eO,eB.default=eB;// This module is intended to unwrap Axios default export as named.
// Keep top-level export same with static properties
// so that it can keep same with es module or cjs
let{Axios:eS,AxiosError:eR,CanceledError:eC,isCancel:eT,CancelToken:eI,VERSION:eL,all:eU,Cancel:e_,isAxiosError:ej,spread:eP,toFormData:eD,AxiosHeaders:eF,HttpStatusCode:ez,formToJSON:eM,getAdapter:e$,mergeConfig:eW}=eB;async function eq(t){try{let e=await eB.get("https://books-backend.p.goit.global/books/"+t);return e.data}catch(t){console.error("An error occurred while fetching data:",t)}}async function eH(){let{data:t}=await eB.get("https://books-backend.p.goit.global/books/category-list");return t}let eJ=document.querySelector(".categories-list");(async function t(){try{let t=await eH();if(!t.length){(0,d.Notify).failure("Oops something going wrong.");return}eJ.insertAdjacentHTML("beforeend",t.map(({list_name:t})=>`
    <li class="categories-list-item">
      <a href="#" class="categories-link">${t}</a>
    </li>
  `).join(""))}catch(t){console.log("TRY-CATCH:",t),(0,d.Notify).failure("Oops something going wrong.")}})(),eJ.addEventListener("click",t=>{t.preventDefault()}),p("ksGdE");let eV=(t,e)=>{try{let n=JSON.stringify(e);localStorage.setItem(t,n)}catch(t){console.error("Set state error: ",t.message)}},eG=t=>{try{let e=localStorage.getItem(t);return null===e?void 0:JSON.parse(e)}catch(t){console.error("Get state error: ",t.message)}};!function(){let t=document.querySelector(".loader");t.style.display="block"}();let eK=document.querySelector(".common-list");document.querySelector(".main-title");let eY=document.querySelector(".categories-list"),eQ=window.innerWidth<767?1:window.innerWidth<1439?3:5;function eX(t){!function(){let t=document.querySelector(".loader");t.style.display="none"}();let e="";for(let n of t){let{books:t,list_name:o}=n;e+=` 
        <li class="common-item">
        <h2 class="common-title">${o}</h2>
        <ul class="book-list">
            ${function(t,e){let n="";for(let o=0;o<e;o+=1){let{book_image:e,title:i,author:r,_id:a}=t[o];n+=`
              <li class="book-item" data-id="${a}">
             
              <a href="#" class="book-link"> 
              <div class="thumb">
              <img src="${e||"../images/default_image.jpg"}" alt="${i}" class="book-img" data-id="${a}">
...
let{author:e,title:n,description:o,book_image:i,buy_links:r,list_name:a}=t.data;console.log({author:e,title:n,description:o,book_image:i,buy_links:r,list_name:a}),//!--------------------
...
</div>`;return r}(t.data))}))});async function nu(t){let e=`https://books-backend.p.goit.global/books/${t}`,n=await eB.get(e);return n}function np(t,e){for(let{name:n,url:o}of t)if(n===e)return o}document.addEventListener("DOMContentLoaded",function(){function t(){document.body.style.overflow="auto",na.classList.add("is-hidden")}ns.addEventListener("click",t),document.addEventListener("keydown",function(e){"Escape"===e.key&&t()}),na.addEventListener("click",function(e){e.target===na&&t()}),ni.addEventListener("click",function(t){t.stopPropagation()})}),document.addEventListener("DOMContentLoaded",function(){nl.addEventListener("click",function(){"Add to shopping list"===nl.textContent?(nl.textContent="Remove from the shopping list",nf.classList.remove("hidden"),nc.classList.remove("hidden")):(nl.textContent="Add to shopping list",nf.classList.add("hidden"),nc.classList.add("hidden"))})}),//!--------------------------------
...
//     }
// });
p("E6hPi")}();//# sourceMappingURL=index.d4d20087.js.map

//# sourceMappingURL=index.d4d20087.js.map
