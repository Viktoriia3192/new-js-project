...
info:function(t,e,i){h(n.Info,t,e,i)}}};return"object"==typeof t.Notiflix?a(!0,t.Notiflix,{Notify:f.Notify}):{Notify:f.Notify}},"function"==typeof define&&define.amd?define([],function(){return r5(r4)}):"object"==typeof E?E=r5(r4):r4.Notiflix=r5(r4);// utils is a library of generic helper functions non-specific to axios
...
ts["-".charCodeAt(0)]=62,ts["_".charCodeAt(0)]=63,st=function(t,e,n,i,r){var s,o,a=8*r-i-1,l=(1<<a)-1,u=l>>1,c=-7,h=n?r-1:0,f=n?-1:1,d=t[e+h];for(h+=f,s=d&(1<<-c)-1,d>>=-c,c+=a;c>0;s=256*s+t[e+h],h+=f,c-=8);for(o=s&(1<<-c)-1,s>>=-c,c+=i;c>0;o=256*o+t[e+h],h+=f,c-=8);if(0===s)s=1-u;else{if(s===l)return o?NaN:(d?-1:1)*(1/0);o+=Math.pow(2,i),s-=u}return(d?-1:1)*o*Math.pow(2,s-i)},se=function(t,e,n,i,r,s){var o,a,l,u=8*s-r-1,c=(1<<u)-1,h=c>>1,f=23===r?5960464477539062e-23:0,d=i?0:s-1,p=i?1:-1,g=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(a=isNaN(e)?1:0,o=c):(o=Math.floor(Math.log(e)/Math.LN2),e*(l=Math.pow(2,-o))<1&&(o--,l*=2),o+h>=1?e+=f/l:e+=f*Math.pow(2,1-h),e*l>=2&&(o++,l/=2),o+h>=c?(a=0,o=c):o+h>=1?(a=(e*l-1)*Math.pow(2,r),o+=h):(a=e*Math.pow(2,h-1)*Math.pow(2,r),o=0));r>=8;t[n+d]=255&a,d+=p,a/=256,r-=8);for(o=o<<r|a,u+=r;u>0;t[n+d]=255&o,d+=p,o/=256,u-=8);t[n+d-p]|=128*g};const tc="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
 ...
 */function tY(t){let e={"!":"%21","'":"%27","(":"%28",")":"%29","~":"%7E","%20":"+","%00":"\x00"};return encodeURIComponent(t).replace(/[!'()~]|%20|%00/g,function(t){return e[t]})}/**
 ...
 *
 * @returns {void}
 */function tJ(t,e){this._pairs=[],t&&tX(t,this,e)}const tZ=tJ.prototype;/**
 ...
 */function t0(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function t1(t,e,n){let i;/*eslint no-param-reassign:0*/if(!e)return t;let r=n&&n.encode||t0,s=n&&n.serialize;if(i=s?s(e,n):tt.isURLSearchParams(e)?e.toString():new tJ(e,n).toString(r)){let e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+i}return t}tZ.append=function(t,e){this._pairs.push([t,e])},tZ.toString=function(t){let e=t?function(e){return t.call(this,e,tY)}:tY;return this._pairs.map(function(t){return e(t[0])+"="+e(t[1])},"").join("&")};var t2=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(t){tt.forEach(this.handlers,function(e){null!==e&&t(e)})}},t9={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},t4="undefined"!=typeof URLSearchParams?URLSearchParams:tJ,t5="undefined"!=typeof FormData?FormData:null,t6="undefined"!=typeof Blob?Blob:null;/**
...
const{Axios:eP,AxiosError:eM,CanceledError:eB,isCancel:eF,CancelToken:eU,VERSION:ej,all:eV,Cancel:e$,isAxiosError:ez,spread:eq,toFormData:eH,AxiosHeaders:eK,HttpStatusCode:eG,formToJSON:eW,getAdapter:eQ,mergeConfig:eX}=eL;async function eY(t){try{let e=await eL.get("https://books-backend.p.goit.global/books/"+t);return e.data}catch(t){console.error("An error occurred while fetching data:",t)}}async function eJ(){let{data:t}=await eL.get("https://books-backend.p.goit.global/books/category-list");return t}const eZ=document.querySelector(".categories-list");(async function t(){try{let t=await eJ();if(!t.length){(0,E.Notify).failure("Oops something going wrong.");return}eZ.insertAdjacentHTML("beforeend",t.map(({list_name:t})=>`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nO=function(t){// TODO(user): Use native implementations if/when available
 ...
 */const nM=function(t){let e=nO(t);return nL.encodeByteArray(e,!0)},nB=function(t){// Use base64url encoding and remove padding in the end (dot characters).
...
Object.setPrototypeOf(this,nQ.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,nX.prototype.create)}}class nX{constructor(t,e,n){this.service=t,this.serviceName=e,this.errors=n}create(t,...e){let n=e[0]||{},i=`${this.service}/${t}`,r=this.errors[t],s=r?r.replace(nY,(t,e)=>{let i=n[e];return null!=i?String(i):`<${e}?>`}):"Error",o=`${this.serviceName}: ${s} (${i}).`,a=new nQ(i,o,n);return a}}const nY=/\{\$([^}]+)}/g;/**
 * Deep equal two objects. Support Arrays and Objects.
 */function nJ(t,e){if(t===e)return!0;let n=Object.keys(t),i=Object.keys(e);for(let r of n){if(!i.includes(r))return!1;let n=t[r],s=e[r];if(nZ(n)&&nZ(s)){if(!nJ(n,s))return!1}else if(n!==s)return!1}for(let t of i)if(!n.includes(t))return!1;return!0}function nZ(t){return null!==t&&"object"==typeof t}/**
...
setLogLevel(t){this._logLevel="string"==typeof t?n3[t]:t}get logHandler(){return this._logHandler}set logHandler(t){if("function"!=typeof t)throw TypeError("Value assigned to `logHandler` must be a function");this._logHandler=t}get userLogHandler(){return this._userLogHandler}set userLogHandler(t){this._userLogHandler=t}/**
     ...
     */debug(...t){this._userLogHandler&&this._userLogHandler(this,ss.DEBUG,...t),this._logHandler(this,ss.DEBUG,...t)}log(...t){this._userLogHandler&&this._userLogHandler(this,ss.VERBOSE,...t),this._logHandler(this,ss.VERBOSE,...t)}info(...t){this._userLogHandler&&this._userLogHandler(this,ss.INFO,...t),this._logHandler(this,ss.INFO,...t)}warn(...t){this._userLogHandler&&this._userLogHandler(this,ss.WARN,...t),this._logHandler(this,ss.WARN,...t)}error(...t){this._userLogHandler&&this._userLogHandler(this,ss.ERROR,...t),this._logHandler(this,ss.ERROR,...t)}}const ii=(t,e)=>e.some(e=>t instanceof e),ir=new WeakMap,is=new WeakMap,io=new WeakMap,ia=new WeakMap,il=new WeakMap;let iu={get(t,e,n){if(t instanceof IDBTransaction){// Special handling for transaction.done.
...
return ic(t[e])},set:(t,e,n)=>(t[e]=n,!0),has:(t,e)=>t instanceof IDBTransaction&&("done"===e||"store"===e)||e in t};function ic(n){var i;// We sometimes generate multiple promises from a single IDBRequest (eg when cursoring), because
// IDB is weird and a single IDBRequest can yield many responses, so these can't be cached.
if(n instanceof IDBRequest)return function(t){let e=new Promise((e,n)=>{let i=()=>{t.removeEventListener("success",r),t.removeEventListener("error",s)},r=()=>{e(ic(t.result)),i()},s=()=>{n(t.error),i()};t.addEventListener("success",r),t.addEventListener("error",s)});return e.then(e=>{e instanceof IDBCursor&&ir.set(e,t);// Catching to avoid "Uncaught Promise exceptions"
...
// the original object.
i.apply(ih(this),t),ic(ir.get(this)))}:function(...t){// Calling the original function with the proxy as 'this' causes ILLEGAL INVOCATION, so we use
// the original object.
return ic(i.apply(ih(this),t))}:function(t,...e){let n=i.call(ih(this),t,...e);return io.set(n,t.sort?t.sort():[t]),ic(n)}:(i instanceof IDBTransaction&&function(t){// Early bail if we've already created a done promise for this transaction.
 ...
 *
 * @internal
 */function ix(t,e){let n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}const iC=new nX("app","Firebase",{"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."});/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
if(nJ(n,s.options)&&nJ(i,s.config))return s;throw iC.create("duplicate-app"/* AppError.DUPLICATE_APP */,{appName:r})}let o=new n5(r);for(let t of iS.values())o.addComponent(t);let a=new i_(n,i,o);return iI.set(r,a),a}/**
...
iD("fire-js",""),iD("firebase","10.3.1","app");const i$=(t,e)=>e.some(e=>t instanceof e),iz=new WeakMap,iq=new WeakMap,iH=new WeakMap,iK=new WeakMap,iG=new WeakMap;let iW={get(t,e,n){if(t instanceof IDBTransaction){// Special handling for transaction.done.
...
iq.set(t,e)}(e),i$(e,n||(n=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])))?new Proxy(e,iW):e;return r!==t&&(iK.set(t,r),iG.set(r,t)),r}const iX=t=>iG.get(t),iY=["get","getKey","getAll","getAllKeys","count"],iJ=["put","add","delete","clear"],iZ=new Map;function i0(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&"string"==typeof e))return;if(iZ.get(e))return iZ.get(e);let n=e.replace(/FromIndex$/,""),i=e!==n,r=iJ.includes(n);if(!(n in(i?IDBIndex:IDBObjectStore).prototype)||!(r||iY.includes(n)))return;let s=async function(t,...e){// isWrite ? 'readwrite' : undefined gzipps better, but fails in Edge :(
let s=this.transaction(t,r?"readwrite":"readonly"),o=s.store;// Must reject if op rejects.
// If it's a write operation, must reject if tx.done rejects.
// Must reject with op rejection first.
// Must resolve with op value.
// Must handle both promises (no unhandled rejections)
return i&&(o=o.index(e.shift())),(await Promise.all([o[n](...e),r&&s.done]))[0]};return iZ.set(e,s),s}iW={...r9=iW,get:(t,e,n)=>i0(t,e)||r9.get(t,e,n),has:(t,e)=>!!i0(t,e)||r9.has(t,e)};const i1="@firebase/installations",i2="0.6.4",i9=`w:${i2}`,i4="FIS_v2",i5=new nX("installations","Installations",{"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."});/** Returns true if error is a FirebaseError that is based on an error from the server. */function i6(t){return t instanceof nQ&&t.code.includes("request-failed"/* ErrorCode.REQUEST_FAILED */)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rD="installations";iA(new n2(rD,t=>{let e=t.getProvider("app").getImmediate(),n=/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
t("event"/* GtagCommand.EVENT */,i,r||{})}catch(t){rL.error(t)}}const rj=new /**
 ...
 */async function rG(t,e,n,i,o,a,l){var u;let c=r$(t);// Once fetched, map measurementIds to appId, for ease of lookup in wrapped gtag function.
c.then(e=>{n[e.measurementId]=e.appId,t.options.measurementId&&e.measurementId!==t.options.measurementId&&rL.warn(`The measurement ID in the local Firebase config (${t.options.measurementId}) does not match the measurement ID fetched from the server (${e.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(t=>rL.error(t)),// Add to list to track state of all dynamic config promises.
e.push(c);let h=rK().then(t=>t?i.getId():void 0),[f,d]=await Promise.all([c,h]);!/**
 ...
 */let rJ="dataLayer",rZ=!1;const r0="@firebase/analytics",r1="0.10.0";iA(new n2(rO,(t,{options:e})=>{// getImmediate for FirebaseApp will always succeed
 ...
 */function(){let t=[];if(function(){let t="object"==typeof chrome?chrome.runtime:"object"==typeof browser?browser.runtime:void 0;return"object"==typeof t&&void 0!==t.id}()&&t.push("This is a browser extension environment."),"undefined"!=typeof navigator&&navigator.cookieEnabled||t.push("Cookies are not available."),t.length>0){let e=t.map((t,e)=>`(${e+1}) ${t}`).join(" "),n=rP.create("invalid-analytics-context"/* AnalyticsError.INVALID_ANALYTICS_CONTEXT */,{errorInfo:e});rL.warn(n.message)}}();let i=t.options.appId;if(!i)throw rP.create("no-app-id"/* AnalyticsError.NO_APP_ID */);if(!t.options.apiKey){if(t.options.measurementId)rL.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw rP.create("no-api-key"/* AnalyticsError.NO_API_KEY */)}if(null!=rQ[i])throw rP.create("already-exists"/* AnalyticsError.ALREADY_EXISTS */,{id:i});if(!rZ){var r,s;let t,e;t=[],Array.isArray(window[rJ])?t=window[rJ]:window[rJ]=t;let{wrappedGtag:n,gtagCore:i}=(r="gtag",e=function(...t){// Must push IArguments object, not an array.
window[rJ].push(arguments)},window[r]&&"function"==typeof window[r]&&(e=window[r]),window[r]=(s=e,/**
...
await rF(s,rQ,rX,rY,t,n)}else if("consent"/* GtagCommand.CONSENT */===t){let[t]=e;s("consent"/* GtagCommand.CONSENT */,"update",t)}else if("get"/* GtagCommand.GET */===t){let[t,n,i]=e;s("get"/* GtagCommand.GET */,t,n,i)}else if("set"/* GtagCommand.SET */===t){let[t]=e;// If SET, second arg must be params.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lM=new ie("@firebase/firestore");// Helper methods are needed because variables can't be exported as read/write
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lz={// Causes are copied from:
 ...
 */class lY{constructor(t,e,n){this.l=t,this.h=e,this.P=n}getToken(){return Promise.resolve(new lX(this.l,this.h,this.P))}start(t,e){// Fire with initial uid.
t.enqueueRetryable(()=>e(lL.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class lJ{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class lZ{constructor(t){this.A=t,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(t,e){let n=t=>{null!=t.error&&lF("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${t.error.message}`);let n=t.token!==this.R;return this.R=t.token,lF("FirebaseAppCheckTokenProvider",`Received ${n?"new":"existing"} token.`),n?e(t.token):Promise.resolve()};this.o=e=>{t.enqueueRetryable(()=>n(e))};let i=t=>{lF("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=t,this.appCheck.addTokenListener(this.o)};this.A.onInit(t=>i(t)),// a chance to register itself with the component framework.
...
e.push(...n.split("/").filter(t=>t.length>0))}return new l6(e)}static emptyPath(){return new l6([])}}const l3=/^[_a-zA-Z][_a-zA-Z0-9]*$/;/**
...
// tree.
class uc{constructor(t,e){this.comparator=t,this.root=e||uf.EMPTY}// Returns a copy of the map, with the specified key/value added or replaced.
insert(t,e){return new uc(this.comparator,this.root.insert(t,e,this.comparator).copy(null,null,uf.BLACK,null,null))}// Returns a copy of the map, with the specified key removed.
remove(t){return new uc(this.comparator,this.root.remove(t,this.comparator).copy(null,null,uf.BLACK,null,null))}// Returns the value of the node with the given key, or null.
...
getIterator(){return new uh(this.root,null,this.comparator,!1)}getIteratorFrom(t){return new uh(this.root,t,this.comparator,!1)}getReverseIterator(){return new uh(this.root,null,this.comparator,!0)}getReverseIteratorFrom(t){return new uh(this.root,t,this.comparator,!0)}}// end SortedMap
// An iterator over an LLRBNode.
class uh{constructor(t,e,n,i){this.isReverse=i,this.nodeStack=[];let r=1;for(;!t.isEmpty();)if(r=e?n(t.key,e):1,e&&i&&(r*=-1),r<0)t=this.isReverse?t.left:t.right;else{if(0===r){// This node is exactly equal to our start key. Push it on the stack,
// but stop iterating;
 ...
 */function ct(t){return t.Ie||(t.Ie=/**
 * Converts this `Query` instance to its corresponding `Target` representation,
 ...
 */class co{constructor(t,e){this.mapKeyFn=t,this.equalsFn=e,/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ca=new uc(l7.comparator),cl=new uc(l7.comparator);function cu(...t){let e=cl;for(let n of t)e=e.insert(n.key,n);return e}function cc(t){let e=cl;return t.forEach((t,n)=>e=e.insert(t,n.overlayedDocument)),e}function ch(){return new co(t=>t.toString(),(t,e)=>t.isEqual(e))}const cf=new uc(l7.comparator),cd=new ud(l7.comparator);function cp(...t){let e=cd;for(let n of t)e=e.add(n);return e}const cg=new ud(l1);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function cm(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:uo(e)?"-0":e}}/**
 * Returns an IntegerValue for `value`.
 */function cy(t){return{integerValue:""+t}}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 *//** Used to represent a field transform on a mutation. */class cv{constructor(){// Make sure that the structural type of `TransformOperation` is unique.
 ...
 */function cw(t,e){return t instanceof cA?/** Returns true if `value` is either an IntegerValue or a DoubleValue. */uR(e)||e&&"doubleValue"in e?e:{integerValue:0}:null}/** Transforms a value into a server-generated timestamp. */class cb extends cv{}/** Transforms an array value via a union operation. */class cE extends cv{constructor(t){super(),this.elements=t}}function cT(t,e){let n=cC(e);for(let e of t.elements)n.some(t=>u_(t,e))||n.push(e);return{arrayValue:{values:n}}}/** Transforms an array value via a remove operation. */class cI extends cv{constructor(t){super(),this.elements=t}}function cS(t,e){let n=cC(e);for(let e of t.elements)n=n.filter(t=>!u_(t,e));return{arrayValue:{values:n}}}/**
 * Implements the backend semantics for locally computed NUMERIC_ADD (increment)
 * transforms. Converts all field values to integers or doubles, but unlike the
 * backend does not cap integer values at 2^63. Instead, JavaScript number
 * arithmetic is used and precision loss can occur for values greater than 2^53.
 */class cA extends cv{constructor(t,e){super(),this.serializer=t,this.Te=e}}function cx(t){return ub(t.integerValue||t.doubleValue)}function cC(t){return uL(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}/** The result of successfully applying a mutation to the backend. */class c_{constructor(/**
 ...
 */class ck{constructor(t,e){this.updateTime=t,this.exists=e}/** Creates a new empty Precondition. */static none(){return new ck}/** Creates a new Precondition with an exists flag. */static exists(t){return new ck(void 0,t)}/** Creates a new Precondition based on a version a document exists at. */static updateTime(t){return new ck(t)}/** Returns whether this Precondition is empty. */get isNone(){return void 0===this.updateTime&&void 0===this.exists}isEqual(t){return this.exists===t.exists&&(this.updateTime?!!t.updateTime&&this.updateTime.isEqual(t.updateTime):!t.updateTime)}}/** Returns true if the preconditions is valid for the given document. */function cN(t,e){return void 0!==t.updateTime?e.isFoundDocument()&&e.version.isEqual(t.updateTime):void 0===t.exists||t.exists===e.isFoundDocument()}/**
 ...
 */function cO(t,e){if(!t.hasLocalMutations||e&&0===e.fields.length)return null;// mask is null when sets or deletes are applied to the current document.
if(null===e)return t.isNoDocument()?new cj(t.key,ck.none()):new cP(t.key,t.data,ck.none());{let n=t.data,i=uF.empty(),r=new ud(l8.comparator);for(let t of e.fields)if(!r.has(t)){let e=n.field(t);// If we are deleting a nested field, we take the immediate parent as
...
null===e&&t.length>1&&(t=t.popLast(),e=n.field(t)),null===e?i.delete(t):i.set(t,e),r=r.add(t)}return new cM(t.key,i,new ug(r.toArray()),ck.none())}}/**
 ...
 */function cR(t,e,n,i){return t instanceof cP?function(t,e,n,i){if(!cN(t.precondition,e))// caused a name collision).
return n;let r=t.value.clone(),s=cU(t.fieldTransforms,i,e);return r.setAll(s),e.convertToFoundDocument(e.version,r).setHasLocalMutations(),null;// SetMutation overwrites all fields.
}(t,e,n,i):t instanceof cM?function(t,e,n,i){if(!cN(t.precondition,e))return n;let r=cU(t.fieldTransforms,i,e),s=e.data;return(s.setAll(cB(t)),s.setAll(r),e.convertToFoundDocument(e.version,s).setHasLocalMutations(),null===n)?null:n.unionWith(t.fieldMask.fields).unionWith(t.fieldTransforms.map(t=>t.field))}(t,e,n,i):cN(t.precondition,e)?(e.convertToNoDocument(e.version).setHasLocalMutations(),null):n}function cL(t,e){var n,i;return t.type===e.type&&!!t.key.isEqual(e.key)&&!!t.precondition.isEqual(e.precondition)&&(n=t.fieldTransforms,i=e.fieldTransforms,!!(void 0===n&&void 0===i||!(!n||!i)&&l2(n,i,(t,e)=>{var n,i;return t.field.isEqual(e.field)&&(n=t.transform,i=e.transform,n instanceof cE&&i instanceof cE||n instanceof cI&&i instanceof cI?l2(n.elements,i.elements,u_):n instanceof cA&&i instanceof cA?u_(n.Te,i.Te):n instanceof cb&&i instanceof cb)})))&&(0/* MutationType.Set */===t.type?t.value.isEqual(e.value):1/* MutationType.Patch */!==t.type||t.data.isEqual(e.data)&&t.fieldMask.isEqual(e.fieldMask))}/**
 * A mutation that creates or replaces the document at the given key with the
 * object value contents.
 */class cP extends cD{constructor(t,e,n,i=[]){super(),this.key=t,this.value=e,this.precondition=n,this.fieldTransforms=i,this.type=0/* MutationType.Set */}getFieldMask(){return null}}class cM extends cD{constructor(t,e,n,i,r=[]){super(),this.key=t,this.data=e,this.fieldMask=n,this.precondition=i,this.fieldTransforms=r,this.type=1/* MutationType.Patch */}getFieldMask(){return this.fieldMask}}function cB(t){let e=new Map;return t.fieldMask.fields.forEach(n=>{if(!n.isEmpty()){let i=t.data.field(n);e.set(n,i)}}),e}/**
 ...
 */function cF(t,e,n){var i;let r=new Map;t.length===n.length||l$();for(let s=0;s<n.length;s++){let o=t[s],a=o.transform,l=e.data.field(o.field);r.set(o.field,(i=n[s],a instanceof cE?cT(a,l):a instanceof cI?cS(a,l):i))}return r}/**
 * Creates a list of "transform results" (a transform result is a field value
 ...
 * @returns The transform results list.
 */function cU(t,e,n){let i=new Map;for(let r of t){let t=r.transform,s=n.data.field(r.field);i.set(r.field,t instanceof cb?function(t,e){let n={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:t.seconds,nanos:t.nanoseconds}}}};// We should avoid storing deeply nested server timestamp map values
 ...
 */function t(e){let n=e.mapValue.fields.__previous_value__;return uT(n)?t(n):n}(e)),e&&(n.fields.__previous_value__=e),{mapValue:n}}(e,s):t instanceof cE?cT(t,s):t instanceof cI?cS(t,s):function(t,e){// PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
// precision and resolves overflows by reducing precision, we do not
// manually cap overflows at 2^63.
let n=cw(t,e),i=cx(n)+cx(t.Te);return uR(n)&&uR(t.Te)?cy(i):cm(t.serializer,i)}(t,s))}return i}/** A mutation that deletes the document at the given key. */class cj extends cD{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=2/* MutationType.Delete */,this.fieldTransforms=[]}getFieldMask(){return null}}class cV extends cD{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=3/* MutationType.Verify */,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class c${/**
     ...
     * backend.
     */applyToRemoteDocument(t,e){let n=e.mutationResults;for(let e=0;e<this.mutations.length;e++){let r=this.mutations[e];if(r.key.isEqual(t.key)){var i;i=n[e],r instanceof cP?function(t,e,n){// Unlike setMutationApplyToLocalView, if we're applying a mutation to a
// remote document the server has accepted the mutation so the precondition
// must have held.
let i=t.value.clone(),r=cF(t.fieldTransforms,e,n.transformResults);i.setAll(r),e.convertToFoundDocument(n.version,i).setHasCommittedMutations()}(r,t,i):r instanceof cM?function(t,e,n){if(!cN(t.precondition,e))// matched on the backend. We therefore must not have the expected version
// of the document in our cache and convert to an UnknownDocument with a
// known updateTime.
return void e.convertToUnknownDocument(n.version);let i=cF(t.fieldTransforms,e,n.transformResults),r=e.data;r.setAll(cB(t)),r.setAll(i),e.convertToFoundDocument(n.version,r).setHasCommittedMutations()}(r,t,i):function(t,e,n){// Unlike applyToLocalView, if we're applying a mutation to a remote
...
for(let n of this.baseMutations)n.key.isEqual(t.key)&&(e=cR(n,t,e,this.localWriteTime));// Second, apply all user-provided mutations.
for(let n of this.mutations)n.key.isEqual(t.key)&&(e=cR(n,t,e,this.localWriteTime));return e}/**
...
// to O(n).
let n=ch();return this.mutations.forEach(i=>{let r=t.get(i.key),s=r.overlayedDocument,o=this.applyToLocalView(s,r.mutatedFields);// Set mutatedFields to null if the document is only from local mutations.
// This creates a Set or Delete mutation, instead of trying to create a
// patch mutation as the overlay.
o=e.has(i.key)?null:o;let a=cO(s,o);null!==a&&n.set(i.key,a),s.isValidDocument()||s.convertToNoDocument(l4.min())}),n}keys(){return this.mutations.reduce((t,e)=>t.add(e.key),cp())}isEqual(t){return this.batchId===t.batchId&&l2(this.mutations,t.mutations,(t,e)=>cL(t,e))&&l2(this.baseMutations,t.baseMutations,(t,e)=>cL(t,e))}}/** The result of applying a mutation batch to the backend. */class cz{constructor(t,e,n,/**
     ...
     */static from(t,e,n){t.mutations.length===n.length||l$();let i=cf,r=t.mutations;for(let t=0;t<r.length;t++)i=i.insert(r[t].key,n[t].version);return new cz(t,e,n,i)}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class cH{constructor(t,e){this.databaseId=t,this.useProto3Json=e}}/**
 * Returns a number (or null) from a google.protobuf.Int32Value proto.
 *//**
 * Returns a value for a Date that's appropriate to put into a proto.
 */function cK(t,e){return t.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function cG(t){return t||l$(),l4.fromTimestamp(function(t){let e=uw(t);return new l9(e.seconds,e.nanos)}(t))}function cW(t,e){return new l6(["projects",t.projectId,"databases",t.database]).child("documents").child(e).canonicalString()}function cQ(t,e){return cW(t.databaseId,e.path)}/** Creates a Document proto from key and fields (but no create/update time) */function cX(t,e,n){return{name:cQ(t,e),fields:n.value.mapValue.fields}}function cY(t){return l8.fromServerFormat(t.fieldPath)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 *//** Serializer for values stored in the LocalStore. */class cJ{constructor(t){this.ht=t}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
/** Firestore index value writer.  */class cZ{constructor(){}// The write methods below short-circuit writing terminators for values
 ...
 */class c0{constructor(){this.an=new c1}addToCollectionParentIndex(t,e){return this.an.add(e),ui.resolve()}getCollectionParents(t,e){return ui.resolve(this.an.getEntries(e))}addFieldIndex(t,e){// Field indices are not supported with memory persistence.
 ...
 */class c1{constructor(){this.index={}}// Returns false if the entry already existed.
add(t){let e=t.lastSegment(),n=t.popLast(),i=this.index[e]||new ud(l6.comparator),r=!i.has(n);return this.index[e]=i.add(n),r}has(t){let e=t.lastSegment(),n=t.popLast(),i=this.index[e];return i&&i.has(n)}getEntries(t){return(this.index[t]||new ud(l6.comparator)).toArray()}}new Uint8Array(0);class c2{constructor(// threshold. Passing `COLLECTION_DISABLED` here will cause collection to always be skipped.
t,e,// us from collecting a huge number of sequence numbers if the cache has grown very large.
n){this.cacheSizeCollectionThreshold=t,this.percentileToCollect=e,this.maximumSequenceNumbersToCollect=n}static withCacheSize(t){return new c2(t,c2.DEFAULT_COLLECTION_PERCENTILE,c2.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 *//** A mutation queue for a specific user, backed by IndexedDB. */c2.DEFAULT_COLLECTION_PERCENTILE=10,c2.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,c2.DEFAULT=new c2(41943040,c2.DEFAULT_COLLECTION_PERCENTILE,c2.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),c2.DISABLED=new c2(-1,0,0);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * restart.
 */class c9{constructor(t){this.Nn=t}next(){return this.Nn+=2,this.Nn}static Bn(){// The target cache generator must return '2' in its first call to `next()`
// as there is no differentiation in the protocol layer between an unset
// number and the number '0'. If we were to sent a target with target ID
// '0', the backend would consider it unset and replace it with its own ID.
return new c9(0)}static Ln(){// Sync engine assigns target IDs for limbo document detection.
return new c9(-1)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 */class c4{constructor(){// A mapping of document key to the new cache entry that should be written.
this.changes=new co(t=>t.toString(),(t,e)=>t.isEqual(e)),this.changesApplied=!1}/**
 ...
 */class c6{constructor(t,e,n,i){this.remoteDocumentCache=t,this.mutationQueue=e,this.documentOverlayCache=n,this.indexManager=i}/**
     * Get the local view of the document identified by `key`.
     *
     * @returns Local view of the document or null if we don't have any cached
     * state for it.
     */getDocument(t,e){let n=null;return this.documentOverlayCache.getOverlay(t,e).next(i=>(n=i,this.remoteDocumentCache.getEntry(t,e))).next(t=>(null!==n&&cR(n.mutation,t,ug.empty(),l9.now()),t))}/**
     * Gets the local view of the documents identified by `keys`.
     *
     * If we don't have cached state for a document in `keys`, a NoDocument will
     * be stored for that key in the resulting set.
     */getDocuments(t,e){return this.remoteDocumentCache.getEntries(t,e).next(e=>this.getLocalViewOfDocuments(t,e,cp()).next(()=>e))}/**
     ...
     *   to be recalculated.
     */getLocalViewOfDocuments(t,e,n=cp()){let i=ch();return this.populateOverlays(t,i,e).next(()=>this.computeViews(t,e,i,n).next(t=>{let e=cu();return t.forEach((t,n)=>{e=e.insert(t,n.overlayedDocument)}),e}))}/**
     * Gets the overlayed documents for the given document map, which will include
     * the local view of those documents and a `FieldMask` indicating which fields
     * are mutated locally, `null` if overlay is a Set or Delete mutation.
     */getOverlayedDocuments(t,e){let n=ch();return this.populateOverlays(t,n,e).next(()=>this.computeViews(t,e,n,cp()))}/**
     ...
     */computeViews(t,e,n,i){let r=ca,s=ch(),o=ch();return e.forEach((t,e)=>{let o=n.get(e.key);// Recalculate an overlay if the document's existence state changed due to
...
i.has(e.key)&&(void 0===o||o.mutation instanceof cM)?r=r.insert(e.key,e):void 0!==o?(s.set(e.key,o.mutation.getFieldMask()),cR(o.mutation,e,o.mutation.getFieldMask(),l9.now())):// Using EMPTY to indicate there is no overlay for the document.
s.set(e.key,ug.empty())}),this.recalculateAndSaveOverlays(t,r).next(t=>(t.forEach((t,e)=>s.set(t,e)),e.forEach((t,e)=>{var n;return o.set(t,new c5(e,null!==(n=s.get(t))&&void 0!==n?n:null))}),o))}recalculateAndSaveOverlays(t,e){let n=ch(),i=new uc((t,e)=>t-e),r=cp();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,e).next(t=>{for(let r of t)r.keys().forEach(t=>{let s=e.get(t);if(null===s)return;let o=n.get(t)||ug.empty();o=r.applyToLocalView(s,o),n.set(t,o);let a=(i.get(r.batchId)||cp()).add(t);i=i.insert(r.batchId,a)})}).next(()=>{let s=[],o=i.getReverseIterator();// Iterate in descending order of batch IDs, and skip documents that are
// already saved.
for(;o.hasNext();){let i=o.getNext(),a=i.key,l=i.value,u=ch();l.forEach(t=>{if(!r.has(t)){let i=cO(e.get(t),n.get(t));null!==i&&u.set(t,i),r=r.add(t)}}),s.push(this.documentOverlayCache.saveOverlays(t,a,u))}return ui.waitFor(s)}).next(()=>n)}/**
 ...
 */return l7.isDocumentKey(e.path)&&null===e.collectionGroup&&0===e.filters.length?this.getDocumentsMatchingDocumentQuery(t,e.path):null!==e.collectionGroup?this.getDocumentsMatchingCollectionGroupQuery(t,e,n,i):this.getDocumentsMatchingCollectionQuery(t,e,n,i)}/**
     ...
     */getNextDocuments(t,e,n,i){return this.remoteDocumentCache.getAllFromCollectionGroup(t,e,n,i).next(r=>{let s=i-r.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,e,n.largestBatchId,i-r.size):ui.resolve(ch()),o=-1,a=r;return s.next(e=>ui.forEach(e,(e,n)=>(o<n.largestBatchId&&(o=n.largestBatchId),r.get(e)?ui.resolve():this.remoteDocumentCache.getEntry(t,e).next(t=>{a=a.insert(e,t)}))).next(()=>this.populateOverlays(t,e,r)).next(()=>this.computeViews(t,a,e,cp())).next(t=>({batchId:o,changes:cc(t)})))})}getDocumentsMatchingDocumentQuery(t,e){// Just do a simple document lookup.
return this.getDocument(t,new l7(e)).next(t=>{let e=cu();return t.isFoundDocument()&&(e=e.insert(t.key,t)),e})}getDocumentsMatchingCollectionGroupQuery(t,e,n,i){let r=e.collectionGroup,s=cu();return this.indexManager.getCollectionParents(t,r).next(o=>ui.forEach(o,o=>{var a;let l=(a=o.child(r),new u3(a,/*collectionGroup=*/null,e.explicitOrderBy.slice(),e.filters.slice(),e.limit,e.limitType,e.startAt,e.endAt));return this.getDocumentsMatchingCollectionQuery(t,l,n,i).next(t=>{t.forEach((t,e)=>{s=s.insert(t,e)})})}).next(()=>s))}getDocumentsMatchingCollectionQuery(t,e,n,i){// Query the remote documents and overlay mutations.
...
let n=cu();return t.forEach((t,i)=>{let s=r.get(t);void 0!==s&&cR(s.mutation,i,ug.empty(),l9.now()),cs(e,i)&&(n=n.insert(t,i))}),n})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class c3{constructor(t){this.serializer=t,this.lr=new Map,this.hr=new Map}getBundleMetadata(t,e){return ui.resolve(this.lr.get(e))}saveBundleMetadata(t,e){return this.lr.set(e.id,{id:e.id,version:e.version,createTime:cG(e.createTime)}),ui.resolve()}getNamedQuery(t,e){return ui.resolve(this.hr.get(e))}saveNamedQuery(t,e){return this.hr.set(e.name,{name:e.name,query:/**
 * Encodes a `BundledQuery` from bundle proto to a Query object.
 *
 * This reconstructs the original query used to build the bundle being loaded,
 * including features exists only in SDKs (for example: limit-to-last).
 */function(t){let e=function(t){var e,n,i,r,s,o,a,l;let u,c=function(t){let e=function(t){let e=l6.fromString(t);return e.length>=4&&"projects"===e.get(0)&&"databases"===e.get(2)||l$(),e}(t);// In v1beta1 queries for collections at the root did not have a trailing
// "/documents". In v1 all resource paths contain "/documents". Preserve the
// ability to read the v1beta1 form for compatibility with queries persisted
// in the local target cache.
return 4===e.length?l6.emptyPath():(e.length>4&&"documents"===e.get(4)||l$(),e.popFirst(5))}(t.parent),h=t.structuredQuery,f=h.from?h.from.length:0,d=null;if(f>0){1===f||l$();let t=h.from[0];t.allDescendants?d=t.collectionId:c=c.child(t.collectionId)}let p=[];h.where&&(p=function(t){var e;let n=function t(e){return void 0!==e.unaryFilter?function(t){switch(t.unaryFilter.op){case"IS_NAN":let e=cY(t.unaryFilter.field);return uH.create(e,"=="/* Operator.EQUAL */,{doubleValue:NaN});case"IS_NULL":let n=cY(t.unaryFilter.field);return uH.create(n,"=="/* Operator.EQUAL */,{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":let i=cY(t.unaryFilter.field);return uH.create(i,"!="/* Operator.NOT_EQUAL */,{doubleValue:NaN});case"IS_NOT_NULL":let r=cY(t.unaryFilter.field);return uH.create(r,"!="/* Operator.NOT_EQUAL */,{nullValue:"NULL_VALUE"});default:return l$()}}(e):void 0!==e.fieldFilter?uH.create(cY(e.fieldFilter.field),function(t){switch(t){case"EQUAL":return"=="/* Operator.EQUAL */;case"NOT_EQUAL":return"!="/* Operator.NOT_EQUAL */;case"GREATER_THAN":return">"/* Operator.GREATER_THAN */;case"GREATER_THAN_OR_EQUAL":return">="/* Operator.GREATER_THAN_OR_EQUAL */;case"LESS_THAN":return"<"/* Operator.LESS_THAN */;case"LESS_THAN_OR_EQUAL":return"<="/* Operator.LESS_THAN_OR_EQUAL */;case"ARRAY_CONTAINS":return"array-contains"/* Operator.ARRAY_CONTAINS */;case"IN":return"in"/* Operator.IN */;case"NOT_IN":return"not-in"/* Operator.NOT_IN */;case"ARRAY_CONTAINS_ANY":return"array-contains-any"/* Operator.ARRAY_CONTAINS_ANY */;default:return l$()}}(e.fieldFilter.op),e.fieldFilter.value):void 0!==e.compositeFilter?uK.create(e.compositeFilter.filters.map(e=>t(e)),function(t){switch(t){case"AND":return"and"/* CompositeOperator.AND */;case"OR":return"or"/* CompositeOperator.OR */;default:return l$()}}(e.compositeFilter.op)):l$()}(t);return n instanceof uK&&uW(e=n)&&uG(e)?n.getFilters():[n]}(h.where));let g=[];h.orderBy&&(g=h.orderBy.map(t=>new uz(cY(t.field),function(t){switch(t){case"ASCENDING":return"asc"/* Direction.ASCENDING */;case"DESCENDING":return"desc"/* Direction.DESCENDING */;default:return}}(t.direction))));let m=null;h.limit&&(m=null==(u="object"==typeof(e=h.limit)?e.value:e)?null:u);let y=null;h.startAt&&(y=function(t){let e=!!t.before,n=t.values||[];return new uj(n,e)}(h.startAt));let v=null;return h.endAt&&(v=function(t){let e=!t.before,n=t.values||[];return new uj(n,e)}(h.endAt)),n=c,i=d,r=g,s=p,o=m,a=y,l=v,new u3(n,i,r,s,o,"F"/* LimitType.First */,a,l)}({parent:t.parent,structuredQuery:t.structuredQuery});return"LAST"===t.limitType?ce(e,e.limit,"L"/* LimitType.Last */):e}(e.bundledQuery),readTime:cG(e.readTime)}),ui.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class c8{constructor(){// A map sorted by DocumentKey, whose value is a pair of the largest batch id
// for the overlay and the overlay itself.
this.overlays=new uc(l7.comparator),this.Pr=new Map}getOverlay(t,e){return ui.resolve(this.overlays.get(e))}getOverlays(t,e){let n=ch();return ui.forEach(e,e=>this.getOverlay(t,e).next(t=>{null!==t&&n.set(e,t)})).next(()=>n)}saveOverlays(t,e,n){return n.forEach((n,i)=>{this.It(t,e,i)}),ui.resolve()}removeOverlaysForBatchId(t,e,n){let i=this.Pr.get(n);return void 0!==i&&(i.forEach(t=>this.overlays=this.overlays.remove(t)),this.Pr.delete(n)),ui.resolve()}getOverlaysForCollection(t,e,n){let i=ch(),r=e.length+1,s=new l7(e.child("")),o=this.overlays.getIteratorFrom(s);for(;o.hasNext();){let t=o.getNext().value,s=t.getKey();if(!e.isPrefixOf(s.path))break;// Documents from sub-collections
s.path.length===r&&t.largestBatchId>n&&i.set(t.getKey(),t)}return ui.resolve(i)}getOverlaysForCollectionGroup(t,e,n,i){let r=new uc((t,e)=>t-e),s=this.overlays.getIterator();for(;s.hasNext();){let t=s.getNext().value;if(t.getKey().getCollectionGroup()===e&&t.largestBatchId>n){let e=r.get(t.largestBatchId);null===e&&(e=ch(),r=r.insert(t.largestBatchId,e)),e.set(t.getKey(),t)}}let o=ch(),a=r.getIterator();for(;a.hasNext()&&(a.getNext().value.forEach((t,e)=>o.set(t,e)),!(o.size()>=i)););return ui.resolve(o)}It(t,e,n){// Remove the association of the overlay to its batch id.
...
let r=this.Pr.get(e);void 0===r&&(r=cp(),this.Pr.set(e,r)),this.Pr.set(e,r.add(n.key))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * some target ID.
 */class c7{constructor(){// A set of outstanding references to a document sorted by key.
this.Ir=new ud(ht.dr),this.Tr=new ud(ht.Er)}/** Returns true if the reference set contains no references. */isEmpty(){return this.Ir.isEmpty()}/** Adds a reference to the given document key for the given ID. */addReference(t,e){let n=new ht(t,e);this.Ir=this.Ir.add(n),this.Tr=this.Tr.add(n)}/** Add references to the given document keys for the given ID. */Ar(t,e){t.forEach(t=>this.addReference(t,e))}/**
     * Removes a reference to the given document key for the given
     * ID.
     */removeReference(t,e){this.Rr(new ht(t,e))}Vr(t,e){t.forEach(t=>this.removeReference(t,e))}/**
     * Clears all references with a given ID. Calls removeRef() for each key
     * removed.
     */mr(t){let e=new l7(new l6([])),n=new ht(e,t),i=new ht(e,t+1),r=[];return this.Tr.forEachInRange([n,i],t=>{this.Rr(t),r.push(t.key)}),r}gr(){this.Ir.forEach(t=>this.Rr(t))}Rr(t){this.Ir=this.Ir.delete(t),this.Tr=this.Tr.delete(t)}pr(t){let e=new l7(new l6([])),n=new ht(e,t),i=new ht(e,t+1),r=cp();return this.Tr.forEachInRange([n,i],t=>{r=r.add(t.key)}),r}containsKey(t){let e=new ht(t,0),n=this.Ir.firstAfterOrEqual(e);return null!==n&&t.isEqual(n.key)}}class ht{constructor(t,e){this.key=t,this.yr=e}/** Compare by key then by ID */static dr(t,e){return l7.comparator(t.key,e.key)||l1(t.yr,e.yr)}/** Compare by ID then by key */static Er(t,e){return l1(t.yr,e.yr)||l7.comparator(t.key,e.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class he{constructor(t,e){this.indexManager=t,this.referenceDelegate=e,/**
         * The set of all mutations that have been sent but not yet been applied to
         * the backend.
         */this.mutationQueue=[],/** Next value to use when assigning sequential IDs to each mutation batch. */this.wr=1,/** An ordered mapping between documents and the mutations batch IDs. */this.Sr=new ud(ht.dr)}checkEmpty(t){return ui.resolve(0===this.mutationQueue.length)}addMutationBatch(t,e,n,i){let r=this.wr;this.wr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];let s=new c$(r,e,n,i);// Track references by document key and index collection parents.
for(let e of(this.mutationQueue.push(s),i))this.Sr=this.Sr.add(new ht(e.key,r)),this.indexManager.addToCollectionParentIndex(t,e.key.path.popLast());return ui.resolve(s)}lookupMutationBatch(t,e){return ui.resolve(this.br(e))}getNextMutationBatchAfterBatchId(t,e){let n=this.Dr(e+1),i=n<0?0:n;// The requested batchId may still be out of range so normalize it to the
// start of the queue.
return ui.resolve(this.mutationQueue.length>i?this.mutationQueue[i]:null)}getHighestUnacknowledgedBatchId(){return ui.resolve(0===this.mutationQueue.length?-1:this.wr-1)}getAllMutationBatches(t){return ui.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(t,e){let n=new ht(e,0),i=new ht(e,Number.POSITIVE_INFINITY),r=[];return this.Sr.forEachInRange([n,i],t=>{let e=this.br(t.yr);r.push(e)}),ui.resolve(r)}getAllMutationBatchesAffectingDocumentKeys(t,e){let n=new ud(l1);return e.forEach(t=>{let e=new ht(t,0),i=new ht(t,Number.POSITIVE_INFINITY);this.Sr.forEachInRange([e,i],t=>{n=n.add(t.yr)})}),ui.resolve(this.Cr(n))}getAllMutationBatchesAffectingQuery(t,e){// Use the query path as a prefix for testing if a document matches the
// query.
let n=e.path,i=n.length+1,r=n;l7.isDocumentKey(r)||(r=r.child(""));let s=new ht(new l7(r),0),o=new ud(l1);return this.Sr.forEachWhile(t=>{let e=t.key.path;return!!n.isPrefixOf(e)&&// Rows with document keys more than one segment longer than the query
...
let e=[];return t.forEach(t=>{let n=this.br(t);null!==n&&e.push(n)}),e}removeMutationBatch(t,e){0===this.vr(e.batchId,"removed")||l$(),this.mutationQueue.shift();let n=this.Sr;return ui.forEach(e.mutations,i=>{let r=new ht(i.key,e.batchId);return n=n.delete(r),this.referenceDelegate.markPotentiallyOrphaned(t,i.key)}).next(()=>{this.Sr=n})}xn(t){// No-op since the memory mutation queue does not maintain a separate cache.
}containsKey(t,e){let n=new ht(e,0),i=this.Sr.firstAfterOrEqual(n);return ui.resolve(e.isEqual(i&&i.key))}performConsistencyCheck(t){return this.mutationQueue.length,ui.resolve()}/**
 ...
 */class hn{/**
     ...
     */constructor(t){this.Fr=t,/** Underlying cache of documents and their read times. */this.docs=new uc(l7.comparator),/** Size of all cached documents. */this.size=0}setIndexManager(t){this.indexManager=t}/**
     ...
     * returned by `newChangeBuffer()`.
     */removeEntry(t){let e=this.docs.get(t);e&&(this.docs=this.docs.remove(t),this.size-=e.size)}getEntry(t,e){let n=this.docs.get(e);return ui.resolve(n?n.document.mutableCopy():uU.newInvalidDocument(e))}getEntries(t,e){let n=ca;return e.forEach(t=>{let e=this.docs.get(t);n=n.insert(t,e?e.document.mutableCopy():uU.newInvalidDocument(t))}),ui.resolve(n)}getDocumentsMatchingQuery(t,e,n,i){let r=ca,s=e.path,o=new l7(s.child("")),a=this.docs.getIteratorFrom(o);for(;a.hasNext();){let{key:t,value:{document:o}}=a.getNext();if(!s.isPrefixOf(t.path))break;t.path.length>s.length+1||0>=function(t,e){let n=t.readTime.compareTo(e.readTime);return 0!==n?n:0!==(n=l7.comparator(t.documentKey,e.documentKey))?n:l1(t.largestBatchId,e.largestBatchId)}(new ut(o.readTime,o.key,-1),n)||(i.has(o.key)||cs(e,o))&&(r=r.insert(o.key,o.mutableCopy()))}return ui.resolve(r)}getAllFromCollectionGroup(t,e,n,i){// This method should only be called from the IndexBackfiller if persistence
// is enabled.
...
return new hi(this)}getSize(t){return ui.resolve(this.size)}}/**
 ...
 */class hi extends c4{constructor(t){super(),this.ur=t}applyChanges(t){let e=[];return this.changes.forEach((n,i)=>{i.isValidDocument()?e.push(this.ur.addEntry(t,i)):this.ur.removeEntry(n)}),ui.waitFor(e)}getFromCache(t,e){return this.ur.getEntry(t,e)}getAllFromCache(t,e){return this.ur.getEntries(t,e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class hs{/**
     ...
     */constructor(t,e){this.kr={},this.overlays={},this.qr=new us(0),this.Qr=!1,this.Qr=!0,this.referenceDelegate=t(this),this.Kr=new hr(this),this.indexManager=new c0,this.remoteDocumentCache=new hn(t=>this.referenceDelegate.$r(t)),this.serializer=new cJ(e),this.Ur=new c3(this.serializer)}start(){return Promise.resolve()}shutdown(){// No durable state to ensure is closed on shutdown.
...
return this.indexManager}getDocumentOverlayCache(t){let e=this.overlays[t.toKey()];return e||(e=new c8,this.overlays[t.toKey()]=e),e}getMutationQueue(t,e){let n=this.kr[t.toKey()];return n||(n=new he(e,this.referenceDelegate),this.kr[t.toKey()]=n),n}getTargetCache(){return this.Kr}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Ur}runTransaction(t,e,n){lF("MemoryPersistence","Starting transaction:",t);let i=new ho(this.qr.next());return this.referenceDelegate.Wr(),n(i).next(t=>this.referenceDelegate.Gr(i).next(()=>t)).toPromise().then(t=>(i.raiseOnCommittedEvent(),t))}zr(t,e){return ui.or(Object.values(this.kr).map(n=>()=>n.containsKey(t,e)))}}/**
 * Memory persistence is not actually transactional, but future implementations
 * may have transaction-scoped state.
 */class ho extends ue{constructor(t){super(),this.currentSequenceNumber=t}}class ha{constructor(t){this.persistence=t,/** Tracks all documents that are active in Query views. */this.jr=new c7,/** The list of documents that are potentially GCed after each transaction. */this.Hr=null}static Jr(t){return new ha(t)}get Yr(){if(this.Hr)return this.Hr;throw l$()}addReference(t,e,n){return this.jr.addReference(n,e),this.Yr.delete(n.toString()),ui.resolve()}removeReference(t,e,n){return this.jr.removeReference(n,e),this.Yr.add(n.toString()),ui.resolve()}markPotentiallyOrphaned(t,e){return this.Yr.add(e.toString()),ui.resolve()}removeTarget(t,e){this.jr.mr(e.targetId).forEach(t=>this.Yr.add(t.toString()));let n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(t,e.targetId).next(t=>{t.forEach(t=>this.Yr.add(t.toString()))}).next(()=>n.removeTargetData(t,e))}Wr(){this.Hr=new Set}Gr(t){// Remove newly orphaned documents.
 ...
 */class hl{constructor(t,e,n,i){this.targetId=t,this.fromCache=e,this.Qi=n,this.Ki=i}static $i(t,e){let n=cp(),i=cp();for(let t of e.docChanges)switch(t.type){case 0/* ChangeType.Added */:n=n.add(t.doc.key);break;case 1/* ChangeType.Removed */:i=i.add(t.doc.key)}return new hl(t,e.fromCache,n,i)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class hc{constructor(){this.Ui=!1,this.Wi=!1,/**
...
let r={result:null};return this.Hi(t,e).next(t=>{r.result=t}).next(()=>{if(!r.result)return this.Ji(t,e,i,n).next(t=>{r.result=t})}).next(()=>{if(r.result)return;let n=new hu;return this.Yi(t,e,n).next(i=>{if(r.result=i,this.Wi)return this.Zi(t,e,n,i.size)})}).next(()=>r.result)}Zi(t,e,n,i){return n.documentReadCount<this.Gi?(lB()<=ss.DEBUG&&lF("QueryEngine","SDK will not create cache indexes for query:",cr(e),"since it only creates cache indexes for collection contains","more than or equal to",this.Gi,"documents"),ui.resolve()):(lB()<=ss.DEBUG&&lF("QueryEngine","Query:",cr(e),"scans",n.documentReadCount,"local documents and returns",i,"documents as results."),n.documentReadCount>this.zi*i?(lB()<=ss.DEBUG&&lF("QueryEngine","The SDK decides to create cache indexes for query:",cr(e),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,ct(e))):ui.resolve())}/**
     * Performs an indexed query that evaluates the query based on a collection's
     * persisted index values. Returns `null` if an index is not available.
     */Hi(t,e){if(u8(e))// key-based lookups. It is more efficient to scan all documents in a
// collection, rather than to perform individual lookups.
return ui.resolve(null);let n=ct(e);return this.indexManager.getIndexType(t,n).next(i=>0/* IndexType.NONE */===i?null:(null!==e.limit&&1/* IndexType.PARTIAL */===i&&(n=ct(// We cannot apply a limit for targets that are served using a partial
    ...
    e=ce(e,null,"F"/* LimitType.First */))),this.indexManager.getDocumentsMatchingTarget(t,n).next(i=>{let r=cp(...i);return this.ji.getDocuments(t,r).next(i=>this.indexManager.getMinOffset(t,n).next(n=>{let s=this.Xi(e,i);return this.es(e,s,r,n.readTime)?this.Hi(t,ce(e,null,"F"/* LimitType.First */)):this.ts(t,s,e,n)}))})))}/**
     * Performs a query based on the target's persisted query mapping. Returns
     * `null` if the mapping is not available or cannot be used.
     */Ji(t,e,n,i){return u8(e)||i.isEqual(l4.min())?ui.resolve(null):this.ji.getDocuments(t,n).next(r=>{let s=this.Xi(e,r);return this.es(e,s,n,i)?ui.resolve(null):(lB()<=ss.DEBUG&&lF("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),cr(e)),this.ts(t,s,e,/**
...
let r="F"/* LimitType.First */===t.limitType?e.last():e.first();return!!r&&(r.hasPendingWrites||r.version.compareTo(i)>0)}Yi(t,e,n){return lB()<=ss.DEBUG&&lF("QueryEngine","Using full collection scan to execute query:",cr(e)),this.ji.getDocumentsMatchingQuery(t,e,ut.min(),n)}/**
 ...
 */class hh{constructor(/** Manages our in-memory or durable persistence. */t,e,n,i){this.persistence=t,this.ns=e,this.serializer=i,/**
         * Maps a targetID to data about its target.
         *
         * PORTING NOTE: We are using an immutable data structure on Web to make re-runs
         * of `applyRemoteEvent()` idempotent.
         */this.rs=new uc(l1),/** Maps a target to its targetID. */this.ss=new co(t=>u5(t),u6),/**
...
// user change
this.documentOverlayCache=this.persistence.getDocumentOverlayCache(t),this.indexManager=this.persistence.getIndexManager(t),this.mutationQueue=this.persistence.getMutationQueue(t,this.indexManager),this.localDocuments=new c6(this._s,this.mutationQueue,this.documentOverlayCache,this.indexManager),this._s.setIndexManager(this.indexManager),this.ns.initialize(this.localDocuments,this.indexManager)}collectGarbage(t){return this.persistence.runTransaction("Collect garbage","readwrite-primary",e=>t.collect(e,this.rs))}}/**
...
// change.
async function hf(t,e){return await t.persistence.runTransaction("Handle user change","readonly",n=>{// Swap out the mutation queue, grabbing the pending mutation batches
// before and after.
let i;return t.mutationQueue.getAllMutationBatches(n).next(r=>(i=r,t.us(e),t.mutationQueue.getAllMutationBatches(n))).next(e=>{let r=[],s=[],o=cp();for(let t of i)for(let e of(r.push(t.batchId),t.mutations))o=o.add(e.key);for(let t of e)for(let e of(s.push(t.batchId),t.mutations))o=o.add(e.key);// Return the set of all (potentially) changed documents and the list
 ...
 * `toWebStorageJSON()`.
 */// Visible for testing.
class hd{constructor(){this.activeTargetIds=cg}Rs(t){this.activeTargetIds=this.activeTargetIds.add(t)}Vs(t){this.activeTargetIds=this.activeTargetIds.delete(t)}/**
     * Converts this entry into a JSON-encoded format we can use for WebStorage.
     * Does not encode `clientId` as it is part of the key in WebStorage.
     */As(){let t={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(t)}}class hp{constructor(){this.ro=new hd,this.io={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(t){// No op.
}updateMutationState(t,e,n){// No op.
}addLocalQueryTarget(t){return this.ro.Rs(t),this.io[t]||"not-current"}updateQueryState(t,e,n){this.io[t]=e}removeLocalQueryTarget(t){this.ro.Vs(t)}isLocalQueryTarget(t){return this.ro.activeTargetIds.has(t)}clearQueryState(t){delete this.io[t]}getAllActiveQueryTargets(){return this.ro.activeTargetIds}isActiveQueryTarget(t){return this.ro.activeTargetIds.has(t)}start(){return this.ro=new hd,Promise.resolve()}handleUserChange(t,e,n){// No op.
 ...
 */function hv(){return null===hy?hy=268435456+Math.round(2147483648*Math.random()):hy++,"0x"+hy.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class hb{constructor(t){this.ho=t.ho,this.Po=t.Po}Io(t){this.To=t}Eo(t){this.Ao=t}onMessage(t){this.Ro=t}close(){this.Po()}send(t){this.ho(t)}Vo(){this.To()}mo(t){this.Ao(t)}fo(t){this.Ro(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hE="WebChannelConnection";class hT extends /**
...
return!1}bo(t,e,n,i,r){let s=hv(),o=this.Do(t,e);lF("RestConnection",`Sending RPC '${t}' ${s}:`,o,n);let a={"google-cloud-resource-prefix":this.yo,"x-goog-request-params":this.wo};return this.Co(a,i,r),this.vo(t,o,a,n).then(e=>(lF("RestConnection",`Received RPC '${t}' ${s}: `,e),e),e=>{throw lj("RestConnection",`RPC '${t}' ${s} failed with error: `,e,"url: ",o,"request:",n),e})}Fo(t,e,n,i,r,s){// The REST API automatically aggregates all of the streamed results, so we
...
t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),e&&e.headers.forEach((e,n)=>t[n]=e),n&&n.headers.forEach((e,n)=>t[n]=e)}Do(t,e){let n=hw[t];return`${this.po}/v1/${e}:${n}`}}{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}vo(t,e,n,i){let r=hv();return new Promise((s,o)=>{let a=new lD;a.setWithCredentials(!0),a.listenOnce(lC.COMPLETE,()=>{try{switch(a.getLastErrorCode()){case lx.NO_ERROR:let e=a.getResponseJson();lF(hE,`XHR for RPC '${t}' ${r} received:`,JSON.stringify(e)),s(e);break;case lx.TIMEOUT:lF(hE,`RPC '${t}' ${r} timed out`),o(new lq(lz.DEADLINE_EXCEEDED,"Request time out"));break;case lx.HTTP_ERROR:let n=a.getStatus();if(lF(hE,`RPC '${t}' ${r} failed with status:`,n,"response text:",a.getResponseText()),n>0){let t=a.getResponseJson();Array.isArray(t)&&(t=t[0]);let e=null==t?void 0:t.error;if(e&&e.status&&e.message){let t=function(t){let e=t.toLowerCase().replace(/_/g,"-");return Object.values(lz).indexOf(e)>=0?e:lz.UNKNOWN}(e.status);o(new lq(t,e.message))}else o(new lq(lz.UNKNOWN,"Server responded with status "+a.getStatus()))}else // it's most probably a connection issue
o(new lq(lz.UNAVAILABLE,"Connection failed."));break;default:l$()}}finally{lF(hE,`RPC '${t}' ${r} completed.`)}});let l=JSON.stringify(i);lF(hE,`RPC '${t}' ${r} sending request:`,i),a.send(e,"POST",l,n,15)})}Mo(t,e,n){let i=hv(),r=[this.po,"/","google.firestore.v1.Firestore","/",t,"/channel"],s=lS(),o=lA(),a={// Required for backend stickiness, routing behavior is based on this
// parameter.
...
a.encodeInitMessageHeaders=!0;let u=r.join("");lF(hE,`Creating RPC '${t}' stream ${i}: ${u}`,a);let c=s.createWebChannel(u,a),h=!1,f=!1,p=new hb({ho:e=>{f?lF(hE,`Not sending because RPC '${t}' stream ${i} is closed:`,e):(h||(lF(hE,`Opening RPC '${t}' stream ${i} transport.`),c.open(),h=!0),lF(hE,`RPC '${t}' stream ${i} sending:`,e),c.send(e))},Po:()=>c.close()}),g=(t,e,n)=>{// TODO(dimond): closure typing seems broken because WebChannel does
...
return g(c,lN.EventType.OPEN,()=>{f||lF(hE,`RPC '${t}' stream ${i} transport opened.`)}),g(c,lN.EventType.CLOSE,()=>{f||(f=!0,lF(hE,`RPC '${t}' stream ${i} transport closed`),p.mo())}),g(c,lN.EventType.ERROR,e=>{f||(f=!0,lj(hE,`RPC '${t}' stream ${i} transport errored:`,e),p.mo(new lq(lz.UNAVAILABLE,"The operation could not be completed")))}),g(c,lN.EventType.MESSAGE,e=>{var n;if(!f){let r=e.data[0];r||l$();// TODO(b/35143891): There is a bug in One Platform that caused errors
// (and only errors) to be wrapped in an extra array. To be forward
// compatible with the bug we need to check either condition. The latter
// can be removed once the fix has been rolled out.
// Use any because msgData.error is not typed.
let s=r.error||(null===(n=r[0])||void 0===n?void 0:n.error);if(s){lF(hE,`RPC '${t}' stream ${i} received error:`,s);// error.status will be a string like 'OK' or 'NOT_FOUND'.
let e=s.status,n=/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hS(t){return new cH(t,/* useProto3Json= */!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class hx{constructor(t,e,n,i,r,s,o,a){this._i=t,this.Uo=n,this.Wo=i,this.connection=r,this.authCredentialsProvider=s,this.appCheckCredentialsProvider=o,this.listener=a,this.state=0/* PersistentStreamState.Initial */,/**
         * A close count that's incremented every time the stream is closed; used by
         * getCloseGuardedDispatcher() to invalidate callbacks that happen after
         * close.
         */this.Go=0,this.zo=null,this.jo=null,this.stream=null,this.Ho=new hA(t,e)}/**
 ...
 */class hC extends hx{constructor(t,e,n,i,r,s){super(t,"write_stream_connection_backoff"/* TimerId.WriteStreamConnectionBackoff */,"write_stream_idle"/* TimerId.WriteStreamIdle */,"health_check_timeout"/* TimerId.HealthCheckTimeout */,e,n,i,s),this.serializer=r,this.P_=!1}/**
...
this.Ho.reset();let i=(e=t.writeResults,n=t.commitTime,e&&e.length>0?(void 0!==n||l$(),e.map(t=>{let e;return(e=t.updateTime?cG(t.updateTime):cG(n)).isEqual(l4.min())&&// The Firestore Emulator currently returns an update time of 0 for
// deletes of non-existing documents (rather than null). This breaks the
// test "get deleted doc while offline with source=cache" as NoDocuments
// with version 0 are filtered by IndexedDb's RemoteDocumentCache.
// TODO(#2149): Remove this when Emulator is fixed
(e=cG(n)),new c_(e,t.transformResults||[])})):[]),r=cG(t.commitTime);return this.listener.T_(r,i)}// The first response is always the handshake response
...
let e={};e.database=(t=this.serializer,new l6(["projects",t.databaseId.projectId,"databases",t.databaseId.database]).canonicalString()),this.n_(e)}/** Sends a group of mutations to the Firestore backend to apply. */d_(t){let e={streamToken:this.lastStreamToken,writes:t.map(t=>(function(t,e){var n;let i;if(e instanceof cP)i={update:cX(t,e.key,e.value)};else if(e instanceof cj)i={delete:cQ(t,e.key)};else if(e instanceof cM)i={update:cX(t,e.key,e.data),updateMask:function(t){let e=[];return t.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}(e.fieldMask)};else{if(!(e instanceof cV))return l$();i={verify:cQ(t,e.key)}}return e.fieldTransforms.length>0&&(i.updateTransforms=e.fieldTransforms.map(t=>(function(t,e){let n=e.transform;if(n instanceof cb)return{fieldPath:e.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(n instanceof cE)return{fieldPath:e.field.canonicalString(),appendMissingElements:{values:n.elements}};if(n instanceof cI)return{fieldPath:e.field.canonicalString(),removeAllFromArray:{values:n.elements}};if(n instanceof cA)return{fieldPath:e.field.canonicalString(),increment:n.Te};throw l$()})(0,t))),e.precondition.isNone||(i.currentDocument=void 0!==(n=e.precondition).updateTime?{updateTime:cK(t,n.updateTime.toTimestamp())}:void 0!==n.exists?{exists:n.exists}:l$()),i})(this.serializer,t))};this.n_(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class hk{constructor(t,e){this.asyncQueue=t,this.onlineStateHandler=e,/** The current OnlineState. */this.state="Unknown"/* OnlineState.Unknown */,/**
...
// down our streams.
hR(this)&&(lF("RemoteStore","Restarting streams for network reachability change."),await async function(t){t.F_.add(4/* OfflineCause.ConnectivityChange */),await hO(t),t.O_.set("Unknown"/* OnlineState.Unknown */),t.F_.delete(4/* OfflineCause.ConnectivityChange */),await hD(t)}(this))})}),this.O_=new hk(n,i)}}async function hD(t){if(hR(t))for(let e of t.M_)await e(/* enabled= */!0)}/**
 * Temporarily disables the network. The network can be re-enabled using
 * enableNetwork().
 */async function hO(t){for(let e of t.M_)await e(/* enabled= */!1)}function hR(t){return 0===t.F_.size}/**
 ...
 * any retry attempt.
 */async function hL(t,e,n){if(!ur(e))throw e;t.F_.add(1/* OfflineCause.IndexedDbFailed */),await hO(t),t.O_.set("Offline"/* OnlineState.Offline */),n||// Use a simple read operation to determine if IndexedDB recovered.
// Ideally, we would expose a health check directly on SimpleDb, but
// RemoteStore only has access to persistence through LocalStore.
(n=()=>{var e;return(e=t.localStore).persistence.runTransaction("Get last remote snapshot version","readonly",t=>e.Kr.getLastRemoteSnapshotVersion(t))}),t.asyncQueue.enqueueRetryable(async()=>{lF("RemoteStore","Retrying IndexedDB access"),await n(),t.F_.delete(1/* OfflineCause.IndexedDbFailed */),await hD(t)})}/**
 * Executes `op`. If `op` fails, takes the network offline until `op`
 * succeeds. Returns after the first attempt.
 */function hP(t,e){return e().catch(n=>hL(t,n,e))}async function hM(t){let e=hH(t),n=t.C_.length>0?t.C_[t.C_.length-1].batchId:-1;for(;hR(t)&&t.C_.length<10;)try{let i=await /**
 ...
 */function(t,e){t.C_.push(e);let n=hH(t);n.Yo()&&n.I_&&n.d_(e.mutations)}(t,i)}catch(e){await hL(t,e)}hB(t)&&hF(t)}function hB(t){return hR(t)&&!hH(t).Jo()&&t.C_.length>0}function hF(t){hH(t).start()}async function hU(t){hH(t).A_()}async function hj(t){let e=hH(t);// Send the write pipeline now that the stream is established.
for(let n of t.C_)e.d_(n.mutations)}async function hV(t,e,n){let i=t.C_.shift(),r=cz.from(i,e,n);await hP(t,()=>t.remoteSyncer.applySuccessfulWrite(r)),// slot has freed up.
await hM(t)}async function h$(t,e){// If the write stream closed after the write handshake completes, a write
// operation failed and we fail the pending operation.
e&&hH(t).I_&&// This error affects the actual write.
...
// restart.
hH(t).Xo(),await hP(t,()=>t.remoteSyncer.rejectFailedWrite(n.batchId,e)),// another slot has freed up.
await hM(t)}}(t,e),// pipeline for failed writes
hB(t)&&hF(t)}async function hz(t,e){t.asyncQueue.verifyOperationInProgress(),lF("RemoteStore","RemoteStore received new credentials");let n=hR(t);// Tear down and re-create our network streams. This will ensure we get a
// fresh auth token for the new user and re-fill the write pipeline with
// new mutations from the LocalStore (since mutations are per-user).
t.F_.add(3/* OfflineCause.CredentialChange */),await hO(t),n&&// Don't set the network status to Unknown if we are offline.
t.O_.set("Unknown"/* OnlineState.Unknown */),await t.remoteSyncer.handleCredentialChange(e),t.F_.delete(3/* OfflineCause.CredentialChange */),await hD(t)}/**
 * Toggles the network state when the client gains or loses its primary lease.
 */async function hq(t,e){e?(t.F_.delete(2/* OfflineCause.IsSecondary */),await hD(t)):e||(t.F_.add(2/* OfflineCause.IsSecondary */),await hO(t),t.O_.set("Unknown"/* OnlineState.Unknown */))}/**
 ...
 */function hH(t){var e,n,i;return t.L_||// Create stream (but note that it is not started yet).
(t.L_=(e=t.datastore,n=t.asyncQueue,i={Io:hU.bind(null,t),Eo:h$.bind(null,t),E_:hj.bind(null,t),T_:hV.bind(null,t)},e.V_(),new hC(n,e.connection,e.authCredentials,e.appCheckCredentials,e.serializer,i)),t.M_.push(async e=>{e?(t.L_.Xo(),await hM(t)):(await t.L_.stop(),t.C_.length>0&&(lF("RemoteStore",`Stopping write stream with ${t.C_.length} pending writes`),t.C_=[]))})),t.L_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * IE.
 */class hK{constructor(t,e,n,i,r){this.asyncQueue=t,this.timerId=e,this.targetTimeMs=n,this.op=i,this.removalCallback=r,this.deferred=new lH,this.then=this.deferred.promise.then.bind(this.deferred.promise),// and so we attach a dummy catch callback to avoid
...
this.deferred.promise.catch(t=>{})}get promise(){return this.deferred.promise}/**
     ...
     */static createAndSchedule(t,e,n,i,r){let s=Date.now()+n,o=new hK(t,e,s,i,r);return o.start(n),o}/**
 ...
 */function hG(t,e){if(lU("AsyncQueue",`${e}: ${t}`),ur(t))return new lq(lz.UNAVAILABLE,`${e}: ${t}`);throw t}class hW{constructor(){this.queries=new co(t=>ci(t),cn),this.onlineState="Unknown"/* OnlineState.Unknown */,this.K_=new Set}}/**
 ...
 * This is useful to implement optional features (like bundles) in free
 * functions, such that they are tree-shakeable.
 */class hQ{constructor(t,e,n,i,r,s){this.localStore=t,this.remoteStore=e,this.eventManager=n,this.sharedClientState=i,this.currentUser=r,this.maxConcurrentLimboResolutions=s,this.fa={},this.ga=new co(t=>ci(t),cn),this.pa=new Map,/**
         ...
         * active target.
         */this.wa=new uc(l7.comparator),/**
         * Keeps track of the information about an active limbo resolution for each
         * active target ID that was started for the purpose of limbo resolution.
         */this.Sa=new Map,this.ba=new c7,/** Stores user completion handlers, indexed by User and BatchId. */this.Da={},/** Stores user callbacks waiting for all pending writes to be acknowledged. */this.Ca=new Map,this.va=c9.Ln(),this.onlineState="Unknown"/* OnlineState.Unknown */,// startup. In the interim, a client should only be considered primary if
// `isPrimary` is true.
 ...
 */async function hX(t,e,n){var i;let r=(t.remoteStore.remoteSyncer.applySuccessfulWrite=hJ.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=hZ.bind(null,t),t);try{let t;let s=await function(t,e){let n,i;let r=l9.now(),s=e.reduce((t,e)=>t.add(e.key),cp());return t.persistence.runTransaction("Locally write mutations","readwrite",o=>{// Figure out which keys do not have a remote version in the cache, this
// is needed to create the right overlay mutation: if no remote version
// presents, we do not need to create overlays as patch mutations.
// TODO(Overlay): Is there a better way to determine this? Using the
//  document version does not work because local mutations set them back
//  to 0.
let a=ca,l=cp();return t._s.getEntries(o,s).next(t=>{(a=t).forEach((t,e)=>{e.isValidDocument()||(l=l.add(t))})}).next(()=>t.localDocuments.getOverlayedDocuments(o,a)).next(i=>{n=i;// For non-idempotent mutations (such as `FieldValue.increment()`),
 ...
 */function(t,e){let n=null;for(let i of t.fieldTransforms){let t=e.data.field(i.field),r=cw(i.transform,t||null);null!=r&&(null===n&&(n=uF.empty()),n.set(i.field,r))}return n||null}(t,n.get(t.key).overlayedDocument);null!=e&&// NOTE: The base state should only be applied if there's some
// existing document to override, so use a Precondition of
// exists=true
s.push(new cM(t.key,e,/**
...
n.push(r)}),new ug(n)}(e.value.mapValue),ck.exists(!0)))}return t.mutationQueue.addMutationBatch(o,r,s,e)}).next(e=>{i=e;let r=e.applyToLocalDocumentSet(n,l);return t.documentOverlayCache.saveOverlays(o,e.batchId,r)})}).then(()=>({batchId:i.batchId,changes:cc(n)}))}(r.localStore,e);r.sharedClientState.addPendingMutation(s.batchId),i=s.batchId,(t=r.Da[r.currentUser.toKey()])||(t=new uc(l1)),t=t.insert(i,n),r.Da[r.currentUser.toKey()]=t,await h2(r,s.changes),await hM(r.remoteStore)}catch(e){// If we can't persist the mutation, we reject the user callback and
// don't send the mutation. The user can then retry the write.
let t=hG(e,"Failed to persist write");n.reject(t)}}/**
 * Applies an OnlineState change to the sync engine and notifies any views of
 * the change.
 */function hY(t,e,n){var i;// If we are the secondary client, we explicitly ignore the remote store's
...
h1(t,i,/*error=*/null),h0(t,i),t.sharedClientState.updateMutationState(i,"acknowledged"),await h2(t,r)}catch(t){await un(t)}}async function hZ(t,e,n){var i;try{let r=await (i=t.localStore).persistence.runTransaction("Reject batch","readwrite-primary",t=>{let n;return i.mutationQueue.lookupMutationBatch(t,e).next(e=>(null!==e||l$(),n=e.keys(),i.mutationQueue.removeMutationBatch(t,e))).next(()=>i.mutationQueue.performConsistencyCheck(t)).next(()=>i.documentOverlayCache.removeOverlaysForBatchId(t,n,e)).next(()=>i.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(t,n)).next(()=>i.localDocuments.getDocuments(t,n))});// The local store may or may not be able to apply the write result and
// raise events immediately (depending on whether the watcher is caught up),
// so we raise user callbacks first so that they consistently happen before
// listen events.
h1(t,e,n),h0(t,e),t.sharedClientState.updateMutationState(e,"rejected",n),await h2(t,r)}catch(t){await un(t)}}/**
 * Triggers the callbacks that are waiting for this batch id to get acknowledged by server,
 * if there are any.
 */function h0(t,e){(t.Ca.get(e)||[]).forEach(t=>{t.resolve()}),t.Ca.delete(e)}/** Reject all outstanding callbacks waiting for pending writes to complete. */function h1(t,e,n){let i=t.Da[t.currentUser.toKey()];// NOTE: Mutations restored from persistence won't have callbacks, so it's
// okay for there to be no callback for this ID.
if(i){let r=i.get(e);r&&(n?r.reject(n):r.resolve(),i=i.remove(e)),t.Da[t.currentUser.toKey()]=i}}async function h2(t,e,n){let i=[],r=[],s=[];t.ga.isEmpty()||(t.ga.forEach((o,a)=>{s.push(t.Ma(a,e,n).then(e=>{// Update views if there are actual changes.
if(// secondary clients to update query state.
(e||n)&&t.isPrimaryClient&&t.sharedClientState.updateQueryState(a.targetId,(null==e?void 0:e.fromCache)?"not-current":"current"),e){i.push(e);let t=hl.$i(a.targetId,e);r.push(t)}}))}),await Promise.all(s),t.fa.c_(i),await async function(t,e){try{await t.persistence.runTransaction("notifyLocalViewChanges","readwrite",n=>ui.forEach(e,e=>ui.forEach(e.Qi,i=>t.persistence.referenceDelegate.addReference(n,e.targetId,i)).next(()=>ui.forEach(e.Ki,i=>t.persistence.referenceDelegate.removeReference(n,e.targetId,i)))))}catch(t){if(!ur(t))throw t;// If `notifyLocalViewChanges` fails, we did not advance the sequence
...
t.rs=t.rs.insert(e,r)}}}(t.localStore,r))}async function h9(t,e){if(!t.currentUser.isEqual(e)){lF("SyncEngine","User change. New user:",e.toKey());let n=await hf(t.localStore,e);t.currentUser=e,t.Ca.forEach(t=>{t.forEach(t=>{t.reject(new lq(lz.CANCELLED,"'waitForPendingWrites' promise is rejected due to a user change."))})}),t.Ca.clear(),t.sharedClientState.handleUserChange(e,n.removedBatchIds,n.addedBatchIds),await h2(t,n.cs)}}class h4{constructor(){this.synchronizeTabs=!1}async initialize(t){this.serializer=hS(t.databaseInfo.databaseId),this.sharedClientState=this.createSharedClientState(t),this.persistence=this.createPersistence(t),await this.persistence.start(),this.localStore=this.createLocalStore(t),this.gcScheduler=this.createGarbageCollectionScheduler(t,this.localStore),this.indexBackfillerScheduler=this.createIndexBackfillerScheduler(t,this.localStore)}createGarbageCollectionScheduler(t,e){return null}createIndexBackfillerScheduler(t,e){return null}createLocalStore(t){var /** Manages our in-memory or durable persistence. */e,n,i,r;return e=this.persistence,n=new hc,i=t.initialUser,r=this.serializer,new hh(e,n,i,r)}createPersistence(t){return new hs(ha.Jr,this.serializer)}createSharedClientState(t){return new hp}async terminate(){this.gcScheduler&&this.gcScheduler.stop(),await this.sharedClientState.shutdown(),await this.persistence.shutdown()}}/**
 * Initializes and wires the components that are needed to interface with the
 * network.
 */class h5{async initialize(t,e){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(e),this.remoteStore=this.createRemoteStore(e),this.eventManager=this.createEventManager(e),this.syncEngine=this.createSyncEngine(e,/* startAsPrimary=*/!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=t=>hY(this.syncEngine,t,1/* OnlineStateSource.SharedClientState */),this.remoteStore.remoteSyncer.handleCredentialChange=h9.bind(null,this.syncEngine),await hq(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return new hW}createDatastore(t){var e,n,i;let r=hS(t.databaseInfo.databaseId),s=(e=t.databaseInfo,new hT(e));return n=t.authCredentials,i=t.appCheckCredentials,new h_(n,i,s,r)}createRemoteStore(t){var e,n,i,r;return e=this.localStore,n=this.datastore,i=t.asyncQueue,r=hm.C()?new hm:new hg,new hN(e,n,i,t=>hY(this.syncEngine,t,0/* OnlineStateSource.RemoteStore */),r)}createSyncEngine(t,e){return function(t,e,n,i,r,s,o){let a=new hQ(t,e,n,i,r,s);return o&&(a.Fa=!0),a}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,e)}terminate(){return async function(t){lF("RemoteStore","RemoteStore shutting down."),t.F_.add(5/* OfflineCause.Shutdown */),await hO(t),t.x_.shutdown(),// triggering spurious listener events with cached data, etc.
...
// tokens.
this.authCredentials.shutdown(),this.appCheckCredentials.shutdown(),t.resolve()}catch(n){let e=hG(n,"Failed to shutdown persistence");t.reject(e)}}),t.promise}}async function h3(t,e){t.asyncQueue.verifyOperationInProgress(),lF("FirestoreClient","Initializing OfflineComponentProvider");let n=await t.getConfiguration();await e.initialize(n);let i=n.initialUser;t.setCredentialChangeListener(async t=>{i.isEqual(t)||(await hf(e.localStore,t),i=t)}),// need to be terminated to allow the delete to succeed.
e.persistence.setDatabaseDeletedListener(()=>t.terminate()),t._offlineComponents=e}async function h8(t,e){t.asyncQueue.verifyOperationInProgress();let n=await h7(t);lF("FirestoreClient","Initializing OnlineComponentProvider");let i=await t.getConfiguration();await e.initialize(n,i),// precedence over the offline component provider.
t.setCredentialChangeListener(t=>hz(e.remoteStore,t)),t.setAppCheckTokenChangeListener((t,n)=>hz(e.remoteStore,n)),t._onlineComponents=e}async function h7(t){if(!t._offlineComponents){if(t._uninitializedComponentsProvider){lF("FirestoreClient","Using user provided OfflineComponentProvider");try{await h3(t,t._uninitializedComponentsProvider._offline)}catch(e){if(!("FirebaseError"===e.name?e.code===lz.FAILED_PRECONDITION||e.code===lz.UNIMPLEMENTED:!("undefined"!=typeof DOMException&&e instanceof DOMException)||// When the browser is out of quota we could get either quota exceeded
// or an aborted error depending on whether the error happened during
// schema migration.
22===e.code||20===e.code||// Firefox Private Browsing mode disables IndexedDb and returns
// INVALID_STATE for any usage.
11===e.code))throw e;lj("Error using user provided cache. Falling back to memory cache: "+e),await h3(t,new h4)}}else lF("FirestoreClient","Using default OfflineComponentProvider"),await h3(t,new h4)}return t._offlineComponents}async function ft(t){return t._onlineComponents||(t._uninitializedComponentsProvider?(lF("FirestoreClient","Using user provided OnlineComponentProvider"),await h8(t,t._uninitializedComponentsProvider._online)):(lF("FirestoreClient","Using default OnlineComponentProvider"),await h8(t,new h5))),t._onlineComponents}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class fc{// This is the lite version of the Query class in the main SDK.
/** @hideconstructor protected */constructor(t,/**
     * If provided, the `FirestoreDataConverter` associated with this instance.
     */e,n){this.converter=e,this._query=n,/** The type of this Firestore reference. */this.type="query",this.firestore=t}withConverter(t){return new fc(this.firestore,t,this._query)}}/**
 * A `DocumentReference` refers to a document location in a Firestore database
 * and can be used to write, read, or listen to the location. The document at
 * the referenced location may or may not exist.
 */class fh{/** @hideconstructor */constructor(t,/**
     * If provided, the `FirestoreDataConverter` associated with this instance.
     ...
     */get parent(){return new ff(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new fh(this.firestore,t,this._key)}}/**
 * A `CollectionReference` object can be used for adding documents, getting
 * document references, and querying for documents (using {@link (query:1)}).
 */class ff extends fc{/** @hideconstructor */constructor(t,e,n){super(t,e,new u3(n)),this._path=n,/** The type of this Firestore reference. */this.type="collection"}/** The collection's identifier. */get id(){return this._query.path.lastSegment()}/**
     * A string representing the path of the referenced collection (relative
     * to the root of the database).
     */get path(){return this._query.path.canonicalString()}/**
     * A reference to the containing `DocumentReference` if this is a
     * subcollection. If this isn't a subcollection, the reference is null.
     */get parent(){let t=this._path.popLast();return t.isEmpty()?null:new fh(this.firestore,/* converter= */null,new l7(t))}withConverter(t){return new ff(this.firestore,t,this._path)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
this.ru=!1,this.iu=!1,this.su=[],this.Ho=new hA(this,"async_queue_retry"/* TimerId.AsyncQueueRetry */),// operations. Meant to speed up recovery when we regain file system access
// after page comes into foreground.
this.ou=()=>{let t=hI();t&&lF("AsyncQueue","Visibility state changed to "+t.visibilityState),this.Ho.$o()};let t=hI();t&&"function"==typeof t.addEventListener&&t.addEventListener("visibilitychange",this.ou)}get isShuttingDown(){return this.eu}/**
     * Adds a new operation to the queue without waiting for it to complete (i.e.
     * we ignore the Promise result).
     */enqueueAndForget(t){// eslint-disable-next-line @typescript-eslint/no-floating-promises
this.enqueue(t)}enqueueAndForgetEvenWhileRestricted(t){this._u(),this.au(t)}enterRestrictedMode(t){if(!this.eu){this.eu=!0,this.iu=t||!1;let e=hI();e&&"function"==typeof e.removeEventListener&&e.removeEventListener("visibilitychange",this.ou)}}enqueue(t){if(this._u(),this.eu)return new Promise(()=>{});// Create a deferred Promise that we can return to the callee. This
...
this.Ho.Qo(()=>this.uu())}}au(t){let e=this.Za.then(()=>(this.ru=!0,t().catch(t=>{let e;this.nu=t,this.ru=!1;let n=(e=t.message||"",t.stack&&(e=t.stack.includes(t.message)?t.stack:t.message+"\n"+t.stack),e);// Re-throw the error so that this.tail becomes a rejected Promise and
    ...
    throw lU("INTERNAL UNHANDLED ERROR: ",n),t}).then(t=>(this.ru=!1,t))));return this.Za=e,e}enqueueAfterDelay(t,e,n){this._u(),this.su.indexOf(t)>-1&&(e=0);let i=hK.createAndSchedule(this,t,e,n,t=>this.cu(t));return this.tu.push(i),i}_u(){this.nu&&l$()}verifyOperationInProgress(){}/**
...
fg(this),this._firestoreClient.terminate()}}function fg(t){var e,n,i,r,s,o;let a=t._freezeSettings(),l=(r=t._databaseId,s=(null===(e=t._app)||void 0===e?void 0:e.options.appId)||"",o=t._persistenceKey,new uS(r,s,o,a.host,a.ssl,a.experimentalForceLongPolling,a.experimentalAutoDetectLongPolling,fe(a.experimentalLongPollingOptions),a.useFetchStreams));t._firestoreClient=new h6(t._authCredentials,t._appCheckCredentials,t._queue,l),(null===(n=a.localCache)||void 0===n?void 0:n._offlineComponentProvider)&&(null===(i=a.localCache)||void 0===i?void 0:i._onlineComponentProvider)&&(t._firestoreClient._uninitializedComponentsProvider={_offlineKind:a.localCache.kind,_offline:a.localCache._offlineComponentProvider,_online:a.localCache._onlineComponentProvider})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fb=/^__.*__$/;/** The result of parsing document data (e.g. for a setData call). */class fE{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return null!==this.fieldMask?new cM(t,this.data,this.fieldMask,e,this.fieldTransforms):new cP(t,this.data,e,this.fieldTransforms)}}function fT(t){switch(t){case 0/* UserDataSource.Set */:// fall through
...
let n=ix(t,rO);if(n.isInitialized()){let t=n.getImmediate();if(nJ(e,n.getOptions()))return t;throw rP.create("already-initialized"/* AnalyticsError.ALREADY_INITIALIZED */)}let i=n.initialize({options:e});return i}(t)}(fk),fD=function(t,e){let n="object"==typeof t?t:iN(),i=ix(n,"firestore").getImmediate({identifier:"string"==typeof t?t:"(default)"});if(!i._initialized){let t=nq("firestore");t&&/**
...
// sentinel.
(t={nullValue:"NULL_VALUE"}),i.push(t),r++}return{arrayValue:{values:i}}}(n,i)}return function(t,e){var n,i,r,s,o;if(null===(t=n1(t)))return{nullValue:"NULL_VALUE"};if("number"==typeof t)return n=e.serializer,"number"==typeof(r=i=t)&&Number.isInteger(r)&&!uo(r)&&r<=Number.MAX_SAFE_INTEGER&&r>=Number.MIN_SAFE_INTEGER?cy(i):cm(n,i);if("boolean"==typeof t)return{booleanValue:t};if("string"==typeof t)return{stringValue:t};if(t instanceof Date){let n=l9.fromDate(t);return{timestampValue:cK(e.serializer,n)}}if(t instanceof l9){// Firestore backend truncates precision down to microseconds. To ensure
// offline mode works the same with regards to truncation, perform the
// truncation immediately without waiting for the backend to do that.
let n=new l9(t.seconds,1e3*Math.floor(t.nanoseconds/1e3));return{timestampValue:cK(e.serializer,n)}}if(t instanceof fw)return{geoPointValue:{latitude:t.latitude,longitude:t.longitude}};if(t instanceof fm)return{bytesValue:(s=e.serializer,o=t._byteString,s.useProto3Json?o.toBase64():o.toUint8Array())};if(t instanceof fh){let n=e.databaseId,i=t.firestore._databaseId;if(!i.isEqual(n))throw e.gu(`Document reference is for database ${i.projectId}/${i.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:cW(t.firestore._databaseId||e.databaseId,t._key.path)}}throw e.gu(`Unsupported field value: ${fo(t)}`)}(n,i)}(r,n.Au(e));null!=s&&(i[e]=s)}),{mapValue:{fields:i}}}(i,l);if(s.merge)o=new ug(l.fieldMask),a=l.fieldTransforms;else if(s.mergeFields){let t=[];for(let i of s.mergeFields){let r=/**
...
var fO=document.querySelector(".auth-button-in"),fR=document.querySelector(".auth-input");fO.addEventListener("click",function(){fR&&fR.remove()}),w("dGLOO");//# sourceMappingURL=index.4a510848.js.map

//# sourceMappingURL=index.4a510848.js.map
