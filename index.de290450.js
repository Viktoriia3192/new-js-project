...
if(e.showOnlyTheLastOne&&f>0)for(var W=t.document.querySelectorAll("[id^="+e.ID+"-]:not([id="+e.ID+"-"+f+"])"),L=0;L<W.length;L++){var S=W[L];null!==S.parentNode&&S.parentNode.removeChild(S)}// notify - show only the last one: end
...
//     }
// });
a("dGLOO");//# sourceMappingURL=index.de290450.js.map

//# sourceMappingURL=index.de290450.js.map
