...
info:function(t,e,i){c(n.Info,t,e,i)}}};return"object"==typeof t.Notiflix?a(!0,t.Notiflix,{Notify:f.Notify}):{Notify:f.Notify}},"function"==typeof define&&define.amd?define([],function(){return r3(r6)}):"object"==typeof E?E=r3(r6):r6.Notiflix=r3(r6);// utils is a library of generic helper functions non-specific to axios
...
ts["-".charCodeAt(0)]=62,ts["_".charCodeAt(0)]=63,sn=function(t,e,n,i,r){var s,o,a=8*r-i-1,l=(1<<a)-1,u=l>>1,h=-7,c=n?r-1:0,f=n?-1:1,d=t[e+c];for(c+=f,s=d&(1<<-h)-1,d>>=-h,h+=a;h>0;s=256*s+t[e+c],c+=f,h-=8);for(o=s&(1<<-h)-1,s>>=-h,h+=i;h>0;o=256*o+t[e+c],c+=f,h-=8);if(0===s)s=1-u;else{if(s===l)return o?NaN:(d?-1:1)*(1/0);o+=Math.pow(2,i),s-=u}return(d?-1:1)*o*Math.pow(2,s-i)},si=function(t,e,n,i,r,s){var o,a,l,u=8*s-r-1,h=(1<<u)-1,c=h>>1,f=23===r?5960464477539062e-23:0,d=i?0:s-1,p=i?1:-1,g=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(a=isNaN(e)?1:0,o=h):(o=Math.floor(Math.log(e)/Math.LN2),e*(l=Math.pow(2,-o))<1&&(o--,l*=2),o+c>=1?e+=f/l:e+=f*Math.pow(2,1-c),e*l>=2&&(o++,l/=2),o+c>=h?(a=0,o=h):o+c>=1?(a=(e*l-1)*Math.pow(2,r),o+=c):(a=e*Math.pow(2,c-1)*Math.pow(2,r),o=0));r>=8;t[n+d]=255&a,d+=p,a/=256,r-=8);for(o=o<<r|a,u+=r;u>0;t[n+d]=255&o,d+=p,o/=256,u-=8);t[n+d-p]|=128*g};let th="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
let nE="bookArr";ng.addEventListener("click",function(t){!function(t){let e=JSON.parse(localStorage.getItem(nE))??[];if(0===e.length)e.push(t);else if(e.length>0){let n=t.id;JSON.parse(localStorage.getItem(nE));let i=e.findIndex(({id:t})=>t===n);-1===i&&(e.push(t),console.log(e))}localStorage.setItem(nE,JSON.stringify(e))}//!--------------------------------
(nv)});/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let nL=function(t){// TODO(user): Use native implementations if/when available
 ...
 */let nF=function(t){let e=nL(t);return nM.encodeByteArray(e,!0)},nU=function(t){// Use base64url encoding and remove padding in the end (dot characters).
 ...
 */let n8=[];(st=sa||(sa={}))[st.DEBUG=0]="DEBUG",st[st.VERBOSE=1]="VERBOSE",st[st.INFO=2]="INFO",st[st.WARN=3]="WARN",st[st.ERROR=4]="ERROR",st[st.SILENT=5]="SILENT";let n7={debug:sa.DEBUG,verbose:sa.VERBOSE,info:sa.INFO,warn:sa.WARN,error:sa.ERROR,silent:sa.SILENT},it=sa.INFO,ie={[sa.DEBUG]:"log",[sa.VERBOSE]:"log",[sa.INFO]:"info",[sa.WARN]:"warn",[sa.ERROR]:"error"},ii=(t,e,...n)=>{if(e<t.logLevel)return;let i=new Date().toISOString(),r=ie[e];if(r)console[r](`[${i}]  ${t.name}:`,...n);else throw Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class ir{/**
...
setLogLevel(t){this._logLevel="string"==typeof t?n7[t]:t}get logHandler(){return this._logHandler}set logHandler(t){if("function"!=typeof t)throw TypeError("Value assigned to `logHandler` must be a function");this._logHandler=t}get userLogHandler(){return this._userLogHandler}set userLogHandler(t){this._userLogHandler=t}/**
     ...
     */debug(...t){this._userLogHandler&&this._userLogHandler(this,sa.DEBUG,...t),this._logHandler(this,sa.DEBUG,...t)}log(...t){this._userLogHandler&&this._userLogHandler(this,sa.VERBOSE,...t),this._logHandler(this,sa.VERBOSE,...t)}info(...t){this._userLogHandler&&this._userLogHandler(this,sa.INFO,...t),this._logHandler(this,sa.INFO,...t)}warn(...t){this._userLogHandler&&this._userLogHandler(this,sa.WARN,...t),this._logHandler(this,sa.WARN,...t)}error(...t){this._userLogHandler&&this._userLogHandler(this,sa.ERROR,...t),this._logHandler(this,sa.ERROR,...t)}}let is=(t,e)=>e.some(e=>t instanceof e),io=new WeakMap,ia=new WeakMap,il=new WeakMap,iu=new WeakMap,ih=new WeakMap,ic={get(t,e,n){if(t instanceof IDBTransaction){// Special handling for transaction.done.
...
ia.set(t,e)}(i),is(i,t||(t=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])))?new Proxy(i,ic):i;return r!==n&&(iu.set(n,r),ih.set(r,n)),r}let ip=t=>ih.get(t),ig=["get","getKey","getAll","getAllKeys","count"],im=["put","add","delete","clear"],iy=new Map;function iv(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&"string"==typeof e))return;if(iy.get(e))return iy.get(e);let n=e.replace(/FromIndex$/,""),i=e!==n,r=im.includes(n);if(!(n in(i?IDBIndex:IDBObjectStore).prototype)||!(r||ig.includes(n)))return;let s=async function(t,...e){// isWrite ? 'readwrite' : undefined gzipps better, but fails in Edge :(
let s=this.transaction(t,r?"readwrite":"readonly"),o=s.store;// Must reject if op rejects.
// If it's a write operation, must reject if tx.done rejects.
// Must reject with op rejection first.
// Must resolve with op value.
// Must handle both promises (no unhandled rejections)
return i&&(o=o.index(e.shift())),(await Promise.all([o[n](...e),r&&s.done]))[0]};return iy.set(e,s),s}ic={...r4=ic,get:(t,e,n)=>iv(t,e)||r4.get(t,e,n),has:(t,e)=>!!iv(t,e)||r4.has(t,e)};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * provider.
 */function(t){let e=t.getComponent();return(null==e?void 0:e.type)==="VERSION"/* ComponentType.VERSION */}(t))return null;{let e=t.getImmediate();return`${e.library}/${e.version}`}}).filter(t=>t).join(" ")}}let ib="@firebase/app",iE="0.9.18",iT=new ir("@firebase/app"),iI="[DEFAULT]",iS={[ib]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},iA=new Map,ix=new Map;/**
 *
 ...
 *
 * @internal
 */function i_(t,e){let n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}let ik=new nY("app","Firebase",{"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."});/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
iR("fire-js",""),iR("firebase","10.3.1","app");let iq=(t,e)=>e.some(e=>t instanceof e),iH=new WeakMap,iK=new WeakMap,iG=new WeakMap,iW=new WeakMap,iQ=new WeakMap,iX={get(t,e,n){if(t instanceof IDBTransaction){// Special handling for transaction.done.
...
iK.set(t,e)}(e),iq(e,n||(n=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])))?new Proxy(e,iX):e;return r!==t&&(iW.set(t,r),iQ.set(r,t)),r}let iY=t=>iQ.get(t),iZ=["get","getKey","getAll","getAllKeys","count"],i0=["put","add","delete","clear"],i1=new Map;function i2(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&"string"==typeof e))return;if(i1.get(e))return i1.get(e);let n=e.replace(/FromIndex$/,""),i=e!==n,r=i0.includes(n);if(!(n in(i?IDBIndex:IDBObjectStore).prototype)||!(r||iZ.includes(n)))return;let s=async function(t,...e){// isWrite ? 'readwrite' : undefined gzipps better, but fails in Edge :(
let s=this.transaction(t,r?"readwrite":"readonly"),o=s.store;// Must reject if op rejects.
// If it's a write operation, must reject if tx.done rejects.
// Must reject with op rejection first.
// Must resolve with op value.
// Must handle both promises (no unhandled rejections)
return i&&(o=o.index(e.shift())),(await Promise.all([o[n](...e),r&&s.done]))[0]};return i1.set(e,s),s}iX={...r5=iX,get:(t,e,n)=>i2(t,e)||r5.get(t,e,n),has:(t,e)=>!!i2(t,e)||r5.has(t,e)};let i9="@firebase/installations",i4="0.6.4",i5=`w:${i4}`,i6="FIS_v2",i3=new nY("installations","Installations",{"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."});/** Returns true if error is a FirebaseError that is based on an error from the server. */function i8(t){return t instanceof nJ&&t.code.includes("request-failed"/* ErrorCode.REQUEST_FAILED */)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function ru(t,e){let n=ra(t);rh(n,e),function(t,e){let n=(!rc&&"BroadcastChannel"in self&&((rc=new BroadcastChannel("[Firebase] FID Change")).onmessage=t=>{rh(t.data.key,t.data.fid)}),rc);n&&n.postMessage({key:t,fid:e}),0===rl.size&&rc&&(rc.close(),rc=null)}(n,e)}function rh(t,e){let n=rl.get(t);if(n)for(let t of n)t(e)}let rc=null,rf="firebase-installations-store",rd=null;function rp(){return rd||(rd=/**
 * Open a database.
 *
 * @param name Name of the database.
 * @param version Schema version.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let rR="installations";iC(new n4(rR,t=>{let e=t.getProvider("app").getImmediate(),n=/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
t("event"/* GtagCommand.EVENT */,i,r||{})}catch(t){rM.error(t)}}let r$=new /**
 ...
 */async function rQ(t,e,n,i,o,a,l){var u;let h=rq(t);// Once fetched, map measurementIds to appId, for ease of lookup in wrapped gtag function.
h.then(e=>{n[e.measurementId]=e.appId,t.options.measurementId&&e.measurementId!==t.options.measurementId&&rM.warn(`The measurement ID in the local Firebase config (${t.options.measurementId}) does not match the measurement ID fetched from the server (${e.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(t=>rM.error(t)),// Add to list to track state of all dynamic config promises.
e.push(h);let c=rW().then(t=>t?i.getId():void 0),[f,d]=await Promise.all([h,c]);!/**
 ...
 */let rJ={},rY=[],rZ={},r0="dataLayer",r1=!1,r2="@firebase/analytics",r9="0.10.0";iC(new n4(rL,(t,{options:e})=>{// getImmediate for FirebaseApp will always succeed
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let lB="10.3.1",lF=new ir("@firebase/firestore");// Helper methods are needed because variables can't be exported as read/write
...
e.push(...n.split("/").filter(t=>t.length>0))}return new l8(e)}static emptyPath(){return new l8([])}}let l7=/^[_a-zA-Z][_a-zA-Z0-9]*$/;/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uu(t){let e=0;for(let n in t)Object.prototype.hasOwnProperty.call(t,n)&&e++;return e}function uh(t,e){for(let n in t)Object.prototype.hasOwnProperty.call(t,n)&&e(n,t[n])}function uc(t){for(let e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}ua.ae=-1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
let t=this.getFieldsMap(e);this.applyChanges(t,n,i),n={},i=[],e=r.popLast()}t?n[r.lastSegment()]=uF(t):i.push(r.lastSegment())});let r=this.getFieldsMap(e);this.applyChanges(r,n,i)}/**
     ...
     * entries.
     */applyChanges(t,e,n){for(let i of(uh(e,(e,n)=>t[e]=n),n))delete t[i]}clone(){return new uj(uF(this.value))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function ht(t){return 0===t.filters.length&&null===t.limit&&null==t.startAt&&null==t.endAt&&(0===t.explicitOrderBy.length||1===t.explicitOrderBy.length&&t.explicitOrderBy[0].field.isKeyField())}/**
 * Returns the normalized order-by constraint that is used to execute the Query,
 * which can be different from the order-by constraints the user provided (e.g.
 * the SDK and backend always orders by `__name__`). The normalized order-by
 * includes implicit order-bys in addition to the explicit user provided
 * order-bys.
 */function he(t){if(null===t.Pe){t.Pe=[];let e=function(t){for(let e of t.filters){let t=e.getFirstInequalityField();if(null!==t)return t}return null}(t),n=t.explicitOrderBy.length>0?t.explicitOrderBy[0].field:null;if(null!==e&&null===n)// inequality filter field for it to be a valid query.
 ...
 */function hn(t){return t.Ie||(t.Ie=/**
 * Converts this `Query` instance to its corresponding `Target` representation,
...
return u6(t.path,t.collectionGroup,e,t.filters,t.limit,n,i)}}(t,he(t))),t.Ie}function hi(t,e,n){return new u7(t.path,t.collectionGroup,t.explicitOrderBy.slice(),t.filters.slice(),e,n,t.startAt,t.endAt)}function hr(t,e){return u8(hn(t),hn(e))&&t.limitType===e.limitType}// TODO(b/29183165): This is used to get a unique string from a query to, for
// example, use as a dictionary key, but the implementation is subject to
// collisions. Make it collision-free.
function hs(t){return`${u3(hn(t))}|lt:${t.limitType}`}function ho(t){var e;let n;return`Query(target=${n=(e=hn(t)).path.canonicalString(),null!==e.collectionGroup&&(n+=" collectionGroup="+e.collectionGroup),e.filters.length>0&&(n+=`, filters: [${e.filters.map(t=>/** Returns a debug description for `filter`. */(function t(e){return e instanceof uG?`${e.field.canonicalString()} ${e.op} ${uL(e.value)}`:e instanceof uW?e.op.toString()+" {"+e.getFilters().map(t).join(" ,")+"}":"Filter"})(t)).join(", ")}]`),null==e.limit||(n+=", limit: "+e.limit),e.orderBy.length>0&&(n+=`, orderBy: [${e.orderBy.map(t=>`${t.field.canonicalString()} (${t.dir})`).join(", ")}]`),e.startAt&&(n+=", startAt: "+(e.startAt.inclusive?"b:":"a:")+e.startAt.position.map(t=>uL(t)).join(",")),e.endAt&&(n+=", endAt: "+(e.endAt.inclusive?"a:":"b:")+e.endAt.position.map(t=>uL(t)).join(",")),`Target(${n})`}; limitType=${t.limitType})`}/** Returns whether `doc` matches the constraints of `query`. */function ha(t,e){return e.isFoundDocument()&&function(t,e){let n=e.key.path;return null!==t.collectionGroup?e.key.hasCollectionId(t.collectionGroup)&&t.path.isPrefixOf(n):ue.isDocumentKey(t.path)?t.path.isEqual(n):t.path.isImmediateParentOf(n)}(t,e)&&function(t,e){// We must use `queryNormalizedOrderBy()` to get the list of all orderBys (both implicit and explicit).
// Note that for OR queries, orderBy applies to all disjunction terms and implicit orderBys must
// be taken into account. For example, the query "a > 1 || b==1" has an implicit "orderBy a" due
// to the inequality, and is evaluated as "a > 1 orderBy a || b==1 orderBy a".
// A document with content of {b:1} matches the filters, but does not match the orderBy because
// it's missing the field 'a'.
for(let n of he(t))if(!n.field.isKeyField()&&null===e.data.field(n.field))return!1;return!0}(t,e)&&function(t,e){for(let n of t.filters)if(!n.matches(e))return!1;return!0}(t,e)&&(!t.startAt||!!/**
 * Returns true if a document sorts before a bound using the provided sort
 * order.
 */function(t,e,n){let i=uz(t,e,n);return t.inclusive?i<=0:i<0}(t.startAt,he(t),e))&&(!t.endAt||!!function(t,e,n){let i=uz(t,e,n);return t.inclusive?i>=0:i>0}(t.endAt,he(t),e))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class hl{constructor(t,e){this.mapKeyFn=t,this.equalsFn=e,/**
     ...
     */delete(t){let e=this.mapKeyFn(t),n=this.inner[e];if(void 0===n)return!1;for(let i=0;i<n.length;i++)if(this.equalsFn(n[i][0],t))return 1===n.length?delete this.inner[e]:n.splice(i,1),this.innerSize--,!0;return!1}forEach(t){uh(this.inner,(e,n)=>{for(let[e,i]of n)t(e,i)})}isEmpty(){return uc(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let hu=new uf(ue.comparator),hh=new uf(ue.comparator);function hc(...t){let e=hh;for(let n of t)e=e.insert(n.key,n);return e}function hf(t){let e=hh;return t.forEach((t,n)=>e=e.insert(t,n.overlayedDocument)),e}function hd(){return new hl(t=>t.toString(),(t,e)=>t.isEqual(e))}let hp=new uf(ue.comparator),hg=new ug(ue.comparator);function hm(...t){let e=hg;for(let n of t)e=e.add(n);return e}let hy=new ug(l9);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function hv(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:ul(e)?"-0":e}}/**
 * Returns an IntegerValue for `value`.
 */function hw(t){return{integerValue:""+t}}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 *//** Used to represent a field transform on a mutation. */class hb{constructor(){// Make sure that the structural type of `TransformOperation` is unique.
 ...
 */function hE(t,e){return t instanceof hC?/** Returns true if `value` is either an IntegerValue or a DoubleValue. */uP(e)||e&&"doubleValue"in e?e:{integerValue:0}:null}/** Transforms a value into a server-generated timestamp. */class hT extends hb{}/** Transforms an array value via a union operation. */class hI extends hb{constructor(t){super(),this.elements=t}}function hS(t,e){let n=hk(e);for(let e of t.elements)n.some(t=>uN(t,e))||n.push(e);return{arrayValue:{values:n}}}/** Transforms an array value via a remove operation. */class hA extends hb{constructor(t){super(),this.elements=t}}function hx(t,e){let n=hk(e);for(let e of t.elements)n=n.filter(t=>!uN(t,e));return{arrayValue:{values:n}}}/**
 * Implements the backend semantics for locally computed NUMERIC_ADD (increment)
 * transforms. Converts all field values to integers or doubles, but unlike the
 * backend does not cap integer values at 2^63. Instead, JavaScript number
 * arithmetic is used and precision loss can occur for values greater than 2^53.
 */class hC extends hb{constructor(t,e){super(),this.serializer=t,this.Te=e}}function h_(t){return uT(t.integerValue||t.doubleValue)}function hk(t){return uM(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}/** The result of successfully applying a mutation to the backend. */class hN{constructor(/**
 ...
 */class hD{constructor(t,e){this.updateTime=t,this.exists=e}/** Creates a new empty Precondition. */static none(){return new hD}/** Creates a new Precondition with an exists flag. */static exists(t){return new hD(void 0,t)}/** Creates a new Precondition based on a version a document exists at. */static updateTime(t){return new hD(t)}/** Returns whether this Precondition is empty. */get isNone(){return void 0===this.updateTime&&void 0===this.exists}isEqual(t){return this.exists===t.exists&&(this.updateTime?!!t.updateTime&&this.updateTime.isEqual(t.updateTime):!t.updateTime)}}/** Returns true if the preconditions is valid for the given document. */function hO(t,e){return void 0!==t.updateTime?e.isFoundDocument()&&e.version.isEqual(t.updateTime):void 0===t.exists||t.exists===e.isFoundDocument()}/**
 ...
 */function hL(t,e){if(!t.hasLocalMutations||e&&0===e.fields.length)return null;// mask is null when sets or deletes are applied to the current document.
if(null===e)return t.isNoDocument()?new h$(t.key,hD.none()):new hB(t.key,t.data,hD.none());{let n=t.data,i=uj.empty(),r=new ug(ut.comparator);for(let t of e.fields)if(!r.has(t)){let e=n.field(t);// If we are deleting a nested field, we take the immediate parent as
...
null===e&&t.length>1&&(t=t.popLast(),e=n.field(t)),null===e?i.delete(t):i.set(t,e),r=r.add(t)}return new hF(t.key,i,new uy(r.toArray()),hD.none())}}/**
 ...
 */function hP(t,e,n,i){return t instanceof hB?function(t,e,n,i){if(!hO(t.precondition,e))// caused a name collision).
return n;let r=t.value.clone(),s=hV(t.fieldTransforms,i,e);return r.setAll(s),e.convertToFoundDocument(e.version,r).setHasLocalMutations(),null;// SetMutation overwrites all fields.
}(t,e,n,i):t instanceof hF?function(t,e,n,i){if(!hO(t.precondition,e))return n;let r=hV(t.fieldTransforms,i,e),s=e.data;return(s.setAll(hU(t)),s.setAll(r),e.convertToFoundDocument(e.version,s).setHasLocalMutations(),null===n)?null:n.unionWith(t.fieldMask.fields).unionWith(t.fieldTransforms.map(t=>t.field))}(t,e,n,i):hO(t.precondition,e)?(e.convertToNoDocument(e.version).setHasLocalMutations(),null):n}function hM(t,e){var n,i;return t.type===e.type&&!!t.key.isEqual(e.key)&&!!t.precondition.isEqual(e.precondition)&&(n=t.fieldTransforms,i=e.fieldTransforms,!!(void 0===n&&void 0===i||!(!n||!i)&&l4(n,i,(t,e)=>{var n,i;return t.field.isEqual(e.field)&&(n=t.transform,i=e.transform,n instanceof hI&&i instanceof hI||n instanceof hA&&i instanceof hA?l4(n.elements,i.elements,uN):n instanceof hC&&i instanceof hC?uN(n.Te,i.Te):n instanceof hT&&i instanceof hT)})))&&(0/* MutationType.Set */===t.type?t.value.isEqual(e.value):1/* MutationType.Patch */!==t.type||t.data.isEqual(e.data)&&t.fieldMask.isEqual(e.fieldMask))}/**
 * A mutation that creates or replaces the document at the given key with the
 * object value contents.
 */class hB extends hR{constructor(t,e,n,i=[]){super(),this.key=t,this.value=e,this.precondition=n,this.fieldTransforms=i,this.type=0/* MutationType.Set */}getFieldMask(){return null}}class hF extends hR{constructor(t,e,n,i,r=[]){super(),this.key=t,this.data=e,this.fieldMask=n,this.precondition=i,this.fieldTransforms=r,this.type=1/* MutationType.Patch */}getFieldMask(){return this.fieldMask}}function hU(t){let e=new Map;return t.fieldMask.fields.forEach(n=>{if(!n.isEmpty()){let i=t.data.field(n);e.set(n,i)}}),e}/**
 ...
 */function hj(t,e,n){var i;let r=new Map;t.length===n.length||lq();for(let s=0;s<n.length;s++){let o=t[s],a=o.transform,l=e.data.field(o.field);r.set(o.field,(i=n[s],a instanceof hI?hS(a,l):a instanceof hA?hx(a,l):i))}return r}/**
 * Creates a list of "transform results" (a transform result is a field value
 ...
 * @returns The transform results list.
 */function hV(t,e,n){let i=new Map;for(let r of t){let t=r.transform,s=n.data.field(r.field);i.set(r.field,t instanceof hT?function(t,e){let n={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:t.seconds,nanos:t.nanoseconds}}}};// We should avoid storing deeply nested server timestamp map values
 ...
 */function t(e){let n=e.mapValue.fields.__previous_value__;return uS(n)?t(n):n}(e)),e&&(n.fields.__previous_value__=e),{mapValue:n}}(e,s):t instanceof hI?hS(t,s):t instanceof hA?hx(t,s):function(t,e){// PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
// precision and resolves overflows by reducing precision, we do not
// manually cap overflows at 2^63.
let n=hE(t,e),i=h_(n)+h_(t.Te);return uP(n)&&uP(t.Te)?hw(i):hv(t.serializer,i)}(t,s))}return i}/** A mutation that deletes the document at the given key. */class h$ extends hR{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=2/* MutationType.Delete */,this.fieldTransforms=[]}getFieldMask(){return null}}class hz extends hR{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=3/* MutationType.Verify */,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class hq{/**
     ...
     * backend.
     */applyToRemoteDocument(t,e){let n=e.mutationResults;for(let e=0;e<this.mutations.length;e++){let r=this.mutations[e];if(r.key.isEqual(t.key)){var i;i=n[e],r instanceof hB?function(t,e,n){// Unlike setMutationApplyToLocalView, if we're applying a mutation to a
// remote document the server has accepted the mutation so the precondition
// must have held.
let i=t.value.clone(),r=hj(t.fieldTransforms,e,n.transformResults);i.setAll(r),e.convertToFoundDocument(n.version,i).setHasCommittedMutations()}(r,t,i):r instanceof hF?function(t,e,n){if(!hO(t.precondition,e))// matched on the backend. We therefore must not have the expected version
// of the document in our cache and convert to an UnknownDocument with a
// known updateTime.
return void e.convertToUnknownDocument(n.version);let i=hj(t.fieldTransforms,e,n.transformResults),r=e.data;r.setAll(hU(t)),r.setAll(i),e.convertToFoundDocument(n.version,r).setHasCommittedMutations()}(r,t,i):function(t,e,n){// Unlike applyToLocalView, if we're applying a mutation to a remote
...
for(let n of this.baseMutations)n.key.isEqual(t.key)&&(e=hP(n,t,e,this.localWriteTime));// Second, apply all user-provided mutations.
for(let n of this.mutations)n.key.isEqual(t.key)&&(e=hP(n,t,e,this.localWriteTime));return e}/**
...
// to O(n).
let n=hd();return this.mutations.forEach(i=>{let r=t.get(i.key),s=r.overlayedDocument,o=this.applyToLocalView(s,r.mutatedFields);// Set mutatedFields to null if the document is only from local mutations.
// This creates a Set or Delete mutation, instead of trying to create a
// patch mutation as the overlay.
o=e.has(i.key)?null:o;let a=hL(s,o);null!==a&&n.set(i.key,a),s.isValidDocument()||s.convertToNoDocument(l6.min())}),n}keys(){return this.mutations.reduce((t,e)=>t.add(e.key),hm())}isEqual(t){return this.batchId===t.batchId&&l4(this.mutations,t.mutations,(t,e)=>hM(t,e))&&l4(this.baseMutations,t.baseMutations,(t,e)=>hM(t,e))}}/** The result of applying a mutation batch to the backend. */class hH{constructor(t,e,n,/**
     ...
     */static from(t,e,n){t.mutations.length===n.length||lq();let i=hp,r=t.mutations;for(let t=0;t<r.length;t++)i=i.insert(r[t].key,n[t].version);return new hH(t,e,n,i)}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class hK{constructor(t,e){this.largestBatchId=t,this.mutation=e}getKey(){return this.mutation.key}isEqual(t){return null!==t&&this.mutation===t.mutation}toString(){return`Overlay{
 ...
 */class hG{constructor(t,e){this.databaseId=t,this.useProto3Json=e}}/**
 * Returns a number (or null) from a google.protobuf.Int32Value proto.
 *//**
 * Returns a value for a Date that's appropriate to put into a proto.
 */function hW(t,e){return t.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function hQ(t){return t||lq(),l6.fromTimestamp(function(t){let e=uE(t);return new l5(e.seconds,e.nanos)}(t))}function hX(t,e){return new l8(["projects",t.projectId,"databases",t.database]).child("documents").child(e).canonicalString()}function hJ(t,e){return hX(t.databaseId,e.path)}/** Creates a Document proto from key and fields (but no create/update time) */function hY(t,e,n){return{name:hJ(t,e),fields:n.value.mapValue.fields}}function hZ(t){return ut.fromServerFormat(t.fieldPath)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 *//** Serializer for values stored in the LocalStore. */class h0{constructor(t){this.ht=t}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
/** Firestore index value writer.  */class h1{constructor(){}// The write methods below short-circuit writing terminators for values
 ...
 */class h2{constructor(){this.an=new h9}addToCollectionParentIndex(t,e){return this.an.add(e),us.resolve()}getCollectionParents(t,e){return us.resolve(this.an.getEntries(e))}addFieldIndex(t,e){// Field indices are not supported with memory persistence.
 ...
 */class h9{constructor(){this.index={}}// Returns false if the entry already existed.
add(t){let e=t.lastSegment(),n=t.popLast(),i=this.index[e]||new ug(l8.comparator),r=!i.has(n);return this.index[e]=i.add(n),r}has(t){let e=t.lastSegment(),n=t.popLast(),i=this.index[e];return i&&i.has(n)}getEntries(t){return(this.index[t]||new ug(l8.comparator)).toArray()}}new Uint8Array(0);class h4{constructor(// threshold. Passing `COLLECTION_DISABLED` here will cause collection to always be skipped.
t,e,// us from collecting a huge number of sequence numbers if the cache has grown very large.
n){this.cacheSizeCollectionThreshold=t,this.percentileToCollect=e,this.maximumSequenceNumbersToCollect=n}static withCacheSize(t){return new h4(t,h4.DEFAULT_COLLECTION_PERCENTILE,h4.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 *//** A mutation queue for a specific user, backed by IndexedDB. */h4.DEFAULT_COLLECTION_PERCENTILE=10,h4.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,h4.DEFAULT=new h4(41943040,h4.DEFAULT_COLLECTION_PERCENTILE,h4.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),h4.DISABLED=new h4(-1,0,0);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * restart.
 */class h5{constructor(t){this.Nn=t}next(){return this.Nn+=2,this.Nn}static Bn(){// The target cache generator must return '2' in its first call to `next()`
// as there is no differentiation in the protocol layer between an unset
// number and the number '0'. If we were to sent a target with target ID
// '0', the backend would consider it unset and replace it with its own ID.
return new h5(0)}static Ln(){// Sync engine assigns target IDs for limbo document detection.
return new h5(-1)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 */class h6{constructor(){// A mapping of document key to the new cache entry that should be written.
this.changes=new hl(t=>t.toString(),(t,e)=>t.isEqual(e)),this.changesApplied=!1}/**
 ...
 */class h8{constructor(t,e,n,i){this.remoteDocumentCache=t,this.mutationQueue=e,this.documentOverlayCache=n,this.indexManager=i}/**
     * Get the local view of the document identified by `key`.
     *
     * @returns Local view of the document or null if we don't have any cached
     * state for it.
     */getDocument(t,e){let n=null;return this.documentOverlayCache.getOverlay(t,e).next(i=>(n=i,this.remoteDocumentCache.getEntry(t,e))).next(t=>(null!==n&&hP(n.mutation,t,uy.empty(),l5.now()),t))}/**
     * Gets the local view of the documents identified by `keys`.
     *
     * If we don't have cached state for a document in `keys`, a NoDocument will
     * be stored for that key in the resulting set.
     */getDocuments(t,e){return this.remoteDocumentCache.getEntries(t,e).next(e=>this.getLocalViewOfDocuments(t,e,hm()).next(()=>e))}/**
     ...
     *   to be recalculated.
     */getLocalViewOfDocuments(t,e,n=hm()){let i=hd();return this.populateOverlays(t,i,e).next(()=>this.computeViews(t,e,i,n).next(t=>{let e=hc();return t.forEach((t,n)=>{e=e.insert(t,n.overlayedDocument)}),e}))}/**
     * Gets the overlayed documents for the given document map, which will include
     * the local view of those documents and a `FieldMask` indicating which fields
     * are mutated locally, `null` if overlay is a Set or Delete mutation.
     */getOverlayedDocuments(t,e){let n=hd();return this.populateOverlays(t,n,e).next(()=>this.computeViews(t,e,n,hm()))}/**
     ...
     */computeViews(t,e,n,i){let r=hu,s=hd(),o=hd();return e.forEach((t,e)=>{let o=n.get(e.key);// Recalculate an overlay if the document's existence state changed due to
...
i.has(e.key)&&(void 0===o||o.mutation instanceof hF)?r=r.insert(e.key,e):void 0!==o?(s.set(e.key,o.mutation.getFieldMask()),hP(o.mutation,e,o.mutation.getFieldMask(),l5.now())):// Using EMPTY to indicate there is no overlay for the document.
s.set(e.key,uy.empty())}),this.recalculateAndSaveOverlays(t,r).next(t=>(t.forEach((t,e)=>s.set(t,e)),e.forEach((t,e)=>{var n;return o.set(t,new h3(e,null!==(n=s.get(t))&&void 0!==n?n:null))}),o))}recalculateAndSaveOverlays(t,e){let n=hd(),i=new uf((t,e)=>t-e),r=hm();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,e).next(t=>{for(let r of t)r.keys().forEach(t=>{let s=e.get(t);if(null===s)return;let o=n.get(t)||uy.empty();o=r.applyToLocalView(s,o),n.set(t,o);let a=(i.get(r.batchId)||hm()).add(t);i=i.insert(r.batchId,a)})}).next(()=>{let s=[],o=i.getReverseIterator();// Iterate in descending order of batch IDs, and skip documents that are
// already saved.
for(;o.hasNext();){let i=o.getNext(),a=i.key,l=i.value,u=hd();l.forEach(t=>{if(!r.has(t)){let i=hL(e.get(t),n.get(t));null!==i&&u.set(t,i),r=r.add(t)}}),s.push(this.documentOverlayCache.saveOverlays(t,a,u))}return us.waitFor(s)}).next(()=>n)}/**
 ...
 */return ue.isDocumentKey(e.path)&&null===e.collectionGroup&&0===e.filters.length?this.getDocumentsMatchingDocumentQuery(t,e.path):null!==e.collectionGroup?this.getDocumentsMatchingCollectionGroupQuery(t,e,n,i):this.getDocumentsMatchingCollectionQuery(t,e,n,i)}/**
     ...
     */getNextDocuments(t,e,n,i){return this.remoteDocumentCache.getAllFromCollectionGroup(t,e,n,i).next(r=>{let s=i-r.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,e,n.largestBatchId,i-r.size):us.resolve(hd()),o=-1,a=r;return s.next(e=>us.forEach(e,(e,n)=>(o<n.largestBatchId&&(o=n.largestBatchId),r.get(e)?us.resolve():this.remoteDocumentCache.getEntry(t,e).next(t=>{a=a.insert(e,t)}))).next(()=>this.populateOverlays(t,e,r)).next(()=>this.computeViews(t,a,e,hm())).next(t=>({batchId:o,changes:hf(t)})))})}getDocumentsMatchingDocumentQuery(t,e){// Just do a simple document lookup.
return this.getDocument(t,new ue(e)).next(t=>{let e=hc();return t.isFoundDocument()&&(e=e.insert(t.key,t)),e})}getDocumentsMatchingCollectionGroupQuery(t,e,n,i){let r=e.collectionGroup,s=hc();return this.indexManager.getCollectionParents(t,r).next(o=>us.forEach(o,o=>{var a;let l=(a=o.child(r),new u7(a,/*collectionGroup=*/null,e.explicitOrderBy.slice(),e.filters.slice(),e.limit,e.limitType,e.startAt,e.endAt));return this.getDocumentsMatchingCollectionQuery(t,l,n,i).next(t=>{t.forEach((t,e)=>{s=s.insert(t,e)})})}).next(()=>s))}getDocumentsMatchingCollectionQuery(t,e,n,i){// Query the remote documents and overlay mutations.
...
let n=hc();return t.forEach((t,i)=>{let s=r.get(t);void 0!==s&&hP(s.mutation,i,uy.empty(),l5.now()),ha(e,i)&&(n=n.insert(t,i))}),n})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class h7{constructor(t){this.serializer=t,this.lr=new Map,this.hr=new Map}getBundleMetadata(t,e){return us.resolve(this.lr.get(e))}saveBundleMetadata(t,e){return this.lr.set(e.id,{id:e.id,version:e.version,createTime:hQ(e.createTime)}),us.resolve()}getNamedQuery(t,e){return us.resolve(this.hr.get(e))}saveNamedQuery(t,e){return this.hr.set(e.name,{name:e.name,query:/**
 * Encodes a `BundledQuery` from bundle proto to a Query object.
 *
 * This reconstructs the original query used to build the bundle being loaded,
 * including features exists only in SDKs (for example: limit-to-last).
 */function(t){let e=function(t){var e,n,i,r,s,o,a,l;let u,h=function(t){let e=function(t){let e=l8.fromString(t);return e.length>=4&&"projects"===e.get(0)&&"databases"===e.get(2)||lq(),e}(t);// In v1beta1 queries for collections at the root did not have a trailing
// "/documents". In v1 all resource paths contain "/documents". Preserve the
// ability to read the v1beta1 form for compatibility with queries persisted
// in the local target cache.
return 4===e.length?l8.emptyPath():(e.length>4&&"documents"===e.get(4)||lq(),e.popFirst(5))}(t.parent),c=t.structuredQuery,f=c.from?c.from.length:0,d=null;if(f>0){1===f||lq();let t=c.from[0];t.allDescendants?d=t.collectionId:h=h.child(t.collectionId)}let p=[];c.where&&(p=function(t){var e;let n=function t(e){return void 0!==e.unaryFilter?function(t){switch(t.unaryFilter.op){case"IS_NAN":let e=hZ(t.unaryFilter.field);return uG.create(e,"=="/* Operator.EQUAL */,{doubleValue:NaN});case"IS_NULL":let n=hZ(t.unaryFilter.field);return uG.create(n,"=="/* Operator.EQUAL */,{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":let i=hZ(t.unaryFilter.field);return uG.create(i,"!="/* Operator.NOT_EQUAL */,{doubleValue:NaN});case"IS_NOT_NULL":let r=hZ(t.unaryFilter.field);return uG.create(r,"!="/* Operator.NOT_EQUAL */,{nullValue:"NULL_VALUE"});default:return lq()}}(e):void 0!==e.fieldFilter?uG.create(hZ(e.fieldFilter.field),function(t){switch(t){case"EQUAL":return"=="/* Operator.EQUAL */;case"NOT_EQUAL":return"!="/* Operator.NOT_EQUAL */;case"GREATER_THAN":return">"/* Operator.GREATER_THAN */;case"GREATER_THAN_OR_EQUAL":return">="/* Operator.GREATER_THAN_OR_EQUAL */;case"LESS_THAN":return"<"/* Operator.LESS_THAN */;case"LESS_THAN_OR_EQUAL":return"<="/* Operator.LESS_THAN_OR_EQUAL */;case"ARRAY_CONTAINS":return"array-contains"/* Operator.ARRAY_CONTAINS */;case"IN":return"in"/* Operator.IN */;case"NOT_IN":return"not-in"/* Operator.NOT_IN */;case"ARRAY_CONTAINS_ANY":return"array-contains-any"/* Operator.ARRAY_CONTAINS_ANY */;default:return lq()}}(e.fieldFilter.op),e.fieldFilter.value):void 0!==e.compositeFilter?uW.create(e.compositeFilter.filters.map(e=>t(e)),function(t){switch(t){case"AND":return"and"/* CompositeOperator.AND */;case"OR":return"or"/* CompositeOperator.OR */;default:return lq()}}(e.compositeFilter.op)):lq()}(t);return n instanceof uW&&uX(e=n)&&uQ(e)?n.getFilters():[n]}(c.where));let g=[];c.orderBy&&(g=c.orderBy.map(t=>new uH(hZ(t.field),function(t){switch(t){case"ASCENDING":return"asc"/* Direction.ASCENDING */;case"DESCENDING":return"desc"/* Direction.DESCENDING */;default:return}}(t.direction))));let m=null;c.limit&&(m=null==(u="object"==typeof(e=c.limit)?e.value:e)?null:u);let y=null;c.startAt&&(y=function(t){let e=!!t.before,n=t.values||[];return new u$(n,e)}(c.startAt));let v=null;return c.endAt&&(v=function(t){let e=!t.before,n=t.values||[];return new u$(n,e)}(c.endAt)),n=h,i=d,r=g,s=p,o=m,a=y,l=v,new u7(n,i,r,s,o,"F"/* LimitType.First */,a,l)}({parent:t.parent,structuredQuery:t.structuredQuery});return"LAST"===t.limitType?hi(e,e.limit,"L"/* LimitType.Last */):e}(e.bundledQuery),readTime:hQ(e.readTime)}),us.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class ct{constructor(){// A map sorted by DocumentKey, whose value is a pair of the largest batch id
// for the overlay and the overlay itself.
this.overlays=new uf(ue.comparator),this.Pr=new Map}getOverlay(t,e){return us.resolve(this.overlays.get(e))}getOverlays(t,e){let n=hd();return us.forEach(e,e=>this.getOverlay(t,e).next(t=>{null!==t&&n.set(e,t)})).next(()=>n)}saveOverlays(t,e,n){return n.forEach((n,i)=>{this.It(t,e,i)}),us.resolve()}removeOverlaysForBatchId(t,e,n){let i=this.Pr.get(n);return void 0!==i&&(i.forEach(t=>this.overlays=this.overlays.remove(t)),this.Pr.delete(n)),us.resolve()}getOverlaysForCollection(t,e,n){let i=hd(),r=e.length+1,s=new ue(e.child("")),o=this.overlays.getIteratorFrom(s);for(;o.hasNext();){let t=o.getNext().value,s=t.getKey();if(!e.isPrefixOf(s.path))break;// Documents from sub-collections
s.path.length===r&&t.largestBatchId>n&&i.set(t.getKey(),t)}return us.resolve(i)}getOverlaysForCollectionGroup(t,e,n,i){let r=new uf((t,e)=>t-e),s=this.overlays.getIterator();for(;s.hasNext();){let t=s.getNext().value;if(t.getKey().getCollectionGroup()===e&&t.largestBatchId>n){let e=r.get(t.largestBatchId);null===e&&(e=hd(),r=r.insert(t.largestBatchId,e)),e.set(t.getKey(),t)}}let o=hd(),a=r.getIterator();for(;a.hasNext()&&(a.getNext().value.forEach((t,e)=>o.set(t,e)),!(o.size()>=i)););return us.resolve(o)}It(t,e,n){// Remove the association of the overlay to its batch id.
let i=this.overlays.get(n.key);if(null!==i){let t=this.Pr.get(i.largestBatchId).delete(n.key);this.Pr.set(i.largestBatchId,t)}this.overlays=this.overlays.insert(n.key,new hK(e,n));// Create the association of this overlay to the given largestBatchId.
let r=this.Pr.get(e);void 0===r&&(r=hm(),this.Pr.set(e,r)),this.Pr.set(e,r.add(n.key))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * some target ID.
 */class ce{constructor(){// A set of outstanding references to a document sorted by key.
this.Ir=new ug(cn.dr),this.Tr=new ug(cn.Er)}/** Returns true if the reference set contains no references. */isEmpty(){return this.Ir.isEmpty()}/** Adds a reference to the given document key for the given ID. */addReference(t,e){let n=new cn(t,e);this.Ir=this.Ir.add(n),this.Tr=this.Tr.add(n)}/** Add references to the given document keys for the given ID. */Ar(t,e){t.forEach(t=>this.addReference(t,e))}/**
     * Removes a reference to the given document key for the given
     * ID.
     */removeReference(t,e){this.Rr(new cn(t,e))}Vr(t,e){t.forEach(t=>this.removeReference(t,e))}/**
     * Clears all references with a given ID. Calls removeRef() for each key
     * removed.
     */mr(t){let e=new ue(new l8([])),n=new cn(e,t),i=new cn(e,t+1),r=[];return this.Tr.forEachInRange([n,i],t=>{this.Rr(t),r.push(t.key)}),r}gr(){this.Ir.forEach(t=>this.Rr(t))}Rr(t){this.Ir=this.Ir.delete(t),this.Tr=this.Tr.delete(t)}pr(t){let e=new ue(new l8([])),n=new cn(e,t),i=new cn(e,t+1),r=hm();return this.Tr.forEachInRange([n,i],t=>{r=r.add(t.key)}),r}containsKey(t){let e=new cn(t,0),n=this.Ir.firstAfterOrEqual(e);return null!==n&&t.isEqual(n.key)}}class cn{constructor(t,e){this.key=t,this.yr=e}/** Compare by key then by ID */static dr(t,e){return ue.comparator(t.key,e.key)||l9(t.yr,e.yr)}/** Compare by ID then by key */static Er(t,e){return l9(t.yr,e.yr)||ue.comparator(t.key,e.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ci{constructor(t,e){this.indexManager=t,this.referenceDelegate=e,/**
         * The set of all mutations that have been sent but not yet been applied to
         * the backend.
         */this.mutationQueue=[],/** Next value to use when assigning sequential IDs to each mutation batch. */this.wr=1,/** An ordered mapping between documents and the mutations batch IDs. */this.Sr=new ug(cn.dr)}checkEmpty(t){return us.resolve(0===this.mutationQueue.length)}addMutationBatch(t,e,n,i){let r=this.wr;this.wr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];let s=new hq(r,e,n,i);// Track references by document key and index collection parents.
for(let e of(this.mutationQueue.push(s),i))this.Sr=this.Sr.add(new cn(e.key,r)),this.indexManager.addToCollectionParentIndex(t,e.key.path.popLast());return us.resolve(s)}lookupMutationBatch(t,e){return us.resolve(this.br(e))}getNextMutationBatchAfterBatchId(t,e){let n=this.Dr(e+1),i=n<0?0:n;// The requested batchId may still be out of range so normalize it to the
// start of the queue.
return us.resolve(this.mutationQueue.length>i?this.mutationQueue[i]:null)}getHighestUnacknowledgedBatchId(){return us.resolve(0===this.mutationQueue.length?-1:this.wr-1)}getAllMutationBatches(t){return us.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(t,e){let n=new cn(e,0),i=new cn(e,Number.POSITIVE_INFINITY),r=[];return this.Sr.forEachInRange([n,i],t=>{let e=this.br(t.yr);r.push(e)}),us.resolve(r)}getAllMutationBatchesAffectingDocumentKeys(t,e){let n=new ug(l9);return e.forEach(t=>{let e=new cn(t,0),i=new cn(t,Number.POSITIVE_INFINITY);this.Sr.forEachInRange([e,i],t=>{n=n.add(t.yr)})}),us.resolve(this.Cr(n))}getAllMutationBatchesAffectingQuery(t,e){// Use the query path as a prefix for testing if a document matches the
// query.
let n=e.path,i=n.length+1,r=n;ue.isDocumentKey(r)||(r=r.child(""));let s=new cn(new ue(r),0),o=new ug(l9);return this.Sr.forEachWhile(t=>{let e=t.key.path;return!!n.isPrefixOf(e)&&// Rows with document keys more than one segment longer than the query
...
let e=[];return t.forEach(t=>{let n=this.br(t);null!==n&&e.push(n)}),e}removeMutationBatch(t,e){0===this.vr(e.batchId,"removed")||lq(),this.mutationQueue.shift();let n=this.Sr;return us.forEach(e.mutations,i=>{let r=new cn(i.key,e.batchId);return n=n.delete(r),this.referenceDelegate.markPotentiallyOrphaned(t,i.key)}).next(()=>{this.Sr=n})}xn(t){// No-op since the memory mutation queue does not maintain a separate cache.
}containsKey(t,e){let n=new cn(e,0),i=this.Sr.firstAfterOrEqual(n);return us.resolve(e.isEqual(i&&i.key))}performConsistencyCheck(t){return this.mutationQueue.length,us.resolve()}/**
 ...
 */class cr{/**
     ...
     * returned by `newChangeBuffer()`.
     */removeEntry(t){let e=this.docs.get(t);e&&(this.docs=this.docs.remove(t),this.size-=e.size)}getEntry(t,e){let n=this.docs.get(e);return us.resolve(n?n.document.mutableCopy():uV.newInvalidDocument(e))}getEntries(t,e){let n=hu;return e.forEach(t=>{let e=this.docs.get(t);n=n.insert(t,e?e.document.mutableCopy():uV.newInvalidDocument(t))}),us.resolve(n)}getDocumentsMatchingQuery(t,e,n,i){let r=hu,s=e.path,o=new ue(s.child("")),a=this.docs.getIteratorFrom(o);for(;a.hasNext();){let{key:t,value:{document:o}}=a.getNext();if(!s.isPrefixOf(t.path))break;t.path.length>s.length+1||0>=function(t,e){let n=t.readTime.compareTo(e.readTime);return 0!==n?n:0!==(n=ue.comparator(t.documentKey,e.documentKey))?n:l9(t.largestBatchId,e.largestBatchId)}(new un(o.readTime,o.key,-1),n)||(i.has(o.key)||ha(e,o))&&(r=r.insert(o.key,o.mutableCopy()))}return us.resolve(r)}getAllFromCollectionGroup(t,e,n,i){// This method should only be called from the IndexBackfiller if persistence
// is enabled.
...
return new cs(this)}getSize(t){return us.resolve(this.size)}}/**
 ...
 */class cs extends h6{constructor(t){super(),this.ur=t}applyChanges(t){let e=[];return this.changes.forEach((n,i)=>{i.isValidDocument()?e.push(this.ur.addEntry(t,i)):this.ur.removeEntry(n)}),us.waitFor(e)}getFromCache(t,e){return this.ur.getEntry(t,e)}getAllFromCache(t,e){return this.ur.getEntries(t,e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class ca{/**
     ...
     */constructor(t,e){this.kr={},this.overlays={},this.qr=new ua(0),this.Qr=!1,this.Qr=!0,this.referenceDelegate=t(this),this.Kr=new co(this),this.indexManager=new h2,this.remoteDocumentCache=new cr(t=>this.referenceDelegate.$r(t)),this.serializer=new h0(e),this.Ur=new h7(this.serializer)}start(){return Promise.resolve()}shutdown(){// No durable state to ensure is closed on shutdown.
...
return this.indexManager}getDocumentOverlayCache(t){let e=this.overlays[t.toKey()];return e||(e=new ct,this.overlays[t.toKey()]=e),e}getMutationQueue(t,e){let n=this.kr[t.toKey()];return n||(n=new ci(e,this.referenceDelegate),this.kr[t.toKey()]=n),n}getTargetCache(){return this.Kr}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Ur}runTransaction(t,e,n){lj("MemoryPersistence","Starting transaction:",t);let i=new cl(this.qr.next());return this.referenceDelegate.Wr(),n(i).next(t=>this.referenceDelegate.Gr(i).next(()=>t)).toPromise().then(t=>(i.raiseOnCommittedEvent(),t))}zr(t,e){return us.or(Object.values(this.kr).map(n=>()=>n.containsKey(t,e)))}}/**
 * Memory persistence is not actually transactional, but future implementations
 * may have transaction-scoped state.
 */class cl extends ui{constructor(t){super(),this.currentSequenceNumber=t}}class cu{constructor(t){this.persistence=t,/** Tracks all documents that are active in Query views. */this.jr=new ce,/** The list of documents that are potentially GCed after each transaction. */this.Hr=null}static Jr(t){return new cu(t)}get Yr(){if(this.Hr)return this.Hr;throw lq()}addReference(t,e,n){return this.jr.addReference(n,e),this.Yr.delete(n.toString()),us.resolve()}removeReference(t,e,n){return this.jr.removeReference(n,e),this.Yr.add(n.toString()),us.resolve()}markPotentiallyOrphaned(t,e){return this.Yr.add(e.toString()),us.resolve()}removeTarget(t,e){this.jr.mr(e.targetId).forEach(t=>this.Yr.add(t.toString()));let n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(t,e.targetId).next(t=>{t.forEach(t=>this.Yr.add(t.toString()))}).next(()=>n.removeTargetData(t,e))}Wr(){this.Hr=new Set}Gr(t){// Remove newly orphaned documents.
 ...
 */class ch{constructor(t,e,n,i){this.targetId=t,this.fromCache=e,this.Qi=n,this.Ki=i}static $i(t,e){let n=hm(),i=hm();for(let t of e.docChanges)switch(t.type){case 0/* ChangeType.Added */:n=n.add(t.doc.key);break;case 1/* ChangeType.Removed */:i=i.add(t.doc.key)}return new ch(t,e.fromCache,n,i)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class cf{constructor(){this.Ui=!1,this.Wi=!1,/**
...
let r={result:null};return this.Hi(t,e).next(t=>{r.result=t}).next(()=>{if(!r.result)return this.Ji(t,e,i,n).next(t=>{r.result=t})}).next(()=>{if(r.result)return;let n=new cc;return this.Yi(t,e,n).next(i=>{if(r.result=i,this.Wi)return this.Zi(t,e,n,i.size)})}).next(()=>r.result)}Zi(t,e,n,i){return n.documentReadCount<this.Gi?(lU()<=sa.DEBUG&&lj("QueryEngine","SDK will not create cache indexes for query:",ho(e),"since it only creates cache indexes for collection contains","more than or equal to",this.Gi,"documents"),us.resolve()):(lU()<=sa.DEBUG&&lj("QueryEngine","Query:",ho(e),"scans",n.documentReadCount,"local documents and returns",i,"documents as results."),n.documentReadCount>this.zi*i?(lU()<=sa.DEBUG&&lj("QueryEngine","The SDK decides to create cache indexes for query:",ho(e),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,hn(e))):us.resolve())}/**
     * Performs an indexed query that evaluates the query based on a collection's
     * persisted index values. Returns `null` if an index is not available.
     */Hi(t,e){if(ht(e))// key-based lookups. It is more efficient to scan all documents in a
// collection, rather than to perform individual lookups.
return us.resolve(null);let n=hn(e);return this.indexManager.getIndexType(t,n).next(i=>0/* IndexType.NONE */===i?null:(null!==e.limit&&1/* IndexType.PARTIAL */===i&&(n=hn(// We cannot apply a limit for targets that are served using a partial
    ...
    e=hi(e,null,"F"/* LimitType.First */))),this.indexManager.getDocumentsMatchingTarget(t,n).next(i=>{let r=hm(...i);return this.ji.getDocuments(t,r).next(i=>this.indexManager.getMinOffset(t,n).next(n=>{let s=this.Xi(e,i);return this.es(e,s,r,n.readTime)?this.Hi(t,hi(e,null,"F"/* LimitType.First */)):this.ts(t,s,e,n)}))})))}/**
     * Performs a query based on the target's persisted query mapping. Returns
     * `null` if the mapping is not available or cannot be used.
     */Ji(t,e,n,i){return ht(e)||i.isEqual(l6.min())?us.resolve(null):this.ji.getDocuments(t,n).next(r=>{let s=this.Xi(e,r);return this.es(e,s,n,i)?us.resolve(null):(lU()<=sa.DEBUG&&lj("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),ho(e)),this.ts(t,s,e,/**
...
let r="F"/* LimitType.First */===t.limitType?e.last():e.first();return!!r&&(r.hasPendingWrites||r.version.compareTo(i)>0)}Yi(t,e,n){return lU()<=sa.DEBUG&&lj("QueryEngine","Using full collection scan to execute query:",ho(e)),this.ji.getDocumentsMatchingQuery(t,e,un.min(),n)}/**
 ...
 */class cd{constructor(/** Manages our in-memory or durable persistence. */t,e,n,i){this.persistence=t,this.ns=e,this.serializer=i,/**
         * Maps a targetID to data about its target.
         *
         * PORTING NOTE: We are using an immutable data structure on Web to make re-runs
         * of `applyRemoteEvent()` idempotent.
         */this.rs=new uf(l9),/** Maps a target to its targetID. */this.ss=new hl(t=>u3(t),u8),/**
...
// user change
this.documentOverlayCache=this.persistence.getDocumentOverlayCache(t),this.indexManager=this.persistence.getIndexManager(t),this.mutationQueue=this.persistence.getMutationQueue(t,this.indexManager),this.localDocuments=new h8(this._s,this.mutationQueue,this.documentOverlayCache,this.indexManager),this._s.setIndexManager(this.indexManager),this.ns.initialize(this.localDocuments,this.indexManager)}collectGarbage(t){return this.persistence.runTransaction("Collect garbage","readwrite-primary",e=>t.collect(e,this.rs))}}/**
...
// change.
async function cp(t,e){return await t.persistence.runTransaction("Handle user change","readonly",n=>{// Swap out the mutation queue, grabbing the pending mutation batches
// before and after.
let i;return t.mutationQueue.getAllMutationBatches(n).next(r=>(i=r,t.us(e),t.mutationQueue.getAllMutationBatches(n))).next(e=>{let r=[],s=[],o=hm();for(let t of i)for(let e of(r.push(t.batchId),t.mutations))o=o.add(e.key);for(let t of e)for(let e of(s.push(t.batchId),t.mutations))o=o.add(e.key);// Return the set of all (potentially) changed documents and the list
 ...
 * `toWebStorageJSON()`.
 */// Visible for testing.
class cg{constructor(){this.activeTargetIds=hy}Rs(t){this.activeTargetIds=this.activeTargetIds.add(t)}Vs(t){this.activeTargetIds=this.activeTargetIds.delete(t)}/**
     * Converts this entry into a JSON-encoded format we can use for WebStorage.
     * Does not encode `clientId` as it is part of the key in WebStorage.
     */As(){let t={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(t)}}class cm{constructor(){this.ro=new cg,this.io={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(t){// No op.
}updateMutationState(t,e,n){// No op.
}addLocalQueryTarget(t){return this.ro.Rs(t),this.io[t]||"not-current"}updateQueryState(t,e,n){this.io[t]=e}removeLocalQueryTarget(t){this.ro.Vs(t)}isLocalQueryTarget(t){return this.ro.activeTargetIds.has(t)}clearQueryState(t){delete this.io[t]}getAllActiveQueryTargets(){return this.ro.activeTargetIds}isActiveQueryTarget(t){return this.ro.activeTargetIds.has(t)}start(){return this.ro=new cg,Promise.resolve()}handleUserChange(t,e,n){// No op.
 ...
 */function cb(){return null===cw?cw=268435456+Math.round(2147483648*Math.random()):cw++,"0x"+cw.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let cE={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};/**
 ...
 */class cT{constructor(t){this.ho=t.ho,this.Po=t.Po}Io(t){this.To=t}Eo(t){this.Ao=t}onMessage(t){this.Ro=t}close(){this.Po()}send(t){this.ho(t)}Vo(){this.To()}mo(t){this.Ao(t)}fo(t){this.Ro(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let cI="WebChannelConnection";class cS extends /**
...
return!1}bo(t,e,n,i,r){let s=cb(),o=this.Do(t,e);lj("RestConnection",`Sending RPC '${t}' ${s}:`,o,n);let a={"google-cloud-resource-prefix":this.yo,"x-goog-request-params":this.wo};return this.Co(a,i,r),this.vo(t,o,a,n).then(e=>(lj("RestConnection",`Received RPC '${t}' ${s}: `,e),e),e=>{throw l$("RestConnection",`RPC '${t}' ${s} failed with error: `,e,"url: ",o,"request:",n),e})}Fo(t,e,n,i,r,s){// The REST API automatically aggregates all of the streamed results, so we
...
t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),e&&e.headers.forEach((e,n)=>t[n]=e),n&&n.headers.forEach((e,n)=>t[n]=e)}Do(t,e){let n=cE[t];return`${this.po}/v1/${e}:${n}`}}{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}vo(t,e,n,i){let r=cb();return new Promise((s,o)=>{let a=new lR;a.setWithCredentials(!0),a.listenOnce(lk.COMPLETE,()=>{try{switch(a.getLastErrorCode()){case l_.NO_ERROR:let e=a.getResponseJson();lj(cI,`XHR for RPC '${t}' ${r} received:`,JSON.stringify(e)),s(e);break;case l_.TIMEOUT:lj(cI,`RPC '${t}' ${r} timed out`),o(new lK(lH.DEADLINE_EXCEEDED,"Request time out"));break;case l_.HTTP_ERROR:let n=a.getStatus();if(lj(cI,`RPC '${t}' ${r} failed with status:`,n,"response text:",a.getResponseText()),n>0){let t=a.getResponseJson();Array.isArray(t)&&(t=t[0]);let e=null==t?void 0:t.error;if(e&&e.status&&e.message){let t=function(t){let e=t.toLowerCase().replace(/_/g,"-");return Object.values(lH).indexOf(e)>=0?e:lH.UNKNOWN}(e.status);o(new lK(t,e.message))}else o(new lK(lH.UNKNOWN,"Server responded with status "+a.getStatus()))}else // it's most probably a connection issue
o(new lK(lH.UNAVAILABLE,"Connection failed."));break;default:lq()}}finally{lj(cI,`RPC '${t}' ${r} completed.`)}});let l=JSON.stringify(i);lj(cI,`RPC '${t}' ${r} sending request:`,i),a.send(e,"POST",l,n,15)})}Mo(t,e,n){let i=cb(),r=[this.po,"/","google.firestore.v1.Firestore","/",t,"/channel"],s=lx(),o=lC(),a={// Required for backend stickiness, routing behavior is based on this
// parameter.
...
a.encodeInitMessageHeaders=!0;let u=r.join("");lj(cI,`Creating RPC '${t}' stream ${i}: ${u}`,a);let h=s.createWebChannel(u,a),c=!1,f=!1,p=new cT({ho:e=>{f?lj(cI,`Not sending because RPC '${t}' stream ${i} is closed:`,e):(c||(lj(cI,`Opening RPC '${t}' stream ${i} transport.`),h.open(),c=!0),lj(cI,`RPC '${t}' stream ${i} sending:`,e),h.send(e))},Po:()=>h.close()}),g=(t,e,n)=>{// TODO(dimond): closure typing seems broken because WebChannel does
...
return g(h,lO.EventType.OPEN,()=>{f||lj(cI,`RPC '${t}' stream ${i} transport opened.`)}),g(h,lO.EventType.CLOSE,()=>{f||(f=!0,lj(cI,`RPC '${t}' stream ${i} transport closed`),p.mo())}),g(h,lO.EventType.ERROR,e=>{f||(f=!0,l$(cI,`RPC '${t}' stream ${i} transport errored:`,e),p.mo(new lK(lH.UNAVAILABLE,"The operation could not be completed")))}),g(h,lO.EventType.MESSAGE,e=>{var n;if(!f){let r=e.data[0];r||lq();// TODO(b/35143891): There is a bug in One Platform that caused errors
// (and only errors) to be wrapped in an extra array. To be forward
// compatible with the bug we need to check either condition. The latter
// can be removed once the fix has been rolled out.
// Use any because msgData.error is not typed.
let s=r.error||(null===(n=r[0])||void 0===n?void 0:n.error);if(s){lj(cI,`RPC '${t}' stream ${i} received error:`,s);// error.status will be a string like 'OK' or 'NOT_FOUND'.
let e=s.status,n=/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cx(t){return new hG(t,/* useProto3Json= */!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class c_{constructor(t,e,n,i,r,s,o,a){this._i=t,this.Uo=n,this.Wo=i,this.connection=r,this.authCredentialsProvider=s,this.appCheckCredentialsProvider=o,this.listener=a,this.state=0/* PersistentStreamState.Initial */,/**
         * A close count that's incremented every time the stream is closed; used by
         * getCloseGuardedDispatcher() to invalidate callbacks that happen after
         * close.
         */this.Go=0,this.zo=null,this.jo=null,this.stream=null,this.Ho=new cC(t,e)}/**
 ...
 */class ck extends c_{constructor(t,e,n,i,r,s){super(t,"write_stream_connection_backoff"/* TimerId.WriteStreamConnectionBackoff */,"write_stream_idle"/* TimerId.WriteStreamIdle */,"health_check_timeout"/* TimerId.HealthCheckTimeout */,e,n,i,s),this.serializer=r,this.P_=!1}/**
...
this.Ho.reset();let i=(e=t.writeResults,n=t.commitTime,e&&e.length>0?(void 0!==n||lq(),e.map(t=>{let e;return(e=t.updateTime?hQ(t.updateTime):hQ(n)).isEqual(l6.min())&&// The Firestore Emulator currently returns an update time of 0 for
// deletes of non-existing documents (rather than null). This breaks the
// test "get deleted doc while offline with source=cache" as NoDocuments
// with version 0 are filtered by IndexedDb's RemoteDocumentCache.
// TODO(#2149): Remove this when Emulator is fixed
(e=hQ(n)),new hN(e,t.transformResults||[])})):[]),r=hQ(t.commitTime);return this.listener.T_(r,i)}// The first response is always the handshake response
...
let e={};e.database=(t=this.serializer,new l8(["projects",t.databaseId.projectId,"databases",t.databaseId.database]).canonicalString()),this.n_(e)}/** Sends a group of mutations to the Firestore backend to apply. */d_(t){let e={streamToken:this.lastStreamToken,writes:t.map(t=>(function(t,e){var n;let i;if(e instanceof hB)i={update:hY(t,e.key,e.value)};else if(e instanceof h$)i={delete:hJ(t,e.key)};else if(e instanceof hF)i={update:hY(t,e.key,e.data),updateMask:function(t){let e=[];return t.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}(e.fieldMask)};else{if(!(e instanceof hz))return lq();i={verify:hJ(t,e.key)}}return e.fieldTransforms.length>0&&(i.updateTransforms=e.fieldTransforms.map(t=>(function(t,e){let n=e.transform;if(n instanceof hT)return{fieldPath:e.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(n instanceof hI)return{fieldPath:e.field.canonicalString(),appendMissingElements:{values:n.elements}};if(n instanceof hA)return{fieldPath:e.field.canonicalString(),removeAllFromArray:{values:n.elements}};if(n instanceof hC)return{fieldPath:e.field.canonicalString(),increment:n.Te};throw lq()})(0,t))),e.precondition.isNone||(i.currentDocument=void 0!==(n=e.precondition).updateTime?{updateTime:hW(t,n.updateTime.toTimestamp())}:void 0!==n.exists?{exists:n.exists}:lq()),i})(this.serializer,t))};this.n_(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class cD{constructor(t,e){this.asyncQueue=t,this.onlineStateHandler=e,/** The current OnlineState. */this.state="Unknown"/* OnlineState.Unknown */,/**
...
// down our streams.
cP(this)&&(lj("RemoteStore","Restarting streams for network reachability change."),await async function(t){t.F_.add(4/* OfflineCause.ConnectivityChange */),await cL(t),t.O_.set("Unknown"/* OnlineState.Unknown */),t.F_.delete(4/* OfflineCause.ConnectivityChange */),await cR(t)}(this))})}),this.O_=new cD(n,i)}}async function cR(t){if(cP(t))for(let e of t.M_)await e(/* enabled= */!0)}/**
 * Temporarily disables the network. The network can be re-enabled using
 * enableNetwork().
 */async function cL(t){for(let e of t.M_)await e(/* enabled= */!1)}function cP(t){return 0===t.F_.size}/**
 ...
 * any retry attempt.
 */async function cM(t,e,n){if(!uo(e))throw e;t.F_.add(1/* OfflineCause.IndexedDbFailed */),await cL(t),t.O_.set("Offline"/* OnlineState.Offline */),n||// Use a simple read operation to determine if IndexedDB recovered.
// Ideally, we would expose a health check directly on SimpleDb, but
// RemoteStore only has access to persistence through LocalStore.
(n=()=>{var e;return(e=t.localStore).persistence.runTransaction("Get last remote snapshot version","readonly",t=>e.Kr.getLastRemoteSnapshotVersion(t))}),t.asyncQueue.enqueueRetryable(async()=>{lj("RemoteStore","Retrying IndexedDB access"),await n(),t.F_.delete(1/* OfflineCause.IndexedDbFailed */),await cR(t)})}/**
 * Executes `op`. If `op` fails, takes the network offline until `op`
 * succeeds. Returns after the first attempt.
 */function cB(t,e){return e().catch(n=>cM(t,n,e))}async function cF(t){let e=cG(t),n=t.C_.length>0?t.C_[t.C_.length-1].batchId:-1;for(;cP(t)&&t.C_.length<10;)try{let i=await /**
 ...
 */function(t,e){t.C_.push(e);let n=cG(t);n.Yo()&&n.I_&&n.d_(e.mutations)}(t,i)}catch(e){await cM(t,e)}cU(t)&&cj(t)}function cU(t){return cP(t)&&!cG(t).Jo()&&t.C_.length>0}function cj(t){cG(t).start()}async function cV(t){cG(t).A_()}async function c$(t){let e=cG(t);// Send the write pipeline now that the stream is established.
for(let n of t.C_)e.d_(n.mutations)}async function cz(t,e,n){let i=t.C_.shift(),r=hH.from(i,e,n);await cB(t,()=>t.remoteSyncer.applySuccessfulWrite(r)),// slot has freed up.
await cF(t)}async function cq(t,e){// If the write stream closed after the write handshake completes, a write
// operation failed and we fail the pending operation.
e&&cG(t).I_&&// This error affects the actual write.
...
// restart.
cG(t).Xo(),await cB(t,()=>t.remoteSyncer.rejectFailedWrite(n.batchId,e)),// another slot has freed up.
await cF(t)}}(t,e),// pipeline for failed writes
cU(t)&&cj(t)}async function cH(t,e){t.asyncQueue.verifyOperationInProgress(),lj("RemoteStore","RemoteStore received new credentials");let n=cP(t);// Tear down and re-create our network streams. This will ensure we get a
// fresh auth token for the new user and re-fill the write pipeline with
// new mutations from the LocalStore (since mutations are per-user).
t.F_.add(3/* OfflineCause.CredentialChange */),await cL(t),n&&// Don't set the network status to Unknown if we are offline.
t.O_.set("Unknown"/* OnlineState.Unknown */),await t.remoteSyncer.handleCredentialChange(e),t.F_.delete(3/* OfflineCause.CredentialChange */),await cR(t)}/**
 * Toggles the network state when the client gains or loses its primary lease.
 */async function cK(t,e){e?(t.F_.delete(2/* OfflineCause.IsSecondary */),await cR(t)):e||(t.F_.add(2/* OfflineCause.IsSecondary */),await cL(t),t.O_.set("Unknown"/* OnlineState.Unknown */))}/**
 ...
 */function cG(t){var e,n,i;return t.L_||// Create stream (but note that it is not started yet).
(t.L_=(e=t.datastore,n=t.asyncQueue,i={Io:cV.bind(null,t),Eo:cq.bind(null,t),E_:c$.bind(null,t),T_:cz.bind(null,t)},e.V_(),new ck(n,e.connection,e.authCredentials,e.appCheckCredentials,e.serializer,i)),t.M_.push(async e=>{e?(t.L_.Xo(),await cF(t)):(await t.L_.stop(),t.C_.length>0&&(lj("RemoteStore",`Stopping write stream with ${t.C_.length} pending writes`),t.C_=[]))})),t.L_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * IE.
 */class cW{constructor(t,e,n,i,r){this.asyncQueue=t,this.timerId=e,this.targetTimeMs=n,this.op=i,this.removalCallback=r,this.deferred=new lG,this.then=this.deferred.promise.then.bind(this.deferred.promise),// and so we attach a dummy catch callback to avoid
...
this.deferred.promise.catch(t=>{})}get promise(){return this.deferred.promise}/**
     ...
     */static createAndSchedule(t,e,n,i,r){let s=Date.now()+n,o=new cW(t,e,s,i,r);return o.start(n),o}/**
 ...
 */function cQ(t,e){if(lV("AsyncQueue",`${e}: ${t}`),uo(t))return new lK(lH.UNAVAILABLE,`${e}: ${t}`);throw t}class cX{constructor(){this.queries=new hl(t=>hs(t),hr),this.onlineState="Unknown"/* OnlineState.Unknown */,this.K_=new Set}}/**
 ...
 * This is useful to implement optional features (like bundles) in free
 * functions, such that they are tree-shakeable.
 */class cJ{constructor(t,e,n,i,r,s){this.localStore=t,this.remoteStore=e,this.eventManager=n,this.sharedClientState=i,this.currentUser=r,this.maxConcurrentLimboResolutions=s,this.fa={},this.ga=new hl(t=>hs(t),hr),this.pa=new Map,/**
         ...
         */this.Sa=new Map,this.ba=new ce,/** Stores user completion handlers, indexed by User and BatchId. */this.Da={},/** Stores user callbacks waiting for all pending writes to be acknowledged. */this.Ca=new Map,this.va=h5.Ln(),this.onlineState="Unknown"/* OnlineState.Unknown */,// startup. In the interim, a client should only be considered primary if
// `isPrimary` is true.
 ...
 */async function cY(t,e,n){var i;let r=(t.remoteStore.remoteSyncer.applySuccessfulWrite=c0.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=c1.bind(null,t),t);try{let t;let s=await function(t,e){let n,i;let r=l5.now(),s=e.reduce((t,e)=>t.add(e.key),hm());return t.persistence.runTransaction("Locally write mutations","readwrite",o=>{// Figure out which keys do not have a remote version in the cache, this
// is needed to create the right overlay mutation: if no remote version
// presents, we do not need to create overlays as patch mutations.
// TODO(Overlay): Is there a better way to determine this? Using the
//  document version does not work because local mutations set them back
//  to 0.
let a=hu,l=hm();return t._s.getEntries(o,s).next(t=>{(a=t).forEach((t,e)=>{e.isValidDocument()||(l=l.add(t))})}).next(()=>t.localDocuments.getOverlayedDocuments(o,a)).next(i=>{n=i;// For non-idempotent mutations (such as `FieldValue.increment()`),
 ...
 */function(t,e){let n=null;for(let i of t.fieldTransforms){let t=e.data.field(i.field),r=hE(i.transform,t||null);null!=r&&(null===n&&(n=uj.empty()),n.set(i.field,r))}return n||null}(t,n.get(t.key).overlayedDocument);null!=e&&// NOTE: The base state should only be applied if there's some
// existing document to override, so use a Precondition of
// exists=true
s.push(new hF(t.key,e,/**
 * Returns a FieldMask built from all fields in a MapValue.
 */function t(e){let n=[];return uh(e.fields,(e,i)=>{let r=new ut([e]);if(uB(i)){let e=t(i.mapValue).fields;if(0===e.length)n.push(r);else // leaf nodes.
for(let t of e)n.push(r.child(t))}else // nodes.
n.push(r)}),new uy(n)}(e.value.mapValue),hD.exists(!0)))}return t.mutationQueue.addMutationBatch(o,r,s,e)}).next(e=>{i=e;let r=e.applyToLocalDocumentSet(n,l);return t.documentOverlayCache.saveOverlays(o,e.batchId,r)})}).then(()=>({batchId:i.batchId,changes:hf(n)}))}(r.localStore,e);r.sharedClientState.addPendingMutation(s.batchId),i=s.batchId,(t=r.Da[r.currentUser.toKey()])||(t=new uf(l9)),t=t.insert(i,n),r.Da[r.currentUser.toKey()]=t,await c4(r,s.changes),await cF(r.remoteStore)}catch(e){// If we can't persist the mutation, we reject the user callback and
// don't send the mutation. The user can then retry the write.
let t=cQ(e,"Failed to persist write");n.reject(t)}}/**
 * Applies an OnlineState change to the sync engine and notifies any views of
 * the change.
 */function cZ(t,e,n){var i;// If we are the secondary client, we explicitly ignore the remote store's
...
t.rs=t.rs.insert(e,r)}}}(t.localStore,r))}async function c5(t,e){if(!t.currentUser.isEqual(e)){lj("SyncEngine","User change. New user:",e.toKey());let n=await cp(t.localStore,e);t.currentUser=e,t.Ca.forEach(t=>{t.forEach(t=>{t.reject(new lK(lH.CANCELLED,"'waitForPendingWrites' promise is rejected due to a user change."))})}),t.Ca.clear(),t.sharedClientState.handleUserChange(e,n.removedBatchIds,n.addedBatchIds),await c4(t,n.cs)}}class c6{constructor(){this.synchronizeTabs=!1}async initialize(t){this.serializer=cx(t.databaseInfo.databaseId),this.sharedClientState=this.createSharedClientState(t),this.persistence=this.createPersistence(t),await this.persistence.start(),this.localStore=this.createLocalStore(t),this.gcScheduler=this.createGarbageCollectionScheduler(t,this.localStore),this.indexBackfillerScheduler=this.createIndexBackfillerScheduler(t,this.localStore)}createGarbageCollectionScheduler(t,e){return null}createIndexBackfillerScheduler(t,e){return null}createLocalStore(t){var /** Manages our in-memory or durable persistence. */e,n,i,r;return e=this.persistence,n=new cf,i=t.initialUser,r=this.serializer,new cd(e,n,i,r)}createPersistence(t){return new ca(cu.Jr,this.serializer)}createSharedClientState(t){return new cm}async terminate(){this.gcScheduler&&this.gcScheduler.stop(),await this.sharedClientState.shutdown(),await this.persistence.shutdown()}}/**
 * Initializes and wires the components that are needed to interface with the
 * network.
 */class c3{async initialize(t,e){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(e),this.remoteStore=this.createRemoteStore(e),this.eventManager=this.createEventManager(e),this.syncEngine=this.createSyncEngine(e,/* startAsPrimary=*/!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=t=>cZ(this.syncEngine,t,1/* OnlineStateSource.SharedClientState */),this.remoteStore.remoteSyncer.handleCredentialChange=c5.bind(null,this.syncEngine),await cK(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return new cX}createDatastore(t){var e,n,i;let r=cx(t.databaseInfo.databaseId),s=(e=t.databaseInfo,new cS(e));return n=t.authCredentials,i=t.appCheckCredentials,new cN(n,i,s,r)}createRemoteStore(t){var e,n,i,r;return e=this.localStore,n=this.datastore,i=t.asyncQueue,r=cv.C()?new cv:new cy,new cO(e,n,i,t=>cZ(this.syncEngine,t,0/* OnlineStateSource.RemoteStore */),r)}createSyncEngine(t,e){return function(t,e,n,i,r,s,o){let a=new cJ(t,e,n,i,r,s);return o&&(a.Fa=!0),a}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,e)}terminate(){return async function(t){lj("RemoteStore","RemoteStore shutting down."),t.F_.add(5/* OfflineCause.Shutdown */),await cL(t),t.x_.shutdown(),// triggering spurious listener events with cached data, etc.
...
// tokens.
this.authCredentials.shutdown(),this.appCheckCredentials.shutdown(),t.resolve()}catch(n){let e=cQ(n,"Failed to shutdown persistence");t.reject(e)}}),t.promise}}async function c7(t,e){t.asyncQueue.verifyOperationInProgress(),lj("FirestoreClient","Initializing OfflineComponentProvider");let n=await t.getConfiguration();await e.initialize(n);let i=n.initialUser;t.setCredentialChangeListener(async t=>{i.isEqual(t)||(await cp(e.localStore,t),i=t)}),// need to be terminated to allow the delete to succeed.
...
this.ru=!1,this.iu=!1,this.su=[],this.Ho=new cC(this,"async_queue_retry"/* TimerId.AsyncQueueRetry */),// operations. Meant to speed up recovery when we regain file system access
// after page comes into foreground.
this.ou=()=>{let t=cA();t&&lj("AsyncQueue","Visibility state changed to "+t.visibilityState),this.Ho.$o()};let t=cA();t&&"function"==typeof t.addEventListener&&t.addEventListener("visibilitychange",this.ou)}get isShuttingDown(){return this.eu}/**
     * Adds a new operation to the queue without waiting for it to complete (i.e.
     * we ignore the Promise result).
     */enqueueAndForget(t){// eslint-disable-next-line @typescript-eslint/no-floating-promises
this.enqueue(t)}enqueueAndForgetEvenWhileRestricted(t){this._u(),this.au(t)}enterRestrictedMode(t){if(!this.eu){this.eu=!0,this.iu=t||!1;let e=cA();e&&"function"==typeof e.removeEventListener&&e.removeEventListener("visibilitychange",this.ou)}}enqueue(t){if(this._u(),this.eu)return new Promise(()=>{});// Create a deferred Promise that we can return to the callee. This
...
this.Ho.Qo(()=>this.uu())}}au(t){let e=this.Za.then(()=>(this.ru=!0,t().catch(t=>{let e;this.nu=t,this.ru=!1;let n=(e=t.message||"",t.stack&&(e=t.stack.includes(t.message)?t.stack:t.message+"\n"+t.stack),e);// Re-throw the error so that this.tail becomes a rejected Promise and
    ...
    throw lV("INTERNAL UNHANDLED ERROR: ",n),t}).then(t=>(this.ru=!1,t))));return this.Za=e,e}enqueueAfterDelay(t,e,n){this._u(),this.su.indexOf(t)>-1&&(e=0);let i=cW.createAndSchedule(this,t,e,n,t=>this.cu(t));return this.tu.push(i),i}_u(){this.nu&&lq()}verifyOperationInProgress(){}/**
 ...
 */class fm extends fc{/** @hideconstructor */constructor(t,e,n,i){super(t,e,n,i),/**
...
fy(this),this._firestoreClient.terminate()}}function fy(t){var e,n,i,r,s,o;let a=t._freezeSettings(),l=(r=t._databaseId,s=(null===(e=t._app)||void 0===e?void 0:e.options.appId)||"",o=t._persistenceKey,new ux(r,s,o,a.host,a.ssl,a.experimentalForceLongPolling,a.experimentalAutoDetectLongPolling,fi(a.experimentalLongPollingOptions),a.useFetchStreams));t._firestoreClient=new c8(t._authCredentials,t._appCheckCredentials,t._queue,l),(null===(n=a.localCache)||void 0===n?void 0:n._offlineComponentProvider)&&(null===(i=a.localCache)||void 0===i?void 0:i._onlineComponentProvider)&&(t._firestoreClient._uninitializedComponentsProvider={_offlineKind:a.localCache.kind,_offline:a.localCache._offlineComponentProvider,_online:a.localCache._onlineComponentProvider})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let fT=/^__.*__$/;/** The result of parsing document data (e.g. for a setData call). */class fI{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return null!==this.fieldMask?new hF(t,this.data,this.fieldMask,e,this.fieldTransforms):new hB(t,this.data,e,this.fieldTransforms)}}function fS(t){switch(t){case 0/* UserDataSource.Set */:// fall through
 ...
 * Security Rules.
 */function(t,e,n,i={}){var r;let s=(t=fu(t,fc))._getSettings(),o=`${e}:${n}`;if("firestore.googleapis.com"!==s.host&&s.host!==o&&l$("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."),t._setSettings(Object.assign(Object.assign({},s),{host:o,ssl:!1})),i.mockUserToken){let e,n;if("string"==typeof i.mockUserToken)e=i.mockUserToken,n=lM.MOCK_USER;else{// Let createMockUserToken validate first (catches common mistakes like
...
// sentinel.
(t={nullValue:"NULL_VALUE"}),i.push(t),r++}return{arrayValue:{values:i}}}(n,i)}return function(t,e){var n,i,r,s,o;if(null===(t=n9(t)))return{nullValue:"NULL_VALUE"};if("number"==typeof t)return n=e.serializer,"number"==typeof(r=i=t)&&Number.isInteger(r)&&!ul(r)&&r<=Number.MAX_SAFE_INTEGER&&r>=Number.MIN_SAFE_INTEGER?hw(i):hv(n,i);if("boolean"==typeof t)return{booleanValue:t};if("string"==typeof t)return{stringValue:t};if(t instanceof Date){let n=l5.fromDate(t);return{timestampValue:hW(e.serializer,n)}}if(t instanceof l5){// Firestore backend truncates precision down to microseconds. To ensure
// offline mode works the same with regards to truncation, perform the
// truncation immediately without waiting for the backend to do that.
let n=new l5(t.seconds,1e3*Math.floor(t.nanoseconds/1e3));return{timestampValue:hW(e.serializer,n)}}if(t instanceof fE)return{geoPointValue:{latitude:t.latitude,longitude:t.longitude}};if(t instanceof fv)return{bytesValue:(s=e.serializer,o=t._byteString,s.useProto3Json?o.toBase64():o.toUint8Array())};if(t instanceof fd){let n=e.databaseId,i=t.firestore._databaseId;if(!i.isEqual(n))throw e.gu(`Document reference is for database ${i.projectId}/${i.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:hX(t.firestore._databaseId||e.databaseId,t._key.path)}}throw e.gu(`Unsupported field value: ${fl(t)}`)}(n,i)}(r,n.Au(e));null!=s&&(i[e]=s)}),{mapValue:{fields:i}}}(i,l);if(s.merge)o=new uy(l.fieldMask),a=l.fieldTransforms;else if(s.mergeFields){let t=[];for(let i of s.mergeFields){let r=/**
...
var fL=document.querySelector(".auth-button-in"),fP=document.querySelector(".auth-input");fL.addEventListener("click",function(){fP&&fP.remove()}),w("E6hPi")}();//# sourceMappingURL=index.3ab0fef7.js.map

//# sourceMappingURL=index.3ab0fef7.js.map
