...
return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),r[e]=t),t}}),i("iE7OH").register(JSON.parse('{"kKLfj":"shopping_list_olexandr.4584cb85.js","ee16w":"sprite.91fed135.svg","kSqT3":"amazon.a0223db0.png","hTMkK":"apple-books.5a9f17e3.png","9Qt2K":"bookshop.801e98bc.png","QSTeH":"index.645e2942.js","547K7":"index.c76f0563.js"}')),i("6JpON");var s={};s=i("aNJCr").getBundleURL("kKLfj")+i("iE7OH").resolve("kSqT3");var a={};a=i("aNJCr").getBundleURL("kKLfj")+i("iE7OH").resolve("hTMkK");var l={};l=i("aNJCr").getBundleURL("kKLfj")+i("iE7OH").resolve("9Qt2K"),i("knWGd"),i("ksGdE"),i("E6hPi");// import Pagination from 'tui-pagination';
...
//   }
// // 
var c={};c=i("aNJCr").getBundleURL("kKLfj")+i("iE7OH").resolve("ee16w");let u=document.querySelector(".shop-list-container"),d=document.querySelector(".shop-list-empty"),p="bookArr";function f(e){let t=JSON.parse(localStorage.getItem(p));if(0===t.length){u.innerHTML="",d.classList.remove("shoping-hidden");return}d.classList.add("shoping-hidden"),u.insertAdjacentHTML("beforeend",h(t)),document.querySelector(".shop-button-book-remove"),u.innerHTML=h(t)}function h(e){return e.map(({author:e,title:o,description:n,book_image:r,buy_links:i,list_name:u,id:d})=>{let p=`<li class="shop-list-item" data-id="${d}">
        ...
        <li>
        <a class="item-link" href=${g(i,"Apple Books")} target= _blank><img src="${/*@__PURE__*/t(a)}" alt="Apple-Books" width="16px"></a>
        </li>
        <li>
        <a class="item-link" href=${g(i,"Bookshop")} target= _blank> <img src="${/*@__PURE__*/t(l)}" alt="Book-Shop" width="16px"></a>
        </li>
      </ul>
      </div>
                </div>
      ...
      <svg class="shop-remove-btn" width="20" height="20">
        ...
        </li>`;return p}).join("")}function g(e,t){for(let{name:o,url:n}of e)if(o===t)return n}window.addEventListener("DOMContentLoaded",f),u.addEventListener("click",function(e){if("shop-button-book-remove"!==e.target.className)return;let t=e.target.parentNode.dataset.id;(function(e){let t=JSON.parse(localStorage.getItem(p));t.find(t=>t.id===e);let o=t.findIndex(t=>t.id===e);t.splice(o,1),localStorage.setItem(p,JSON.stringify(t))})(t),f()})}();//# sourceMappingURL=shopping_list_olexandr.4584cb85.js.map

//# sourceMappingURL=shopping_list_olexandr.4584cb85.js.map
