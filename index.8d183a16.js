...
info:function(t,e,i){m(o.Info,t,e,i)}}};return"object"==typeof t.Notiflix?s(!0,t.Notiflix,{Notify:d.Notify}):{Notify:d.Notify}},"function"==typeof define&&define.amd?define([],function(){return e(t)}):"object"==typeof s?s=e(t):t.Notiflix=e(t);var l=a("dIxxU");async function c(t){try{let e=await (0,l.default).get("https://books-backend.p.goit.global/books/"+t);return e.data}catch(t){console.error("An error occurred while fetching data:",t)}}async function f(){let{data:t}=await (0,l.default).get("https://books-backend.p.goit.global/books/category-list");return t}let m=document.querySelector(".categories-list");(async function t(){try{let t=await f();if(!t.length){(0,s.Notify).failure("Oops something going wrong.");return}m.insertAdjacentHTML("beforeend",t.map(({list_name:t})=>`
  ...
  `).join(""))}catch(t){console.log("TRY-CATCH:",t),(0,s.Notify).failure("Oops something going wrong.")}})(),m.addEventListener("click",t=>{t.preventDefault()}),a("ksGdE");let d=(t,e)=>{try{let o=JSON.stringify(e);localStorage.setItem(t,o)}catch(t){console.error("Set state error: ",t.message)}},p=t=>{try{let e=localStorage.getItem(t);return null===e?void 0:JSON.parse(e)}catch(t){console.error("Get state error: ",t.message)}};!function(){let t=document.querySelector(".loader");t.style.display="block"}();let y=document.querySelector(".common-list");document.querySelector(".main-title");let u=document.querySelector(".categories-list"),x=window.innerWidth<767?1:window.innerWidth<1439?3:5;function g(t){!function(){let t=document.querySelector(".loader");t.style.display="none"}();let e="";for(let o of t){let{books:t,list_name:i}=o;e+=` 
...
//     }
// });
a("E6hPi")}();//# sourceMappingURL=index.8d183a16.js.map

//# sourceMappingURL=index.8d183a16.js.map
